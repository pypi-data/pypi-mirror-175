...
class ARM_ElfRelocationHandler(ghidra.app.util.bin.format.elf.relocation.ElfRelocationHandler):
    ...
    def createRelocationContext(self, __a0: ghidra.app.util.bin.format.elf.ElfLoadHelper, __a1: ghidra.app.util.bin.format.elf.ElfRelocationTable, __a2: java.util.Map) -> ghidra.app.util.bin.format.elf.relocation.ARM_ElfRelocationContext: ...
