...
class DBTraceFunctionSymbol(ghidra.trace.database.symbol.DBTraceNamespaceSymbol, ghidra.trace.model.symbol.TraceFunctionSymbol):
    ...
    def addLocalVariable(self, __a0: ghidra.program.model.listing.Variable, __a1: ghidra.program.model.symbol.SourceType) -> ghidra.trace.database.symbol.DBTraceLocalVariableSymbol: ...
