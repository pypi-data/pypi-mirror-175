...
def pkdump(path , fname , obj , length = None , interval = None , timedelta = None , backup = None , backupDuration = None , keep = 0 , json = False):
    if json == False:
...
def pkload(path , fname , obj , init = None ):
