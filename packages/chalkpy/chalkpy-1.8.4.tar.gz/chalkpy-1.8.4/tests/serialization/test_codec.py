...
def test_get_polars_dtype():
    ...
    assert FEATURE_CODEC.get_polars_dtype("hello.f") == pl.Struct([pl.Field("foo", pl.Int64), pl.Field("bar", pl.Utf8)])
    ...
    assert FEATURE_CODEC.get_polars_dtype("hello.fancy") == pl.Object
