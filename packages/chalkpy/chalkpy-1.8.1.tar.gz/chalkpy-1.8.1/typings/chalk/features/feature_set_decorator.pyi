...
from chalk.streams.windows import Windowed as __stubgen_chalk_streams_windows_Windowed
...
class StreamFeaturesWindowMetaclass(FeaturesMeta):
    @property
    def scalar_feature(self) -> Type[__stubgen_chalk_streams_windows_Windowed]: ...
...
class StreamFeaturesWindow(Features, metaclass=StreamFeaturesWindowMetaclass):
    def __init__(
        self,
        scalar_feature: __stubgen_chalk_streams_windows_Windowed = ...,
        uid: str = ...,
    ):
        self.scalar_feature: __stubgen_chalk_streams_windows_Windowed
        self.uid: str
...
class StreamFeaturesStateMetaclass(FeaturesMeta):
    @property
    def scalar_feature(self) -> Type[str]: ...

class StreamFeaturesState(Features, metaclass=StreamFeaturesStateMetaclass):
    def __init__(
        self,
        scalar_feature: str = ...,
    ):
...
class StreamFeaturesStateProtocol(Protocol):
    scalar_feature: str
...
@overload
def features(item: Type[StreamFeaturesStateProtocol]) -> Type[StreamFeaturesState]: ...
...
class __stubgen__features_proto(Protocol):
    ...
    @overload
    def __call__(self, item: Type[StreamFeaturesStateProtocol]) -> Type[StreamFeaturesState]: ...
