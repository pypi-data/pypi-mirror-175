...
import types
from typing import List, Optional, Set, Type, TypeVar, Union, cast, get_args, get_origin, get_type_hints
...
class FeatureTypeAnnotation:
    ...
    def _parse_type(self, annotation: Optional[type]):
        ...
        self._is_scalar = annotation is not None and not (
            isinstance(annotation, type) and issubclass(annotation, Features)
        )
