...
setup(
    ...
    author_email="Mostafa.Abdelrashied@Bain.com",
    url="https://www.bain.com/vector-digital/advanced-analytics/",
    ...
    install_requires=[
        ...
        "seaborn==0.12.1",
        "jupyterlab==3.5.0",
        'pyMixtComp_macosx_10_9_x86_64 ; platform_system=="macOS" and platform_machine=="x86_64"',
        'pyMixtComp_linux_x86_64 ; platform_system=="Linux" and platform_machine=="x86_64"',
        ],
)
