...
from .base import BaseTrainer, BaseDataset
...
class PyForecastTrainer(BaseTrainer):
    ...
    def __init__(self, module, group_ids, time_idx, target,
                 ...
                 device='cpu', **kwargs):
        super().__init__(module=module, dataset=PyTorchForecastingDataset,
                         ...
                         collate_fn=collate_fn, criterion=criterion,
...
class TemporalFusionTransformer(PyForecastTrainer):
    ...
    def __init__(self, group_ids, time_idx, target, max_prediction_length,
        ...
        super().__init__(
            module=TFT, group_ids=group_ids, time_idx=time_idx, target=target,
            max_prediction_length=max_prediction_length,
            max_encoder_length=max_encoder_length,
            time_varying_known_reals=time_varying_known_reals,
            time_varying_unknown_reals=time_varying_unknown_reals,
