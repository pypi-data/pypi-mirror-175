...
class Adsorption:
    ...
    def move_molecule_to(self,molid,ads_site,ads_site_index,anchor,vert_sep):
        ...
        move_molecule_to(molid,ads_site,ads_site_index,anchor,vert_sep) -> 
            rigidly moves the molecule such that the anchor point is located 
            at the specified adsorption site.
    ...
    def move_molecule_to(self,molecule,ads_site,ads_site_index,anchor,vert_sep):
        ...
        move_molecule_to(molecule,ads_site,ads_site_index,anchor,vert_sep) -> 
            rigidly moves the molecule such that the anchor point is located at 
            the specified adsorption site.
