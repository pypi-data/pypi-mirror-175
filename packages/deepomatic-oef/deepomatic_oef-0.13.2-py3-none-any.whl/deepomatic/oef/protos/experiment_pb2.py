...
_EXPERIMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exclusive_labels', full_name='deepomatic.oef.experiment.Experiment.exclusive_labels', index=6,
