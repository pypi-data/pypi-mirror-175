...
class ShippingMethodInt:
    ...
    SELF_FLASH_INT = 4
    # 闪送
    FLASH_DELIVERY_INT = 8

    str2int_map = {
        ShippingMethod.EXPRESS: EXPRESS_INT,
        ShippingMethod.SELF_SERVICE: SELF_SERVICE_INT,
        ShippingMethod.SELF_FLASH: SELF_FLASH_INT,
        ShippingMethod.FLASH_DELIVERY: FLASH_DELIVERY_INT
    }
