...
class Message_:
    def __init__(self, bot, msg):
        ...
        self.is_group = True if self.chat_type in ['group', 'supergroup'] else False
    ...
    def respond(self, text, message_thread_id=None, parse_mode=None, entities=None, link_preview=None, disable_web_page_preview=None, disable_notification=None, protect_content=None, reply_to=None, reply_to_message_id=None, allow_sending_without_reply=None, buttons=None, reply_markup=None, **kwargs):
        chat_id = self.chat.id
        r = self.bot.send_message(chat_id=chat_id, text=text, message_thread_id=message_thread_id, parse_mode=parse_mode, entities=entities, link_preview=link_preview, disable_web_page_preview=disable_web_page_preview, disable_notification=disable_notification, protect_content=protect_content, reply_to=reply_to, reply_to_message_id=reply_to_message_id, allow_sending_without_reply=allow_sending_without_reply, buttons=buttons, reply_markup=reply_markup, **kwargs)
