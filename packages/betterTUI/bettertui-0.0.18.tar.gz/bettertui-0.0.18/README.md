...
## Wrapper(screen: Screen, start_pos: list, widgets: list, trash: list)
...
* *trash* - a list of non-interactive widgets you would like to also delete when Widget.delete() is called 'useful for realtime widgets'
...
# Initiliaze Text object
text = betterTUI.Text(screen, 2, 2, f"Current Time: 00:00:00")

# turn on real_time_updates which will call getTime and
# redraw the string every second
# real_time_update: (interval: int, func: Any) -> None
