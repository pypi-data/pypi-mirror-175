...
def delete_layer_step_files(layer_step: LayerStepModel):
    if layer_step.cog_filepath:
        delete_object_by_s3_path(layer_step.cog_filepath)

    if layer_step.cog_filepaths:
        for s3_file_path in layer_step.cog_filepaths:
            delete_object_by_s3_path(s3_file_path)
