...
- Restored :meth:`Model.get_leaderboard_ui_permalink <datarobot.models.Model.get_leaderboard_ui_permalink>`, :meth:`Model.open_model_browser <datarobot.models.Model.open_model_browser>`,
  ...
  These methods were incorrectly removed instead of deprecated.
- Fixed a bug for when the datarobot package is used in IPython notebooks, where API credentials did not persist across cells when ipykernel < 6.0.0 is installed.
