...
# %% auto 0
__all__ = ['df_ensemble', 'SimpleMultiComponent', 'Transform1', 'Transform2', 'SimplePipeline',
           ...
           'SimplePandasPipelineNoPandasComponent', 'DummyEvaluator', 'TransformM', 'column_transformer_data',
           'multi_split_data', 'multi_split_data_df_column', 'get_cross_validator_input_data', 'DummyHistoryClassifier',
           'run_study', 'run_multiple_studies', 'DummyClassifierInstance', 'SumColumn', 'MultiplyColumn',
           'test_multi_comp_io', 'test_multi_comp_desc', 'test_multi_comp_desc2', 'test_list', 'test_show',
           ...
           'test_pass_functions_to_multi_component', 'test_pass_tuples_classes', 'test_set_suffix',
           'test_multi_comp_propagate_args', 'test_pass_no_component_class', 'test_compare_kwargs_compose',
           ...
           'test_multi_split_non_dict', 'test_multi_split_non_dict_bis', 'test_multi_split_root',
           'test_multi_split_tuples', 'test_multi_split_df_column_transform_whole_df',
...
def test_gather_and_save_info ():
    ...
    assert os.listdir (f'{path_session}/last_run')==['higher.pk', 'pipeline.pk']
