...
__all__ = ['estimator2io', 'result2io', 'SklearnIO', 'save_csv', 'save_parquet', 'save_multi_index_parquet', 'save_keras_model',
           ...
           'snake_to_camel', 'get_parent_class', 'get_component_hierarchy', 'get_ds_experiment_manager']
...
class DataIO (BaseCallback):
    ...
    def load_result (self, split=None, path_results=None, result_file_name=None, return_found=False):
        """
