...
def _delvewheel_init_patch_0_0_22():
    import os
    import sys
    libs_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, 'itk_fpfh.libs'))
    if sys.version_info[:2] >= (3, 8):
        ...
        with open(os.path.join(libs_dir, '.load-order-itk_fpfh-0.1.0')) as file:
