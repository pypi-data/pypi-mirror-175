...
import bluetooth.advertise as advertise
import bluetooth.ble as ble
import bluetooth.service as service
import dbus.mainloop.glib
import dbus.service
from bluetooth.const import AGENT_PATH, SERVICE_UUID
...
def _setup(main):
    ...
    sv = service.UVedoraService(bus, 2, main)
    app.add_service(sv)
