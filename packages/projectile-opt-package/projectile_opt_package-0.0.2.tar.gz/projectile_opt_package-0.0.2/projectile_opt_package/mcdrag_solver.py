...
def load_lib():
    ...
    if sys.platform.startswith('linux'):
        LIB_FILE_NAME = os.path.abspath(os.path.join(HERE, ".", "compiled", "mcdrag", "release", "libmcdrag.so"))
    elif sys.platform.startswith('win32'):
        LIB_FILE_NAME = os.path.abspath(os.path.join(HERE, ".", "compiled", "mcdrag", "release", "libmcdrag.dll"))
    else:
