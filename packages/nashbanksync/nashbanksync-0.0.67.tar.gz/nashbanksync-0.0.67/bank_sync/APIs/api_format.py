...
class API(object):
    ...
    def api_request(self, payload, method, verify = False, files = None):
        ...
        logger.info(f":::::::::::::::::start of api_request:::::::::::::::::::")
        logger.info(f"get_full_url: {self.get_full_url()}")
        logger.info(f"headers: {self._headers}")
        logger.info(f"params: {self._params}")
        logger.info(f"data: {self._payload}")
        logger.info(f"json: {self._payload}")
        ...
        try:
            ...
            logger.info(f":::::::::::::::::end of api_request:::::::::::::::::::")
