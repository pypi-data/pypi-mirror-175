...
class CorruptionReportPlotRecipes(BaseModel):
    ...
    model_comparison_mfr: Dict[str, Any] = Field(..., title="Model Comparison Mfr")
...
class ImageSegmentationModelOutput(BaseModel):
    ...
    dimensions: List[Union[Dimension, Dimension1, Dimension2]] = Field(
        ..., max_items=3, min_items=3, title="Dimensions"
    )
    class_names: List[str] = Field(..., title="Class Names")
...
class ImageObjectDetectionBoundingBox(BaseModel):
    ...
    class_index: int = Field(..., title="Class Index")
