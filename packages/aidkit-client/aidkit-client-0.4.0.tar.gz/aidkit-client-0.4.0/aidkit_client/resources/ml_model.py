...
from aidkit_client._endpoints.models import Standardizer as CoreStandardizer
from aidkit_client._endpoints.models import (
...
class ImageModel(ClassificationOutputMixin, MLModel):
    ...
    def _build_input_specs(
        ...
        pre_processor: Optional[Standardizer] = None,
        ...
        :param pre_processor: Optional pre-processor.
        ...
        if pre_processor:
            inner_pre_processor = CoreStandardizer(**pre_processor.dict())
        else:
            inner_pre_processor = CoreStandardizer(mean=0.0, std=1.0)
        ...
        if image_input_config.image_type == "grayscale":
            ...
            return GrayScaleImageInputSpecs(
                ...
                pre_processor=inner_pre_processor,
            )
    ...
    async def create(
        ...
        :param pre_processor: Optional `Standardizer` as pre-processor.
        ...
        input_specs = cls._build_input_specs(
            batch=batch, image_input_config=image_input_config, pre_processor=pre_processor
        )
