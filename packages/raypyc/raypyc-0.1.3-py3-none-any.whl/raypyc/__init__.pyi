...
def rl_load_shader_buffer(size: unsignedlonglong, data: ctypes.c_void_p, usageHint: ctypes.c_int) -> ctypes.c_uint:
...
def rl_update_shader_buffer_elements(id: ctypes.c_uint, data: ctypes.c_void_p, dataSize: unsignedlonglong, offset: unsignedlonglong) -> None:
	"""Update SSBO buffer data"""
	...

def rl_get_shader_buffer_size(id: ctypes.c_uint) -> unsignedlonglong:
	"""Get SSBO buffer size"""
	...

def rl_read_shader_buffer_elements(id: ctypes.c_uint, dest: ctypes.c_void_p, count: unsignedlonglong, offset: unsignedlonglong) -> None:
	"""Bind SSBO buffer"""
	...
...
def rl_copy_buffers_elements(destId: ctypes.c_uint, srcId: ctypes.c_uint, destOffset: unsignedlonglong, srcOffset: unsignedlonglong, count: unsignedlonglong) -> None:
	"""Copy SSBO buffer data"""
	...
