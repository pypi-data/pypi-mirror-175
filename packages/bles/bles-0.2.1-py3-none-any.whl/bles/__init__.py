...
from bl3d import History as DomainEventHistory
...
class ProjectorRegistry:
    ...
    def filter(self, condition: Callable[[str], bool]) -> "ProjectorRegistry":
        return ProjectorRegistry([p for n, p in self.__projectors if condition(n)])
