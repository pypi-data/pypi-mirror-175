...
class Fade:
    ...
    def YELLOW_TO_RED(text: str, seed: int=25, intensity: int=1):
        output = ""
        green = 250
    ...
    def PURPLE_TO_BLUE(text: str, seed: int=15, intensity: int=1):
        output = ""
        red = 110
        if Fade.detectascii(text):
            for character in text:
    ...
    def GREEN_TO_BLUE(text: str, seed: int=15, intensity: int=1):
        output = ""
        blue = 100
        if Fade.detectascii(text):
            for character in text:
