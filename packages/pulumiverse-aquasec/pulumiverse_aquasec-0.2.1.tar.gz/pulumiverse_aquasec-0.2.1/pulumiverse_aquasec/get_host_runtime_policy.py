...
def get_host_runtime_policy(malware_scan_options: Optional[pulumi.InputType['GetHostRuntimePolicyMalwareScanOptionsArgs']] = None,
    ...
    return AwaitableGetHostRuntimePolicyResult(
        ...
        audit_brute_force_login=__ret__.audit_brute_force_login,
        audit_full_command_arguments=__ret__.audit_full_command_arguments,
        audit_host_failed_login_events=__ret__.audit_host_failed_login_events,
        audit_host_successful_login_events=__ret__.audit_host_successful_login_events,
        audit_user_account_management=__ret__.audit_user_account_management,
        ...
        monitor_system_log_integrity=__ret__.monitor_system_log_integrity,
        ...
        package_blocks=__ret__.package_blocks,
        port_scanning_detection=__ret__.port_scanning_detection,
