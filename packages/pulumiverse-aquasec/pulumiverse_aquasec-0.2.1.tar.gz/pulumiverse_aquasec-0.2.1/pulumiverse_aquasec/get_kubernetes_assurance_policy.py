...
class GetKubernetesAssurancePolicyResult:
    ...
    def kubernetes_controls_names(self) -> Optional[Sequence[str]]:
        """
...
def get_kubernetes_assurance_policy(kubernetes_controls_names: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] kubernetes_controls_names: List of kubernetes control names
    :param bool maximum_score_exclude_no_fix: Indicates that policy should ignore cases that do not have a known fix.
    """
    __args__ = dict()
    __args__['kubernetesControlsNames'] = kubernetes_controls_names
    ...
    return AwaitableGetKubernetesAssurancePolicyResult(
        ...
        kubernetes_controls_names=__ret__.kubernetes_controls_names,
...
def get_kubernetes_assurance_policy_output(kubernetes_controls_names: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                           maximum_score_exclude_no_fix: Optional[pulumi.Input[Optional[bool]]] = None,
