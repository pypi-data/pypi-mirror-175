...
class SqlHandler():
    ...
    def connect_to_db(
            ...
            driver: str=DEFAULT_SQL_DRIVER, **kwargs
        ) -> None:
        """
        Connects to the database, returning a pyodbc connection instance.
        ...
        :param **kwargs: Provide any additional kwargs for pyodbc.connect (timeout for example).
        """
        ...
        self._conn = pyodbc.connect(conn_string, **kwargs)
