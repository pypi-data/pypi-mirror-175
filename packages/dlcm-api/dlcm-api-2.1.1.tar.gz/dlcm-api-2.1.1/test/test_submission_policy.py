...
from dlcmapi_client.models.submission_policy import SubmissionPolicy  # noqa: E501
from dlcmapi_client.rest import ApiException

class TestSubmissionPolicy(unittest.TestCase):
    """SubmissionPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SubmissionPolicy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = dlcmapi_client.models.submission_policy.SubmissionPolicy()  # noqa: E501
        if include_optional :
