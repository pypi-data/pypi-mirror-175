...
def make_predictions(input_data: pd.DataFrame) -> np.ndarray:
    ...
    scaler = joblib.load('D:/EPITA/dsp/pw2/models/scaler.joblib')
    encoder = joblib.load('D:/EPITA/dsp/pw2/models/encoder.joblib')
    ...
    model = joblib.load('D:/EPITA/dsp/pw2/models/model.joblib')
