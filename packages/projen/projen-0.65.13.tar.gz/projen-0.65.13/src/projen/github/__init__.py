...
class AutoMerge(
    ...
    def add_conditions(self, *conditions: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*conditions: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def add_conditions_later(self, later: "IAddConditionsLater") -> None:
        ...
        '''
        if __debug__:
            def stub(later: "IAddConditionsLater") -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Dependabot(
    ...
    def add_ignore(
        ...
        *versions: builtins.str,
        ...
        '''
        if __debug__:
            def stub(dependency_name: builtins.str, *versions: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GitHubProject(
    ...
    def annotate_generated(self, glob: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(glob: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GitIdentity:
    def __init__(self, *, email: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, email: builtins.str, name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GithubCredentialsPersonalAccessTokenOptions:
    def __init__(self, *, secret: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(*, secret: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument secret", value=secret, expected_type=type_hints["secret"])
        self._values: typing.Dict[str, typing.Any] = {}
