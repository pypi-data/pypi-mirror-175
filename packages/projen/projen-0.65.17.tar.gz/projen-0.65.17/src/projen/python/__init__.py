...
class PytestSampleOptions:
    def __init__(self, *, module_name: builtins.str, testdir: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, module_name: builtins.str, testdir: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class PythonProject(
    ...
    def pytest(self, value: typing.Optional[Pytest]) -> None:
        if __debug__:
            def stub(value: typing.Optional[Pytest]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class PythonSample(
    ...
    def __init__(self, project: _Project_57d89203, *, dir: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(project: _Project_57d89203, *, dir: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument project", value=project, expected_type=type_hints["project"])
...
class PythonSampleOptions:
    def __init__(self, *, dir: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, dir: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class RequirementsFile(
    ...
    def add_packages(self, *packages: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*packages: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def _synthesize_content(
        ...
        '''
        if __debug__:
            def stub(resolver: _IResolver_0b7d1958) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class VenvOptions:
    def __init__(self, *, envdir: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(*, envdir: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
