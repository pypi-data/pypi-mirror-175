...
from benchling_sdk.services.v2.alpha.v2_alpha_webhook_service import V2AlphaWebhookService
...
class Benchling(object):
    ...
    _webhook_service: V2AlphaWebhookService
    ...
    def __init__(
        ...
        # Webhook operations mostly don't make API calls but use ApiService to get JWKs
        self._webhook_service = V2AlphaWebhookService(self.v2.stable.api)
    ...
    @property
    def webhooks(self) -> V2AlphaWebhookService:
        """
        Webhooks (in alpha).
