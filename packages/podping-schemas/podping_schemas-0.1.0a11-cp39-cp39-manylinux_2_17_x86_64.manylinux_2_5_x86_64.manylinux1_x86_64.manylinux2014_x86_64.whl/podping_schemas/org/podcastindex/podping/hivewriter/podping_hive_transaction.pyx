...
cdef class PodpingHiveTransaction(_Struct):
    ...
    @staticmethod
    cdef __new(object medium=0, object reason=0, object iris=None, object hiveTxId=None, object hiveBlockNum=0):
        ...
        builder.copy_from_list(pos + 16, _text_unicode_list_item_type, iris)
        builder.alloc_text(pos + 24, _encode_maybe(hiveTxId))
        builder.write_uint64(pos + 8, hiveBlockNum)
        return builder.as_string()
    
    def __init__(object self, object medium=0, object reason=0, object iris=None, object hiveTxId=None, object hiveBlockNum=0):
