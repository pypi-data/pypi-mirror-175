...
config = {
  'gamma' : {
              "CL0"      : ("CL", "gamma_B2KstarGammaType0", "PhotonCL", kernels),
              "CL1"      : ("CL", "gamma_B2KstarGammaType1", "PhotonCL", kernels),
              "IsPhoton0" : ("PP_IsPhoton", "gamma_B2KstarGammaType0", "IsPhoton", kernels),
              "IsPhoton1" : ("PP_IsPhoton", "gamma_B2KstarGammaType1", "IsPhoton", kernels),
            },
}
