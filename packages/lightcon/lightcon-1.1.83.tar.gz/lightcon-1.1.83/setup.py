...
setuptools.setup(
    ...
    install_requires = ['pythonnet>=2.5.0tcon', 'pyserial', 'numpy', 'matplotlib', 'requests'],
    ...
    data_files = [('Lib/site-packages/lightcon/harpia_daq', 
                ...
                ('Lib/site-packages/lightcon/eth_motor_board/config',
                    ['lightcon/eth_motor_board/Sanyo Denki SH2141-5541.json',
                     'lightcon/eth_motor_board/Standa 8CMA20.json',
                     'lightcon/eth_motor_board/Standa 8MT184-13.json']),
