...
class SemanticCompare:
    ...
    def __init__(
        self,
        server_url: str = st.secrets["semantha_streamlit_compare"]["server_url"],
        api_key: str = st.secrets["semantha_streamlit_compare"]["api_key"],
        domain: str = st.secrets["semantha_streamlit_compare"]["domain"]
