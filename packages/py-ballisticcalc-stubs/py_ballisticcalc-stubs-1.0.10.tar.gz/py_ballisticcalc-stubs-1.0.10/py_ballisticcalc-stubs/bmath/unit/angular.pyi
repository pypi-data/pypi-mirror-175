...
def __pyx_unpickle_Angular(*args, **kwargs): # real signature unknown
    pass
...
class Angular(object):
    # no doc
    def convert(self, units: int) -> Angular: # real signature unknown
        """
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001ABF86059B0>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001ABF6E11790>'

__spec__ = None # (!) real value is "ModuleSpec(name='py_ballisticcalc.bmath.unit.angular', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001ABF6E11790>, origin='C:\\\\Users\\\\Sergey\\\\PycharmProjects\\\\archer_ballistics_constructor\\\\venv11\\\\Lib\\\\site-packages\\\\py_ballisticcalc\\\\bmath\\\\unit\\\\angular.cp311-win_amd64.pyd')"
