...
def __pyx_unpickle_Weight(*args, **kwargs): # real signature unknown
    pass
...
class Weight(object):
    # no doc
    def convert(self, units: int) -> Weight: # real signature unknown
        """
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001EF1DB14690>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001EF1DB10D10>'

__spec__ = None # (!) real value is "ModuleSpec(name='py_ballisticcalc.bmath.unit.weight', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001EF1DB10D10>, origin='C:\\\\Users\\\\Sergey\\\\PycharmProjects\\\\archer_ballistics_constructor\\\\venv11\\\\Lib\\\\site-packages\\\\py_ballisticcalc\\\\bmath\\\\unit\\\\weight.cp311-win_amd64.pyd')"
