...
import aiokafka_commit.errors as Errors
from aiokafka_commit import __version__
from aiokafka_commit.conn import create_conn, CloseReason
from aiokafka_commit.cluster import ClusterMetadata
from aiokafka_commit.protocol.coordination import FindCoordinatorRequest
from aiokafka_commit.errors import (
    KafkaError,
    ...
    StaleMetadata)
from aiokafka_commit.util import (
...
log = logging.getLogger('aiokafka_commit')
...
class AIOKafkaClient:
    ...
    Keyword Arguments:
        ...
        client_id (str): a name for this client. This string is passed in
            ...
            consumer group administration. Default: 'aiokafka_commit-{ver}'
    ...
    def __init__(self, *, loop=None, bootstrap_servers='localhost',
                 client_id='aiokafka_commit-' + __version__,
    ...
    async def check_version(self, node_id=None):
        ...
        test_cases = [
            ...
            ((0, 8, 2), GroupCoordinatorRequest_v0('aiokafka_commit-default-group')),
            ((0, 8, 1), OffsetFetchRequest_v0('aiokafka_commit-default-group', [])),
