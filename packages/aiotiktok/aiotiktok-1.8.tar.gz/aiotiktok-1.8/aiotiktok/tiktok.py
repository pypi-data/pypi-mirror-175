...
class Tiktok():
    def __init__(self) -> None:
        ...
        self.tiktok_url = 'https://api-h2.tiktokv.com/aweme/v1/feed/?aweme_id={}&version_code=2613&aid=1180'
    ...
    async def tiktok(self, original_url: str):
        ...
        tiktok_api_link = self.tiktok_url.format(video_id)
