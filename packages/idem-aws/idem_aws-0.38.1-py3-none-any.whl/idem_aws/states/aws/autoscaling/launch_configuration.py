...
async def present(
    ...
    Args:
        name(str):
            Idem name of the launch configuration.

        launch_config_name(str):
            The name of the aws launch configuration. This name must be unique per Region per account.
        ...
        .. code-block:: sls
            ...
            idem-test-launch_configuration:
              aws.autoscaling.launch_configuration.present:
                ...
                - launch_config_name: test-launch_configuration
                - resource_id: test-launch_configuration
    ...
    desired_state = {
        "name": name,
        "resource_id": launch_config_name,
