...
class App(cmd2.Cmd):
    ...
    def do_download_dvl_data(self, download_dvl_args):
        ...
        fid = int(download_dvl_args.fid)
        sa = int(download_dvl_args.sa)
        length = int(download_dvl_args.length)
    ...
    def do_download_nucleus_data(self, download_nucleus_args):
        ...
        fid = int(download_nucleus_args.fid)
        sa = int(download_nucleus_args.sa)
        length = int(download_nucleus_args.length)
