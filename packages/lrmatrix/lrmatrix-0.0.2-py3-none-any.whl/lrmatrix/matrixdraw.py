...
def draw_range_matrix( matrix, col_values_min, col_values_max, matrix_row_categories, category_names,
	...
	draw_rows_left_legend( g_left_legend, rows_left_legend_1, rec_height, rows_left_legend_title_1, pad = pad, draw_rows_line = draw_rows_line, font_size = font_size, stroke_width = stroke_width )
