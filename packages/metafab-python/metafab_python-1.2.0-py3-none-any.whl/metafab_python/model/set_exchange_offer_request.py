...
class SetExchangeOfferRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        """SetExchangeOfferRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            input_collection_item_ids ([float]): An array of item ids from the provided input collection that are required to use this offer. Input items are transferred from the wallet to the exchange contract upon using an offer.. [optional]  # noqa: E501
            input_collection_item_amounts ([float]): An array of amounts for each item id from the provided input collection that are required to use this offer. Item amounts array indices are reflective of the amount required for a given item id at the same index.. [optional]  # noqa: E501
            ...
            output_collection_item_ids ([float]): An array of item ids from the provided output collection that are given by this offer. Output items are automatically minted if the exchange contract has the `minter` role for the output collection contract. Otherwise, they are transferred from the item balance held by the exchange contract.. [optional]  # noqa: E501
            output_collection_item_amounts ([float]): An array of amounts for each item id from the provided output collection that are given by this offer. Item amounts array indices are reflective of the amount required for a given item id at the same index.. [optional]  # noqa: E501
            ...
            max_uses (float): The maximum number of times this offer can be used in total. maxUses is collective across all uses of the offer. If 5 unique players use an offer, that counts as 5 offer uses. Exclude this or use 0 to allow unlimited uses.. [optional]  # noqa: E501
        """
