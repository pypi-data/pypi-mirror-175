...
def process_payment(payment_data: dict,
    ...
    if "application_fee" in payment_data.keys():
        if 0 < payment_data["application_fee"] < mp_payment_data['transaction_amount']:
            merchant_id = ObjectId('6178652dcfb117ad58a2cd3d')
            mp_payment_data["application_fee"] = round(payment_data["application_fee"], 2)
...
def create_payment_data_for_sdk(price: int,
    ...
    if application_fee:
        payment_data["application_fee"] = round(application_fee * price, 2)
