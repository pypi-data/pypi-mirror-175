...
from pytestshellutils.shell import Factory
...
class FactoriesManager:
    ...
    code_dir = attr.ib(default=None, converter=cast_to_pathlib_path)
    ...
    def _default_environ(self) -> EnvironDict:
        return EnvironDict(**os.environ.copy())

    def final_minion_config_tweaks(self, config: Dict[str, Any]) -> None:
        """
    ...
    def final_master_config_tweaks(self, config: Dict[str, Any]) -> None:
        """
    ...
    def final_syndic_config_tweaks(self, config: Dict[str, Any]) -> None:
        """
        Final tweaks to the syndic configuration.
        """
        self.final_common_config_tweaks(config, 'syndic')

    def final_proxy_minion_config_tweaks(self, config: Dict[str, Any]) -> None:
        """
        Final tweaks to the proxy-minion configuration.
        """
        self.final_common_config_tweaks(config, 'minion')

    def final_cloud_config_tweaks(self, config: Dict[str, Any]) -> None:
        """
        Final tweaks to the cloud configuration.
        """
        self.final_common_config_tweaks(config, 'cloud')

    def final_common_config_tweaks(self, config: Dict[str, Any], role: str) -> None:
        """
    ...
    def salt_master_daemon(
        self,
        master_id: str,
        order_masters: bool = False,
        master_of_masters: Optional[bool] = None,
        defaults: Optional[Dict[str, Any]] = None,
        overrides: Optional[Dict[str, Any]] = None,
        max_start_attempts: int = 3,
        start_timeout: Optional[int] = None,
        factory_class: Type[SaltDaemon] = daemons.master.SaltMaster,
        **factory_class_kwargs: Any
    ) -> daemons.master.SaltMaster:
        """
    ...
    def salt_minion_daemon(
        ...
        start_timeout=None,
        factory_class: Type[SaltDaemon] = daemons.minion.SaltMinion,
        **factory_class_kwargs
    ) -> daemons.minionSaltMinion:
        """
    ...
    def salt_syndic_daemon(
        ...
        max_start_attempts=3,
        start_timeout=None,
        factory_class: Type[SaltDaemon] = daemons.syndic.SaltSyndic,
        master_defaults=None,
        master_overrides=None,
        master_factory_class: Type[SaltDaemon] = daemons.master.SaltMaster,
        minion_defaults=None,
        minion_overrides=None,
        minion_factory_class: Type[SaltDaemon] = daemons.minion.SaltMinion,
        **factory_class_kwargs
    ) -> daemons.syndic.SaltSyndic:
        """
    ...
    def salt_proxy_minion_daemon(
        ...
        max_start_attempts=3,
        start_timeout=None,
        factory_class: Type[SaltDaemon] = daemons.proxy.SaltProxyMinion,
        **factory_class_kwargs
    ) -> daemons.proxy.SaltProxyMinion:
        """
    ...
    def salt_api_daemon(
        ...
        max_start_attempts=3,
        start_timeout=None,
        factory_class: Type[SaltDaemon] = daemons.api.SaltApi,
        **factory_class_kwargs
    ) -> daemons.api.SaltApi:
        """
    ...
    def get_sshd_daemon(
        ...
        max_start_attempts=3,
        start_timeout=None,
        factory_class: Type[daemons.sshd.Sshd] = daemons.sshd.Sshd,
        **factory_class_kwargs
    ) -> daemons.sshd.Sshd:
        """
    ...
    def get_container(
        ...
        image_name,
        display_name=None,
        factory_class: Type[daemons.container.Container] = daemons.container.Container,
        max_start_attempts=3,
        start_timeout=None,
        **factory_class_kwargs
    ) -> daemons.container.Container:
        """
    ...
    def get_salt_script_path(self, script_name: str) -> str:
        """
    ...
    def get_root_dir_for_daemon(
        self,
        daemon_id: str,
        defaults: Optional[Dict[str, Any]] = None,
        factory_class: Optional[Factory] = None,
    ) -> pathlib.Path:
        """
