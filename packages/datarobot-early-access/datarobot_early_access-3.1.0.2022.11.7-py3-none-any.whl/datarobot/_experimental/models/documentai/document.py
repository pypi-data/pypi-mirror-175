...
class DocumentTextExtractionSampleDocument(APIObject):
    ...
    actual_target_value: str
        Actual target value
    prediction: Dict[str, List[PredictionType]]
    ...
    _converter = t.Dict(
        {
            t.Key("document_index", optional=True): t.Int(),
            t.Key("feature_name", optional=True): t.String(),
            t.Key("actual_target_value", optional=True): t.String(),
            t.Key("prediction", optional=True): t.Dict(
                {"values": t.List(t.Float()), "labels": t.List(t.String())}
            ),
            t.Key("thumbnail_id", optional=True): t.String(),
            t.Key("thumbnail_width", optional=True): t.Int(),
            t.Key("thumbnail_height", optional=True): t.Int(),
            t.Key("thumbnail_link", optional=True): t.String(),
            t.Key("document_task", optional=True): t.String(),
        }
    ).ignore_extra("*")
    ...
    def __init__(
        ...
        feature_name: str,
        actual_target_value: str,
        prediction: List[PredictionType],
        thumbnail_id: str,
        thumbnail_width: int,
        thumbnail_height: int,
        thumbnail_link: str,
...
class DocumentTextExtractionSamplePage(APIObject):
    ...
    _converter = t.Dict(
        {
            t.Key("document_task", optional=True): t.String(),
            t.Key("page_index", optional=True): t.Int(),
            t.Key("document_index", optional=True): t.Int(),
            t.Key("feature_name", optional=True): t.String(),
            t.Key("actual_target_value", optional=True): t.String(),
            t.Key("prediction", optional=True): t.Dict(
            ...
            t.Key("document_page_width", optional=True): t.Int(),
            t.Key("document_page_height", optional=True): t.Int(),
            t.Key("document_page_link", optional=True): t.String(),
            t.Key("text_lines", optional=True): t.List(
                t.Dict(
                    {
                        t.Key("left", optional=True): t.Int(),
                        t.Key("top", optional=True): t.Int(),
                        t.Key("right", optional=True): t.Int(),
                        t.Key("bottom", optional=True): t.Int(),
                        t.Key("text", optional=True): t.String(),
                    }
                )
            ),
            t.Key("document_task", optional=True): t.String(),
