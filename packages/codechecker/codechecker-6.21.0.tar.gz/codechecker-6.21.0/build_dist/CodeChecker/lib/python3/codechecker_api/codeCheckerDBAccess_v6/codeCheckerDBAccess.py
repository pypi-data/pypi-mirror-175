...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i336 in range(_size332):
                        ...
                        self.skipDetectionStatuses.append(_elem337)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter345 in self.reportHashes:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter424, viter425 in self.success.items():
                oprot.writeString(kiter424.encode('utf-8') if sys.version_info[0] == 2 else kiter424)
                oprot.writeListBegin(TType.STRUCT, len(viter425))
                for iter426 in viter425:
                    iter426.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i431 in range(_size427):
                        _elem432 = LinesInFilesRequested()
                        _elem432.read(iprot)
                        self.linesInFilesRequested.append(_elem432)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter433 in self.linesInFilesRequested:
                iter433.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i438 in range(_size434):
                        ...
                        for _i445 in range(_size441):
                            _key446 = iprot.readI64()
                            _val447 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _val440[_key446] = _val447
                        iprot.readMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter448, viter449 in self.success.items():
                oprot.writeI64(kiter448)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter449))
                for kiter450, viter451 in viter449.items():
                ...
                if ftype == TType.LIST:
                    ...
                    for _i477 in range(_size473):
                        ...
                        for _i483 in range(_size479):
                            _elem484 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                            _elem478.append(_elem484)
                        iprot.readListEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter485 in self.success:
                oprot.writeListBegin(TType.STRING, len(iter485))
                for iter486 in iter485:
...
class getDetectionStatusCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter555 in self.runIds:
                oprot.writeI64(iter555)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i560 in range(_size556):
                        _key561 = iprot.readI32()
                        _val562 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter563, viter564 in self.success.items():
                oprot.writeI32(kiter563)
                oprot.writeI64(viter564)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i629 in range(_size625):
                        ...
                        self.sourceComponentFilter.append(_elem630)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter631 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i643 in range(_size639):
                        ...
                        self.fileHashes.append(_elem644)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter645 in self.fileHashes:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i650 in range(_size646):
                        _elem651 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getMissingContentHashesForBlameInfo_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i657 in range(_size653):
                        _elem658 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.fileHashes.append(_elem658)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            oprot.writeFieldBegin('fileHashes', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.fileHashes))
            for iter659 in self.fileHashes:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i664 in range(_size660):
                        _elem665 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i671 in range(_size667):
                        _elem672 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.trimPathPrefixes.append(_elem672)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter673 in self.trimPathPrefixes:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter681, viter682 in self.success.items():
                oprot.writeI32(kiter681)
                oprot.writeI64(viter682)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i687 in range(_size683):
                        _key688 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val689 = AnalyzerStatistics()
                        _val689.read(iprot)
...
class setCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i703 in range(_size699):
                        ...
                        self.reportHashes.append(_elem704)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter705 in self.reportHashes:
...
class unsetCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i710 in range(_size706):
                        _elem711 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.reportHashes.append(_elem711)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter712 in self.reportHashes:
