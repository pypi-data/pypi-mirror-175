...
class OriginVerify(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        origin: typing.Union[aws_cdk.aws_apigateway.IStage, aws_cdk.aws_elasticloadbalancingv2.IApplicationLoadBalancer],
...
class OriginVerifyProps:
    ...
    def origin(
        self,
    ) -> typing.Union[aws_cdk.aws_apigateway.IStage, aws_cdk.aws_elasticloadbalancingv2.IApplicationLoadBalancer]:
        ...
        return typing.cast(typing.Union[aws_cdk.aws_apigateway.IStage, aws_cdk.aws_elasticloadbalancingv2.IApplicationLoadBalancer], result)
