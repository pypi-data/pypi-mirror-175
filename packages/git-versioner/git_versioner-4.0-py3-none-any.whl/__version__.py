...
def setup_keyword(dist: setuptools.Distribution, keyword, value):
    global version_py, version_py_short
    if not value:
        return
    ...
    dist.cmdclass['snapshot-version'] = VersionCommand
    ...
    if "sdist" in dist.script_args:
        ...
        distutils.command.sdist.sdist.sub_commands.append(('snapshot-version', None))
    ...
    if "snapshot" in value:
        ...
        distutils.command.build.build.sub_commands.append(('snapshot-version', None))
