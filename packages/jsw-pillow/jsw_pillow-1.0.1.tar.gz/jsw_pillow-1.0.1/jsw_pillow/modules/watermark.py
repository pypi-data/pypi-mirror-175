...
class Watermark:
    ...
    def single(cls, **kwargs):
        original_image, rotated_text_image, watermarks_image, dest = cls._preprocess(**kwargs)
    ...
    def _preprocess(cls, **kwargs):
        ...
        dest = kwargs.get('dest', f'{filename}.watermark{ext}')
        ...
        return original_image, rotated_text_image, watermarks_image, dest
