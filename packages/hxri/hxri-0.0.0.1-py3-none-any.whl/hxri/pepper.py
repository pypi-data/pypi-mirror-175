...
class Tracking(ALModule):
    ...
    def onRun(self, input_ = "enable", parameters = {"use_body":"Head", "use_arms":"None"}, parallel = False):
...
class SensorEvents:
    ...
    def getValue(self,sensor):
        return self.memoryProxy.getData(sensor)
...
class BodyMove:
    ...
    def onLoad(self):
        try: 
            ...
            if self.robot == "pepper"or self.robot == "Pepper":
    ...
    def onBreathe(self, input_ = "", parameters = {}, parallel = False):
        try:
            if input_ == "on":
                ...
                self.backgroundProxy.setEnabled(False)
        except:
            pass
