...
class btaConnection:
    ...
    def get_activity(self, btid, rformat="json"):
        ...
        data = self.query(resource="aktivitaet", fid=btid, rformat=rformat)
        return data
    ...
    def get_procedure(self, btid, rformat="json"):
        ...
        data = self.query(resource="vorgang", fid=btid, rformat=rformat)
        return data
    ...
    def get_procedureposition(self, btid, rformat="json"):
        ...
        data = self.query(resource="vorgangsposition", fid=btid, rformat=rformat)
        return data
    ...
    def get_document(self, btid, rformat="json"):
        ...
        data = self.query(resource="drucksache-text", fid=btid, rformat=rformat)
        return data
    ...
    def get_plenaryprotocol(self, btid, rformat="json"):
        ...
        data = self.query(resource="plenarprotokoll-text", fid=btid, rformat=rformat)
        return data
