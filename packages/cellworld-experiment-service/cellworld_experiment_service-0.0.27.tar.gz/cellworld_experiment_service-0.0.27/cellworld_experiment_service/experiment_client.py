...
class ExperimentClient(MessageClient):
    ...
    def resume_experiment(self, experiment_name: str, duration_extension: int):
        return self.send_request(Message("resume_experiment", ResumeExperimentRequest(experiment_name=experiment_name, duration_extension=duration_extension)), 5000).get_body(bool)
