...
# -------------------------------------------
# monkeypatch betterproto with the fix from
# https://github.com/danielgtaylor/python-betterproto/commit/bfc0fac7544bbdf4e0e2beabd45482a4958af514
# remove when commit is released


def _overbytes(self) -> bytes:
    """
...
setattr(Message, "__bytes__", _overbytes)
