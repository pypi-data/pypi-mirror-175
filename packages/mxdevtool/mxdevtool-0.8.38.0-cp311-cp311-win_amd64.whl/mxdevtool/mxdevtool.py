...
class Observable(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(Observable self) -> bool"""
        return _mxdevtool.Observable___bool__(self)
...
class YieldTermStructure(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(YieldTermStructure self) -> bool"""
        return _mxdevtool.YieldTermStructure___bool__(self)
...
class Extrapolation(object):
    ...
    def type(self) -> "Extrapolator1D::Type":
...
class Index(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(Index self) -> bool"""
        return _mxdevtool.Index___bool__(self)
...
class core_IndexMC(Index):
    r"""Proxy of C++ IndexMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(core_IndexMC self) -> core_IndexMC"""
        _mxdevtool.core_IndexMC_swiginit(self, _mxdevtool.new_core_IndexMC())
    __swig_destroy__ = _mxdevtool.delete_core_IndexMC

# Register core_IndexMC in _mxdevtool:
_mxdevtool.core_IndexMC_swigregister(core_IndexMC)

class core_SwapIndex(InterestRateIndex):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_SwapIndex self, std::string const & familyName, Period tenor, Integer settlementDays, Currency currency, Calendar calendar, Period fixedLegTenor, BusinessDayConvention fixedLegConvention, DayCounter fixedLegDayCounter, core_IborIndex iborIndex) -> core_SwapIndex
        __init__(core_SwapIndex self, std::string const & familyName, Period tenor, Integer settlementDays, Currency currency, Calendar calendar, Period fixedLegTenor, BusinessDayConvention fixedLegConvention, DayCounter fixedLegDayCounter, core_IborIndex iborIndex, YieldTermStructureHandle discountCurve) -> core_SwapIndex
        """
        _mxdevtool.core_SwapIndex_swiginit(self, _mxdevtool.new_core_SwapIndex(*args))

    def fixedLegTenor(self) -> "Period":
        r"""fixedLegTenor(core_SwapIndex self) -> Period"""
        return _mxdevtool.core_SwapIndex_fixedLegTenor(self)

    def fixedLegConvention(self) -> "BusinessDayConvention":
        r"""fixedLegConvention(core_SwapIndex self) -> BusinessDayConvention"""
        return _mxdevtool.core_SwapIndex_fixedLegConvention(self)

    def iborIndex(self) -> "IborIndexPtr":
        r"""iborIndex(core_SwapIndex self) -> core_IborIndex"""
        return _mxdevtool.core_SwapIndex_iborIndex(self)

    def forwardingTermStructure(self) -> "Handle< YieldTermStructure >":
        r"""forwardingTermStructure(core_SwapIndex self) -> YieldTermStructureHandle"""
        return _mxdevtool.core_SwapIndex_forwardingTermStructure(self)
    __swig_destroy__ = _mxdevtool.delete_core_SwapIndex

# Register core_SwapIndex in _mxdevtool:
_mxdevtool.core_SwapIndex_swigregister(core_SwapIndex)
...
class Quote(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(Quote self) -> bool"""
        return _mxdevtool.Quote___bool__(self)
...
class PricingEngine(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(PricingEngine self) -> bool"""
        return _mxdevtool.PricingEngine___bool__(self)
...
class Instrument(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(Instrument self) -> bool"""
        return _mxdevtool.Instrument___bool__(self)
...
class core_StructuredSwap(Instrument):
    r"""Proxy of C++ StructuredSwapPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, payLegInfo: "LegInfo", recLegInfo: "LegInfo"):
        r"""__init__(core_StructuredSwap self, LegInfo payLegInfo, LegInfo recLegInfo) -> core_StructuredSwap"""
        _mxdevtool.core_StructuredSwap_swiginit(self, _mxdevtool.new_core_StructuredSwap(payLegInfo, recLegInfo))

    def _setPricingParams_Scen(self, pay_discount: "std::string", rec_discount: "std::string", regression_index_names: "StrVector", scen_filename: "std::string") -> "void":
        r"""_setPricingParams_Scen(core_StructuredSwap self, std::string pay_discount, std::string rec_discount, StrVector regression_index_names, std::string scen_filename)"""
        return _mxdevtool.core_StructuredSwap__setPricingParams_Scen(self, pay_discount, rec_discount, regression_index_names, scen_filename)
...
class CashFlow(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(CashFlow self) -> bool"""
        return _mxdevtool.CashFlow___bool__(self)
...
class FloatingRateCouponPricer(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(FloatingRateCouponPricer self) -> bool"""
        return _mxdevtool.FloatingRateCouponPricer___bool__(self)
...
def CmsLeg(*args, **kwargs) -> "Leg":
    r"""CmsLeg(DoubleVector nominals, Schedule schedule, core_SwapIndex index, DayCounter paymentDayCounter=DayCounter(), BusinessDayConvention const paymentConvention=Following, UnsignedIntVector fixingDays=std::vector< Natural >(), DoubleVector gearings=std::vector< Real >(), DoubleVector spreads=std::vector< Spread >(), DoubleVector caps=std::vector< Rate >(), DoubleVector floors=std::vector< Rate >(), bool isInArrears=False) -> Leg"""
    return _mxdevtool.CmsLeg(*args, **kwargs)

def CmsZeroLeg(*args, **kwargs) -> "Leg":
    r"""CmsZeroLeg(DoubleVector nominals, Schedule schedule, core_SwapIndex index, DayCounter paymentDayCounter=DayCounter(), BusinessDayConvention const paymentConvention=Following, UnsignedIntVector fixingDays=std::vector< Natural >(), DoubleVector gearings=std::vector< Real >(), DoubleVector spreads=std::vector< Spread >(), DoubleVector caps=std::vector< Rate >(), DoubleVector floors=std::vector< Rate >()) -> Leg"""
...
class LegExerciseOption(object):
    r"""Proxy of C++ boost::shared_ptr< LegExerciseOption > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __deref__(self) -> "LegExerciseOption *":
        r"""__deref__(LegExerciseOption self) -> LegExerciseOption *"""
        return _mxdevtool.LegExerciseOption___deref__(self)

    def __nonzero__(self) -> "bool":
        r"""__nonzero__(LegExerciseOption self) -> bool"""
        return _mxdevtool.LegExerciseOption___nonzero__(self)

    def __bool__(self) -> "bool":
        r"""__bool__(LegExerciseOption self) -> bool"""
        return _mxdevtool.LegExerciseOption___bool__(self)

    def __init__(self):
        r"""__init__(LegExerciseOption self) -> LegExerciseOption"""
        _mxdevtool.LegExerciseOption_swiginit(self, _mxdevtool.new_LegExerciseOption())
...
class core_StructuredLegExerciseOption(LegExerciseOption):
    r"""Proxy of C++ StructuredLegExerciseOptionPtr class."""
...
class LegInfo(object):
    r"""Proxy of C++ boost::shared_ptr< LegInfo > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __deref__(self) -> "LegInfo *":
        r"""__deref__(LegInfo self) -> LegInfo *"""
        return _mxdevtool.LegInfo___deref__(self)

    def __nonzero__(self) -> "bool":
        r"""__nonzero__(LegInfo self) -> bool"""
        return _mxdevtool.LegInfo___nonzero__(self)

    def __bool__(self) -> "bool":
        r"""__bool__(LegInfo self) -> bool"""
        return _mxdevtool.LegInfo___bool__(self)

    def __init__(self):
        r"""__init__(LegInfo self) -> LegInfo"""
        _mxdevtool.LegInfo_swiginit(self, _mxdevtool.new_LegInfo())
...
class core_VanillaLegInfo(LegInfo):
    r"""Proxy of C++ VanillaLegInfoPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, coupons: "Leg", currency: "Currency"):
...
class core_StructuredLegInfo(LegInfo):
    r"""Proxy of C++ StructuredLegInfoPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(core_StructuredLegInfo self, Leg coupons, Currency currency, LegExerciseOption option=boost::shared_ptr< LegExerciseOption >()) -> core_StructuredLegInfo"""
...
class core_CouponMC(CashFlow):
    r"""Proxy of C++ CouponMCPtr class."""
    ...
    def nominal(self) -> "Real":
        r"""nominal(core_CouponMC self) -> Real"""
        return _mxdevtool.core_CouponMC_nominal(self)

    def accrualStartDate(self) -> "Date":
        r"""accrualStartDate(core_CouponMC self) -> Date"""
        return _mxdevtool.core_CouponMC_accrualStartDate(self)

    def accrualEndDate(self) -> "Date":
        r"""accrualEndDate(core_CouponMC self) -> Date"""
        return _mxdevtool.core_CouponMC_accrualEndDate(self)

    def accrualPeriod(self) -> "Time":
        r"""accrualPeriod(core_CouponMC self) -> Time"""
        return _mxdevtool.core_CouponMC_accrualPeriod(self)

    def accrualDays(self) -> "BigInteger":
        r"""accrualDays(core_CouponMC self) -> BigInteger"""
        return _mxdevtool.core_CouponMC_accrualDays(self)

    def dayCounter(self) -> "DayCounter":
        r"""dayCounter(core_CouponMC self) -> DayCounter"""
        return _mxdevtool.core_CouponMC_dayCounter(self)

    def accruedAmount(self) -> "Real":
        r"""accruedAmount(core_CouponMC self) -> Real"""
        return _mxdevtool.core_CouponMC_accruedAmount(self)

    def pv(self) -> "Real":
        r"""pv(core_CouponMC self) -> Real"""
        return _mxdevtool.core_CouponMC_pv(self)

    def discount(self) -> "Real":
        r"""discount(core_CouponMC self) -> Real"""
        return _mxdevtool.core_CouponMC_discount(self)
    __swig_destroy__ = _mxdevtool.delete_core_CouponMC

# Register core_CouponMC in _mxdevtool:
_mxdevtool.core_CouponMC_swigregister(core_CouponMC)

class core_FloatingRateCouponMC(core_CouponMC):
    r"""Proxy of C++ FloatingRateCouponMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, paymentDate: "Date", nominal: "Real", startDate: "Date", endDate: "Date", fixingDays: "Natural", indexPayoffMC: "PayoffMC", calendar: "Calendar", dayCounter: "DayCounter", gearing: "Real"=1.0, spread: "Spread"=0.0, isInArrears: "bool"=False):
        r"""__init__(core_FloatingRateCouponMC self, Date paymentDate, Real nominal, Date startDate, Date endDate, Natural fixingDays, PayoffMC indexPayoffMC, Calendar calendar, DayCounter dayCounter, Real gearing=1.0, Spread spread=0.0, bool isInArrears=False) -> core_FloatingRateCouponMC"""
        _mxdevtool.core_FloatingRateCouponMC_swiginit(self, _mxdevtool.new_core_FloatingRateCouponMC(paymentDate, nominal, startDate, endDate, fixingDays, indexPayoffMC, calendar, dayCounter, gearing, spread, isInArrears))
...
class core_RateAccrualCouponMC(core_CouponMC):
    r"""Proxy of C++ RateAccrualCouponMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(core_RateAccrualCouponMC self, Date paymentDate, Real nominal, PayoffMC payoffMC, Date accrualStartDate, Date accrualEndDate, Calendar calendar, DayCounter dayCounter, Real accruedRate=Null< Real >()) -> core_RateAccrualCouponMC"""
...
class CmsRateBond(Bond):
    ...
    def __init__(self, *args, **kwargs):
        r"""__init__(CmsRateBond self, Size settlementDays, Real faceAmount, Schedule schedule, core_SwapIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Natural fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps, DoubleVector floors, bool inArrears=False, Real redemption=100.0, Date issueDate=Date()) -> CmsRateBond"""
...
class Simplex(OptimizationMethod):
    ...
    def __init__(self, _lambda: "Real"):
        r"""__init__(Simplex self, Real _lambda) -> Simplex"""
        _mxdevtool.Simplex_swiginit(self, _mxdevtool.new_Simplex(_lambda))

    def getLambda(self) -> "Real":
...
class LevenbergMarquardt(OptimizationMethod):
    ...
    def __init__(self, epsfcn: "Real"=1.0e-8, xtol: "Real"=1.0e-8, gtol: "Real"=1.0e-8, useCostFunctionsJacobian: "bool"=False):
...
class BlackVolTermStructure(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(BlackVolTermStructure self) -> bool"""
        return _mxdevtool.BlackVolTermStructure___bool__(self)
...
class SwaptionVolatilityStructure(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(SwaptionVolatilityStructure self) -> bool"""
        return _mxdevtool.SwaptionVolatilityStructure___bool__(self)
    ...
    def referenceDate(self) -> "Date":
        r"""referenceDate(SwaptionVolatilityStructure self) -> Date"""
        return _mxdevtool.SwaptionVolatilityStructure_referenceDate(self)

    def dayCounter(self) -> "DayCounter":
        r"""dayCounter(SwaptionVolatilityStructure self) -> DayCounter"""
        return _mxdevtool.SwaptionVolatilityStructure_dayCounter(self)

    def calendar(self) -> "Calendar":
        r"""calendar(SwaptionVolatilityStructure self) -> Calendar"""
        return _mxdevtool.SwaptionVolatilityStructure_calendar(self)

    def maxSwapTenor(self) -> "Period":
        r"""maxSwapTenor(SwaptionVolatilityStructure self) -> Period"""
        return _mxdevtool.SwaptionVolatilityStructure_maxSwapTenor(self)

    def maxSwapLength(self) -> "Time":
        r"""maxSwapLength(SwaptionVolatilityStructure self) -> Time"""
        return _mxdevtool.SwaptionVolatilityStructure_maxSwapLength(self)

    def minStrike(self) -> "Real":
        r"""minStrike(SwaptionVolatilityStructure self) -> Real"""
        return _mxdevtool.SwaptionVolatilityStructure_minStrike(self)

    def maxStrike(self) -> "Real":
        r"""maxStrike(SwaptionVolatilityStructure self) -> Real"""
        return _mxdevtool.SwaptionVolatilityStructure_maxStrike(self)

    def volatility(self, *args) -> "Volatility":
        r"""
        volatility(SwaptionVolatilityStructure self, Period optionTenor, Period swapTenor, Rate strike, bool extrapolate=False) -> Volatility
        volatility(SwaptionVolatilityStructure self, Date optionDate, Period swapTenor, Rate strike, bool extrapolate=False) -> Volatility
        volatility(SwaptionVolatilityStructure self, Time optionTime, Period swapTenor, Rate strike, bool extrapolate=False) -> Volatility
        volatility(SwaptionVolatilityStructure self, Period optionTenor, Time swapLength, Rate strike, bool extrapolate=False) -> Volatility
        volatility(SwaptionVolatilityStructure self, Date optionDate, Time swapLength, Rate strike, bool extrapolate=False) -> Volatility
        volatility(SwaptionVolatilityStructure self, Time optionTime, Time swapLength, Rate strike, bool extrapolate=False) -> Volatility
        """
    ...
    def enableExtrapolation(self) -> "void":
        r"""enableExtrapolation(SwaptionVolatilityStructure self)"""
        return _mxdevtool.SwaptionVolatilityStructure_enableExtrapolation(self)

    def disableExtrapolation(self) -> "void":
        r"""disableExtrapolation(SwaptionVolatilityStructure self)"""
        return _mxdevtool.SwaptionVolatilityStructure_disableExtrapolation(self)

    def allowsExtrapolation(self) -> "bool":
        r"""allowsExtrapolation(SwaptionVolatilityStructure self) -> bool"""
        return _mxdevtool.SwaptionVolatilityStructure_allowsExtrapolation(self)
...
class core_ConstantSwaptionVolatility(SwaptionVolatilityStructure):
    r"""Proxy of C++ ConstantSwaptionVolatilityPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, referenceDate: "Date", cal: "Calendar", bdc: "BusinessDayConvention", volatility: "Volatility", dc: "DayCounter", type: "VolatilityType"=ShiftedLognormal, shift: "Real"=0.0):
        r"""__init__(core_ConstantSwaptionVolatility self, Date referenceDate, Calendar cal, BusinessDayConvention bdc, Volatility volatility, DayCounter dc, VolatilityType type=ShiftedLognormal, Real shift=0.0) -> core_ConstantSwaptionVolatility"""
        _mxdevtool.core_ConstantSwaptionVolatility_swiginit(self, _mxdevtool.new_core_ConstantSwaptionVolatility(referenceDate, cal, bdc, volatility, dc, type, shift))
    __swig_destroy__ = _mxdevtool.delete_core_ConstantSwaptionVolatility

# Register core_ConstantSwaptionVolatility in _mxdevtool:
_mxdevtool.core_ConstantSwaptionVolatility_swigregister(core_ConstantSwaptionVolatility)

class core_SwaptionVolatilityMatrix(SwaptionVolatilityStructure):
    r"""Proxy of C++ SwaptionVolatilityMatrixPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_SwaptionVolatilityMatrix self, Date referenceDate, Calendar calendar, BusinessDayConvention bdc, PeriodVector optionTenors, PeriodVector swapTenors, Matrix volatilities, DayCounter dayCounter, bool flatExtrapolation=False, VolatilityType type=ShiftedLognormal, Matrix shifts=Matrix()) -> core_SwaptionVolatilityMatrix
        __init__(core_SwaptionVolatilityMatrix self, Date referenceDate, Calendar calendar, BusinessDayConvention bdc, DateVector optionDates, PeriodVector swapTenors, Matrix volatilities, DayCounter dayCounter, bool flatExtrapolation=False, VolatilityType type=ShiftedLognormal, Matrix shifts=Matrix()) -> core_SwaptionVolatilityMatrix
        """
        _mxdevtool.core_SwaptionVolatilityMatrix_swiginit(self, _mxdevtool.new_core_SwaptionVolatilityMatrix(*args))
    __swig_destroy__ = _mxdevtool.delete_core_SwaptionVolatilityMatrix

# Register core_SwaptionVolatilityMatrix in _mxdevtool:
_mxdevtool.core_SwaptionVolatilityMatrix_swigregister(core_SwaptionVolatilityMatrix)
...
class Parameter(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(Parameter self) -> bool"""
        return _mxdevtool.Parameter___bool__(self)
...
class ProcessValue(object):
    ...
    def __bool__(self) -> "bool":
        r"""__bool__(ProcessValue self) -> bool"""
        return _mxdevtool.ProcessValue___bool__(self)
...
class core_ProcessModel(core_ProcessValue):
    ...
    def factors(self) -> "Size":
        r"""factors(core_ProcessModel self) -> Size"""
        return _mxdevtool.core_ProcessModel_factors(self)
...
class core_RsgLatinHs(IRsgWrapper):
    ...
    def __init__(self, baseRsg: "IRsgWrapper", dimension: "long", randomTransformType: "std::string const &"):
        r"""
...
class core_ScenarioGenerator(IEvolverBase):
    ...
    def generate(self) -> "void":
        r"""generate(core_ScenarioGenerator self)"""
...
class core_ScenarioGenerator2(IEvolverBase):
    ...
    def generate(self) -> "void":
        r"""generate(core_ScenarioGenerator2 self)"""
...
class core_ModelCalibrator(object):
    ...
    def calibrate_model(self, *args) -> "std::vector< double,std::allocator< double > >":
        r"""calibrate_model(core_ModelCalibrator self, core_ProcessModel processModel, CalibrationHelperVector helpers, OptimizationMethod method, EndCriteria criteria, Constraint constraint=Constraint(), DoubleVector weights=std::vector< Real >(), BoolVector fixParameters=std::vector< bool >()) -> DoubleVector"""
...
class BlackCalibrationHelper(CalibrationHelper):
    ...
    def setPricingEngine(self, engine: "PricingEngine") -> "void":
        r"""setPricingEngine(BlackCalibrationHelper self, PricingEngine engine)"""
...
def as_black_helper(h: "boost::shared_ptr< CalibrationHelper > const &") -> "boost::shared_ptr< BlackCalibrationHelper >":
    r"""as_black_helper(boost::shared_ptr< CalibrationHelper > const & h) -> boost::shared_ptr< BlackCalibrationHelper >"""
    return _mxdevtool.as_black_helper(h)

def as_swaption_helper(h: "boost::shared_ptr< BlackCalibrationHelper > const &") -> "boost::shared_ptr< SwaptionHelper >":
    r"""as_swaption_helper(boost::shared_ptr< BlackCalibrationHelper > const & h) -> boost::shared_ptr< SwaptionHelper >"""
    return _mxdevtool.as_swaption_helper(h)
class core_SwaptionHelper(BlackCalibrationHelper):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_SwaptionHelper self, Period maturity, Period length, QuoteHandle volatility, Index index, Period fixedLegTenor, DayCounter fixedLegDayCounter, DayCounter floatingLegDayCounter, YieldTermStructureHandle termStructure, BlackCalibrationHelper::CalibrationErrorType errorType=RelativePriceError, Real const strike=Null< Real >(), Real const nominal=1.0, VolatilityType const type=ShiftedLognormal, Real const shift=0.0) -> core_SwaptionHelper
        __init__(core_SwaptionHelper self, Date exerciseDate, Period length, QuoteHandle volatility, Index index, Period fixedLegTenor, DayCounter fixedLegDayCounter, DayCounter floatingLegDayCounter, YieldTermStructureHandle termStructure, BlackCalibrationHelper::CalibrationErrorType errorType=RelativePriceError, Real const strike=Null< Real >(), Real const nominal=1.0, VolatilityType const type=ShiftedLognormal, Real const shift=0.0) -> core_SwaptionHelper
        __init__(core_SwaptionHelper self, Date exerciseDate, Date endDate, QuoteHandle volatility, Index index, Period fixedLegTenor, DayCounter fixedLegDayCounter, DayCounter floatingLegDayCounter, YieldTermStructureHandle termStructure, BlackCalibrationHelper::CalibrationErrorType errorType=RelativePriceError, Real const strike=Null< Real >(), Real const nominal=1.0, VolatilityType const type=ShiftedLognormal, Real const shift=0.0) -> core_SwaptionHelper
        """
        _mxdevtool.core_SwaptionHelper_swiginit(self, _mxdevtool.new_core_SwaptionHelper(*args))

    def underlyingSwap(self) -> "boost::shared_ptr< VanillaSwap >":
        r"""underlyingSwap(core_SwaptionHelper self) -> boost::shared_ptr< VanillaSwap >"""
        return _mxdevtool.core_SwaptionHelper_underlyingSwap(self)

    def swaption(self) -> "boost::shared_ptr< Swaption >":
        r"""swaption(core_SwaptionHelper self) -> boost::shared_ptr< Swaption >"""
        return _mxdevtool.core_SwaptionHelper_swaption(self)

    def times(self) -> "std::vector< Time,std::allocator< Time > >":
        r"""times(core_SwaptionHelper self) -> DoubleVector"""
        return _mxdevtool.core_SwaptionHelper_times(self)

    def swaptionExpiryDate(self) -> "Date":
        r"""swaptionExpiryDate(core_SwaptionHelper self) -> Date"""
        return _mxdevtool.core_SwaptionHelper_swaptionExpiryDate(self)

    def swaptionStrike(self) -> "Real":
        r"""swaptionStrike(core_SwaptionHelper self) -> Real"""
        return _mxdevtool.core_SwaptionHelper_swaptionStrike(self)

    def swaptionNominal(self) -> "Real":
        r"""swaptionNominal(core_SwaptionHelper self) -> Real"""
        return _mxdevtool.core_SwaptionHelper_swaptionNominal(self)

    def swaptionMaturityDate(self) -> "Date":
        r"""swaptionMaturityDate(core_SwaptionHelper self) -> Date"""
        return _mxdevtool.core_SwaptionHelper_swaptionMaturityDate(self)
    __swig_destroy__ = _mxdevtool.delete_core_SwaptionHelper

# Register core_SwaptionHelper in _mxdevtool:
_mxdevtool.core_SwaptionHelper_swigregister(core_SwaptionHelper)

class core_CapHelper(BlackCalibrationHelper):
    ...
    def __init__(self, *args):
        r"""__init__(core_CapHelper self, Period length, QuoteHandle volatility, boost::shared_ptr< IborIndex > const & index, Frequency fixedLegFrequency, DayCounter fixedLegDayCounter, bool includeFirstSwaplet, YieldTermStructureHandle termStructure, BlackCalibrationHelper::CalibrationErrorType errorType=RelativePriceError, VolatilityType const type=ShiftedLognormal, Real const shift=0.0) -> core_CapHelper"""
        _mxdevtool.core_CapHelper_swiginit(self, _mxdevtool.new_core_CapHelper(*args))

    def times(self) -> "std::vector< Time,std::allocator< Time > >":
        r"""times(core_CapHelper self) -> DoubleVector"""
        return _mxdevtool.core_CapHelper_times(self)
    __swig_destroy__ = _mxdevtool.delete_core_CapHelper

# Register core_CapHelper in _mxdevtool:
_mxdevtool.core_CapHelper_swigregister(core_CapHelper)

class CalibrationHelperVector(object):
    r"""Proxy of C++ std::vector< boost::shared_ptr< CalibrationHelper > > class."""
    ...
    def __len__(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::size_type":
        r"""__len__(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::size_type"""
    ...
    def __getslice__(self, i: "std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type", j: "std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type") -> "std::vector< boost::shared_ptr< CalibrationHelper >,std::allocator< boost::shared_ptr< CalibrationHelper > > > *":
        r"""__getslice__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type j) -> CalibrationHelperVector"""
        return _mxdevtool.CalibrationHelperVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        r"""
        __setslice__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type j)
        __setslice__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type j, CalibrationHelperVector v)
        """
    ...
    def __delslice__(self, i: "std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type", j: "std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type") -> "void":
        r"""__delslice__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type j)"""
        return _mxdevtool.CalibrationHelperVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        r"""
        __delitem__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i)
        __delitem__(CalibrationHelperVector self, PySliceObject * slice)
        """
    ...
    def __getitem__(self, *args) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &":
        r"""
        __getitem__(CalibrationHelperVector self, PySliceObject * slice) -> CalibrationHelperVector
        __getitem__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i) -> std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &
        """
        return _mxdevtool.CalibrationHelperVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        r"""
        __setitem__(CalibrationHelperVector self, PySliceObject * slice, CalibrationHelperVector v)
        __setitem__(CalibrationHelperVector self, PySliceObject * slice)
        __setitem__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)
        """
    ...
    def pop(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type":
        r"""pop(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::value_type"""
        return _mxdevtool.CalibrationHelperVector_pop(self)

    def append(self, x: "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &") -> "void":
        r"""append(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)"""
    ...
    def size(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::size_type":
        r"""size(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::size_type"""
    ...
    def begin(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::iterator":
        r"""begin(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::iterator"""
        return _mxdevtool.CalibrationHelperVector_begin(self)

    def end(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::iterator":
        r"""end(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::iterator"""
    ...
    def rbegin(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::reverse_iterator":
        r"""rbegin(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::reverse_iterator"""
    ...
    def rend(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::reverse_iterator":
        r"""rend(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::reverse_iterator"""
    ...
    def get_allocator(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::allocator_type":
        r"""get_allocator(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::allocator_type"""
    ...
    def erase(self, *args) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::iterator":
        r"""
        erase(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::iterator pos) -> std::vector< boost::shared_ptr< CalibrationHelper > >::iterator
        erase(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::iterator first, std::vector< boost::shared_ptr< CalibrationHelper > >::iterator last) -> std::vector< boost::shared_ptr< CalibrationHelper > >::iterator
        """
    ...
    def __init__(self, *args):
        ...
        __init__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type size) -> CalibrationHelperVector
        __init__(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type size, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & value) -> CalibrationHelperVector
        """
        _mxdevtool.CalibrationHelperVector_swiginit(self, _mxdevtool.new_CalibrationHelperVector(*args))

    def push_back(self, x: "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &") -> "void":
        r"""push_back(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)"""
    ...
    def front(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &":
        r"""front(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &"""
    ...
    def back(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &":
        r"""back(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &"""
        return _mxdevtool.CalibrationHelperVector_back(self)

    def assign(self, n: "std::vector< boost::shared_ptr< CalibrationHelper > >::size_type", x: "std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const &") -> "void":
        r"""assign(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type n, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)"""
        return _mxdevtool.CalibrationHelperVector_assign(self, n, x)

    def resize(self, *args) -> "void":
        r"""
        resize(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type new_size)
        resize(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type new_size, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)
        """
        return _mxdevtool.CalibrationHelperVector_resize(self, *args)

    def insert(self, *args) -> "void":
        r"""
        insert(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::iterator pos, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x) -> std::vector< boost::shared_ptr< CalibrationHelper > >::iterator
        insert(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::iterator pos, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type n, std::vector< boost::shared_ptr< CalibrationHelper > >::value_type const & x)
        """
    ...
    def reserve(self, n: "std::vector< boost::shared_ptr< CalibrationHelper > >::size_type") -> "void":
        r"""reserve(CalibrationHelperVector self, std::vector< boost::shared_ptr< CalibrationHelper > >::size_type n)"""
    ...
    def capacity(self) -> "std::vector< boost::shared_ptr< CalibrationHelper > >::size_type":
        r"""capacity(CalibrationHelperVector self) -> std::vector< boost::shared_ptr< CalibrationHelper > >::size_type"""
...
class BlackCalibrationHelperVector(object):
    r"""Proxy of C++ std::vector< boost::shared_ptr< BlackCalibrationHelper > > class."""
    ...
    def __len__(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type":
        r"""__len__(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type"""
        return _mxdevtool.BlackCalibrationHelperVector___len__(self)

    def __getslice__(self, i: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type", j: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type") -> "std::vector< boost::shared_ptr< BlackCalibrationHelper >,std::allocator< boost::shared_ptr< BlackCalibrationHelper > > > *":
        r"""__getslice__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type j) -> BlackCalibrationHelperVector"""
        return _mxdevtool.BlackCalibrationHelperVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        r"""
        __setslice__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type j)
        __setslice__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type j, BlackCalibrationHelperVector v)
        """
        return _mxdevtool.BlackCalibrationHelperVector___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type", j: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type") -> "void":
        r"""__delslice__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type j)"""
        return _mxdevtool.BlackCalibrationHelperVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        r"""
        __delitem__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i)
        __delitem__(BlackCalibrationHelperVector self, PySliceObject * slice)
        """
        return _mxdevtool.BlackCalibrationHelperVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &":
        r"""
        __getitem__(BlackCalibrationHelperVector self, PySliceObject * slice) -> BlackCalibrationHelperVector
        __getitem__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &
        """
        return _mxdevtool.BlackCalibrationHelperVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        r"""
        __setitem__(BlackCalibrationHelperVector self, PySliceObject * slice, BlackCalibrationHelperVector v)
        __setitem__(BlackCalibrationHelperVector self, PySliceObject * slice)
        __setitem__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::difference_type i, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)
        """
        return _mxdevtool.BlackCalibrationHelperVector___setitem__(self, *args)

    def pop(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type":
        r"""pop(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type"""
        return _mxdevtool.BlackCalibrationHelperVector_pop(self)

    def append(self, x: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &") -> "void":
        r"""append(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)"""
    ...
    def size(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type":
        r"""size(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type"""
        return _mxdevtool.BlackCalibrationHelperVector_size(self)

    def swap(self, v: "BlackCalibrationHelperVector") -> "void":
    ...
    def begin(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator":
        r"""begin(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator"""
        return _mxdevtool.BlackCalibrationHelperVector_begin(self)

    def end(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator":
        r"""end(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator"""
        return _mxdevtool.BlackCalibrationHelperVector_end(self)

    def rbegin(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::reverse_iterator":
        r"""rbegin(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::reverse_iterator"""
        return _mxdevtool.BlackCalibrationHelperVector_rbegin(self)

    def rend(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::reverse_iterator":
        r"""rend(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::reverse_iterator"""
    ...
    def get_allocator(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::allocator_type":
        r"""get_allocator(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::allocator_type"""
    ...
    def erase(self, *args) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator":
        r"""
        erase(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator pos) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator
        erase(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator first, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator last) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator
        """
    ...
    def __init__(self, *args):
        ...
        __init__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type size) -> BlackCalibrationHelperVector
        __init__(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type size, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & value) -> BlackCalibrationHelperVector
        """
        _mxdevtool.BlackCalibrationHelperVector_swiginit(self, _mxdevtool.new_BlackCalibrationHelperVector(*args))

    def push_back(self, x: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &") -> "void":
        r"""push_back(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)"""
        return _mxdevtool.BlackCalibrationHelperVector_push_back(self, x)

    def front(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &":
        r"""front(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &"""
        return _mxdevtool.BlackCalibrationHelperVector_front(self)

    def back(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &":
        r"""back(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &"""
        return _mxdevtool.BlackCalibrationHelperVector_back(self)

    def assign(self, n: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type", x: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const &") -> "void":
        r"""assign(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type n, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)"""
        return _mxdevtool.BlackCalibrationHelperVector_assign(self, n, x)

    def resize(self, *args) -> "void":
        r"""
        resize(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type new_size)
        resize(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type new_size, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)
        """
        return _mxdevtool.BlackCalibrationHelperVector_resize(self, *args)

    def insert(self, *args) -> "void":
        r"""
        insert(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator pos, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator
        insert(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::iterator pos, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type n, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::value_type const & x)
        """
        return _mxdevtool.BlackCalibrationHelperVector_insert(self, *args)

    def reserve(self, n: "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type") -> "void":
        r"""reserve(BlackCalibrationHelperVector self, std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type n)"""
        return _mxdevtool.BlackCalibrationHelperVector_reserve(self, n)

    def capacity(self) -> "std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type":
        r"""capacity(BlackCalibrationHelperVector self) -> std::vector< boost::shared_ptr< BlackCalibrationHelper > >::size_type"""
...
class PayoffMC(object):
    r"""Proxy of C++ boost::shared_ptr< PayoffMC > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __deref__(self) -> "PayoffMC *":
        r"""__deref__(PayoffMC self) -> PayoffMC *"""
        return _mxdevtool.PayoffMC___deref__(self)

    def __nonzero__(self) -> "bool":
        r"""__nonzero__(PayoffMC self) -> bool"""
        return _mxdevtool.PayoffMC___nonzero__(self)

    def __bool__(self) -> "bool":
        r"""__bool__(PayoffMC self) -> bool"""
        return _mxdevtool.PayoffMC___bool__(self)

    def __init__(self):
        r"""__init__(PayoffMC self) -> PayoffMC"""
        _mxdevtool.PayoffMC_swiginit(self, _mxdevtool.new_PayoffMC())
...
class PayoffMCVector(object):
    r"""Proxy of C++ std::vector< boost::shared_ptr< PayoffMC > > class."""
    ...
    def __len__(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::size_type":
        r"""__len__(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::size_type"""
        return _mxdevtool.PayoffMCVector___len__(self)

    def __getslice__(self, i: "std::vector< boost::shared_ptr< PayoffMC > >::difference_type", j: "std::vector< boost::shared_ptr< PayoffMC > >::difference_type") -> "std::vector< boost::shared_ptr< PayoffMC >,std::allocator< boost::shared_ptr< PayoffMC > > > *":
        r"""__getslice__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i, std::vector< boost::shared_ptr< PayoffMC > >::difference_type j) -> PayoffMCVector"""
        return _mxdevtool.PayoffMCVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        r"""
        __setslice__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i, std::vector< boost::shared_ptr< PayoffMC > >::difference_type j)
        __setslice__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i, std::vector< boost::shared_ptr< PayoffMC > >::difference_type j, PayoffMCVector v)
        """
        return _mxdevtool.PayoffMCVector___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< boost::shared_ptr< PayoffMC > >::difference_type", j: "std::vector< boost::shared_ptr< PayoffMC > >::difference_type") -> "void":
        r"""__delslice__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i, std::vector< boost::shared_ptr< PayoffMC > >::difference_type j)"""
        return _mxdevtool.PayoffMCVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        r"""
        __delitem__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i)
        __delitem__(PayoffMCVector self, PySliceObject * slice)
        """
        return _mxdevtool.PayoffMCVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< boost::shared_ptr< PayoffMC > >::value_type const &":
        r"""
        __getitem__(PayoffMCVector self, PySliceObject * slice) -> PayoffMCVector
        __getitem__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i) -> PayoffMC
        """
        return _mxdevtool.PayoffMCVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        r"""
        __setitem__(PayoffMCVector self, PySliceObject * slice, PayoffMCVector v)
        __setitem__(PayoffMCVector self, PySliceObject * slice)
        __setitem__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::difference_type i, PayoffMC x)
        """
        return _mxdevtool.PayoffMCVector___setitem__(self, *args)

    def pop(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::value_type":
        r"""pop(PayoffMCVector self) -> PayoffMC"""
        return _mxdevtool.PayoffMCVector_pop(self)

    def append(self, x: "PayoffMC") -> "void":
        r"""append(PayoffMCVector self, PayoffMC x)"""
    ...
    def size(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::size_type":
        r"""size(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::size_type"""
        return _mxdevtool.PayoffMCVector_size(self)

    def swap(self, v: "PayoffMCVector") -> "void":
        r"""swap(PayoffMCVector self, PayoffMCVector v)"""
        return _mxdevtool.PayoffMCVector_swap(self, v)

    def begin(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::iterator":
        r"""begin(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::iterator"""
        return _mxdevtool.PayoffMCVector_begin(self)

    def end(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::iterator":
        r"""end(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::iterator"""
        return _mxdevtool.PayoffMCVector_end(self)

    def rbegin(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::reverse_iterator":
        r"""rbegin(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::reverse_iterator"""
        return _mxdevtool.PayoffMCVector_rbegin(self)

    def rend(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::reverse_iterator":
        r"""rend(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::reverse_iterator"""
    ...
    def get_allocator(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::allocator_type":
        r"""get_allocator(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::allocator_type"""
    ...
    def erase(self, *args) -> "std::vector< boost::shared_ptr< PayoffMC > >::iterator":
        r"""
        erase(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::iterator pos) -> std::vector< boost::shared_ptr< PayoffMC > >::iterator
        erase(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::iterator first, std::vector< boost::shared_ptr< PayoffMC > >::iterator last) -> std::vector< boost::shared_ptr< PayoffMC > >::iterator
        """
    ...
    def __init__(self, *args):
        ...
        __init__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type size) -> PayoffMCVector
        __init__(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type size, PayoffMC value) -> PayoffMCVector
        """
        _mxdevtool.PayoffMCVector_swiginit(self, _mxdevtool.new_PayoffMCVector(*args))

    def push_back(self, x: "PayoffMC") -> "void":
        r"""push_back(PayoffMCVector self, PayoffMC x)"""
        return _mxdevtool.PayoffMCVector_push_back(self, x)

    def front(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::value_type const &":
        r"""front(PayoffMCVector self) -> PayoffMC"""
        return _mxdevtool.PayoffMCVector_front(self)

    def back(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::value_type const &":
        r"""back(PayoffMCVector self) -> PayoffMC"""
        return _mxdevtool.PayoffMCVector_back(self)

    def assign(self, n: "std::vector< boost::shared_ptr< PayoffMC > >::size_type", x: "PayoffMC") -> "void":
        r"""assign(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type n, PayoffMC x)"""
        return _mxdevtool.PayoffMCVector_assign(self, n, x)

    def resize(self, *args) -> "void":
        r"""
        resize(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type new_size)
        resize(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type new_size, PayoffMC x)
        """
        return _mxdevtool.PayoffMCVector_resize(self, *args)

    def insert(self, *args) -> "void":
        r"""
        insert(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::iterator pos, PayoffMC x) -> std::vector< boost::shared_ptr< PayoffMC > >::iterator
        insert(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::iterator pos, std::vector< boost::shared_ptr< PayoffMC > >::size_type n, PayoffMC x)
        """
        return _mxdevtool.PayoffMCVector_insert(self, *args)

    def reserve(self, n: "std::vector< boost::shared_ptr< PayoffMC > >::size_type") -> "void":
        r"""reserve(PayoffMCVector self, std::vector< boost::shared_ptr< PayoffMC > >::size_type n)"""
        return _mxdevtool.PayoffMCVector_reserve(self, n)

    def capacity(self) -> "std::vector< boost::shared_ptr< PayoffMC > >::size_type":
        r"""capacity(PayoffMCVector self) -> std::vector< boost::shared_ptr< PayoffMC > >::size_type"""
...
class core_PayoffMC(PayoffMC):
    r"""Proxy of C++ PayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def calculate_path(self, *args) -> "Real":
        r"""
        calculate_path(core_PayoffMC self, Size scenCount, Date date, core_ScenarioResult scenRes, Calendar calendar=NullCalendar()) -> Real
        calculate_path(core_PayoffMC self, Size scenCount, Size t_pos, core_ScenarioResult scenRes, Calendar calendar=NullCalendar()) -> Real
        calculate_path(core_PayoffMC self, Size scenCount, Time t, core_ScenarioResult scenRes, Calendar calendar=NullCalendar()) -> Real
        """
        return _mxdevtool.core_PayoffMC_calculate_path(self, *args)
    ...
    def __init__(self):
        r"""__init__(core_PayoffMC self) -> core_PayoffMC"""
        _mxdevtool.core_PayoffMC_swiginit(self, _mxdevtool.new_core_PayoffMC())
    __swig_destroy__ = _mxdevtool.delete_core_PayoffMC

# Register core_PayoffMC in _mxdevtool:
_mxdevtool.core_PayoffMC_swigregister(core_PayoffMC)

class core_PlusPayoffMC(core_PayoffMC):
    r"""Proxy of C++ PlusPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, po: "PayoffMC"):
        r"""__init__(core_PlusPayoffMC self, PayoffMC po) -> core_PlusPayoffMC"""
...
class core_MinusPayoffMC(core_PayoffMC):
    r"""Proxy of C++ MinusPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, po: "PayoffMC"):
        r"""__init__(core_MinusPayoffMC self, PayoffMC po) -> core_MinusPayoffMC"""
...
class core_AdditionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ AdditionPayoffMCPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_AdditionPayoffMC self, PayoffMC po1, PayoffMC po2) -> core_AdditionPayoffMC
        __init__(core_AdditionPayoffMC self, double v, PayoffMC po) -> core_AdditionPayoffMC
        __init__(core_AdditionPayoffMC self, PayoffMC po, double v) -> core_AdditionPayoffMC
        """
        _mxdevtool.core_AdditionPayoffMC_swiginit(self, _mxdevtool.new_core_AdditionPayoffMC(*args))
...
class core_SubtractionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ SubtractionPayoffMCPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_SubtractionPayoffMC self, PayoffMC po1, PayoffMC po2) -> core_SubtractionPayoffMC
        __init__(core_SubtractionPayoffMC self, double v, PayoffMC po) -> core_SubtractionPayoffMC
        __init__(core_SubtractionPayoffMC self, PayoffMC po, double v) -> core_SubtractionPayoffMC
        """
        _mxdevtool.core_SubtractionPayoffMC_swiginit(self, _mxdevtool.new_core_SubtractionPayoffMC(*args))
...
class core_MultiplicationPayoffMC(core_PayoffMC):
    r"""Proxy of C++ MultiplicationPayoffMCPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_MultiplicationPayoffMC self, PayoffMC po1, PayoffMC po2) -> core_MultiplicationPayoffMC
        __init__(core_MultiplicationPayoffMC self, double v, PayoffMC po) -> core_MultiplicationPayoffMC
        __init__(core_MultiplicationPayoffMC self, PayoffMC po, double v) -> core_MultiplicationPayoffMC
        """
        _mxdevtool.core_MultiplicationPayoffMC_swiginit(self, _mxdevtool.new_core_MultiplicationPayoffMC(*args))
...
class core_DivisionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ DivisionPayoffMCPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_DivisionPayoffMC self, PayoffMC po1, PayoffMC po2) -> core_DivisionPayoffMC
        __init__(core_DivisionPayoffMC self, double v, PayoffMC po) -> core_DivisionPayoffMC
        __init__(core_DivisionPayoffMC self, PayoffMC po, double v) -> core_DivisionPayoffMC
        """
        _mxdevtool.core_DivisionPayoffMC_swiginit(self, _mxdevtool.new_core_DivisionPayoffMC(*args))
...
class core_IdentityPayoffMC(core_PayoffMC):
    r"""Proxy of C++ IdentityPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, po: "PayoffMC"):
        r"""__init__(core_IdentityPayoffMC self, PayoffMC po) -> core_IdentityPayoffMC"""
...
class core_LinearPayoffMC(core_PayoffMC):
    r"""Proxy of C++ LinearPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, po: "PayoffMC", multiple: "Real", spread: "Real"):
        r"""__init__(core_LinearPayoffMC self, PayoffMC po, Real multiple, Real spread) -> core_LinearPayoffMC"""
...
class core_ConstantPayoffMC(core_PayoffMC):
    r"""Proxy of C++ ConstantPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, v: "Real"):
...
class core_IndexPayoffMC(core_PayoffMC):
    r"""Proxy of C++ IndexPayoffMCPtr class."""
    ...
    def _index(self) -> "IndexMCPtr":
        r"""_index(core_IndexPayoffMC self) -> core_IndexMC"""
        return _mxdevtool.core_IndexPayoffMC__index(self)
...
class core_ConditionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ ConditionPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, conditionMC: "ConditionMC", payoffMCTrue: "PayoffMC", payoffMCFalse: "PayoffMC"):
        r"""__init__(core_ConditionPayoffMC self, ConditionMC conditionMC, PayoffMC payoffMCTrue, PayoffMC payoffMCFalse) -> core_ConditionPayoffMC"""
...
class core_DatesFunctionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ DatesFunctionPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, payoffMC: "PayoffMC", dates: "DateVector", func_name: "std::string const &"):
        r"""__init__(core_DatesFunctionPayoffMC self, PayoffMC payoffMC, DateVector dates, std::string const & func_name) -> core_DatesFunctionPayoffMC"""
        _mxdevtool.core_DatesFunctionPayoffMC_swiginit(self, _mxdevtool.new_core_DatesFunctionPayoffMC(payoffMC, dates, func_name))
    __swig_destroy__ = _mxdevtool.delete_core_DatesFunctionPayoffMC

# Register core_DatesFunctionPayoffMC in _mxdevtool:
_mxdevtool.core_DatesFunctionPayoffMC_swigregister(core_DatesFunctionPayoffMC)

class core_BetweenDatesFunctionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ BetweenDatesFunctionPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, payoffMC: "PayoffMC", startDate: "Date", endDate: "Date", func_name: "std::string const &"):
        r"""__init__(core_BetweenDatesFunctionPayoffMC self, PayoffMC payoffMC, Date startDate, Date endDate, std::string const & func_name) -> core_BetweenDatesFunctionPayoffMC"""
        _mxdevtool.core_BetweenDatesFunctionPayoffMC_swiginit(self, _mxdevtool.new_core_BetweenDatesFunctionPayoffMC(payoffMC, startDate, endDate, func_name))
    __swig_destroy__ = _mxdevtool.delete_core_BetweenDatesFunctionPayoffMC

# Register core_BetweenDatesFunctionPayoffMC in _mxdevtool:
_mxdevtool.core_BetweenDatesFunctionPayoffMC_swigregister(core_BetweenDatesFunctionPayoffMC)

class core_BinaryFunctionPayoffMC(core_PayoffMC):
    r"""Proxy of C++ BinaryFunctionPayoffMCPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, po1: "PayoffMC", po2: "PayoffMC", func_name: "std::string const &"):
        r"""__init__(core_BinaryFunctionPayoffMC self, PayoffMC po1, PayoffMC po2, std::string const & func_name) -> core_BinaryFunctionPayoffMC"""
        _mxdevtool.core_BinaryFunctionPayoffMC_swiginit(self, _mxdevtool.new_core_BinaryFunctionPayoffMC(po1, po2, func_name))
    __swig_destroy__ = _mxdevtool.delete_core_BinaryFunctionPayoffMC

# Register core_BinaryFunctionPayoffMC in _mxdevtool:
_mxdevtool.core_BinaryFunctionPayoffMC_swigregister(core_BinaryFunctionPayoffMC)

class BarrierDirection(object):
    r"""Proxy of C++ BarrierDirection class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Down = _mxdevtool.BarrierDirection_Down
    
    Up = _mxdevtool.BarrierDirection_Up
    

    def __init__(self):
        r"""__init__(BarrierDirection self) -> BarrierDirection"""
        _mxdevtool.BarrierDirection_swiginit(self, _mxdevtool.new_BarrierDirection())
    __swig_destroy__ = _mxdevtool.delete_BarrierDirection

# Register BarrierDirection in _mxdevtool:
_mxdevtool.BarrierDirection_swigregister(BarrierDirection)

class ConditionMC(object):
    r"""Proxy of C++ boost::shared_ptr< ConditionMC > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __deref__(self) -> "ConditionMC *":
...
class ConditionMCVector(object):
    r"""Proxy of C++ std::vector< boost::shared_ptr< ConditionMC > > class."""
    ...
    def __len__(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::size_type":
        r"""__len__(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::size_type"""
        return _mxdevtool.ConditionMCVector___len__(self)

    def __getslice__(self, i: "std::vector< boost::shared_ptr< ConditionMC > >::difference_type", j: "std::vector< boost::shared_ptr< ConditionMC > >::difference_type") -> "std::vector< boost::shared_ptr< ConditionMC >,std::allocator< boost::shared_ptr< ConditionMC > > > *":
        r"""__getslice__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i, std::vector< boost::shared_ptr< ConditionMC > >::difference_type j) -> ConditionMCVector"""
        return _mxdevtool.ConditionMCVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        r"""
        __setslice__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i, std::vector< boost::shared_ptr< ConditionMC > >::difference_type j)
        __setslice__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i, std::vector< boost::shared_ptr< ConditionMC > >::difference_type j, ConditionMCVector v)
        """
        return _mxdevtool.ConditionMCVector___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< boost::shared_ptr< ConditionMC > >::difference_type", j: "std::vector< boost::shared_ptr< ConditionMC > >::difference_type") -> "void":
        r"""__delslice__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i, std::vector< boost::shared_ptr< ConditionMC > >::difference_type j)"""
        return _mxdevtool.ConditionMCVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        r"""
        __delitem__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i)
        __delitem__(ConditionMCVector self, PySliceObject * slice)
        """
        return _mxdevtool.ConditionMCVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< boost::shared_ptr< ConditionMC > >::value_type const &":
        r"""
        __getitem__(ConditionMCVector self, PySliceObject * slice) -> ConditionMCVector
        __getitem__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i) -> ConditionMC
        """
        return _mxdevtool.ConditionMCVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        r"""
        __setitem__(ConditionMCVector self, PySliceObject * slice, ConditionMCVector v)
        __setitem__(ConditionMCVector self, PySliceObject * slice)
        __setitem__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::difference_type i, ConditionMC x)
        """
        return _mxdevtool.ConditionMCVector___setitem__(self, *args)

    def pop(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::value_type":
        r"""pop(ConditionMCVector self) -> ConditionMC"""
        return _mxdevtool.ConditionMCVector_pop(self)

    def append(self, x: "ConditionMC") -> "void":
    ...
    def size(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::size_type":
        r"""size(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::size_type"""
        return _mxdevtool.ConditionMCVector_size(self)

    def swap(self, v: "ConditionMCVector") -> "void":
        r"""swap(ConditionMCVector self, ConditionMCVector v)"""
        return _mxdevtool.ConditionMCVector_swap(self, v)

    def begin(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::iterator":
        r"""begin(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::iterator"""
        return _mxdevtool.ConditionMCVector_begin(self)

    def end(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::iterator":
        r"""end(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::iterator"""
        return _mxdevtool.ConditionMCVector_end(self)

    def rbegin(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::reverse_iterator":
        r"""rbegin(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::reverse_iterator"""
        return _mxdevtool.ConditionMCVector_rbegin(self)

    def rend(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::reverse_iterator":
        r"""rend(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::reverse_iterator"""
    ...
    def get_allocator(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::allocator_type":
        r"""get_allocator(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::allocator_type"""
    ...
    def erase(self, *args) -> "std::vector< boost::shared_ptr< ConditionMC > >::iterator":
        r"""
        erase(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::iterator pos) -> std::vector< boost::shared_ptr< ConditionMC > >::iterator
        erase(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::iterator first, std::vector< boost::shared_ptr< ConditionMC > >::iterator last) -> std::vector< boost::shared_ptr< ConditionMC > >::iterator
        """
    ...
    def __init__(self, *args):
        ...
        __init__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type size) -> ConditionMCVector
        __init__(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type size, ConditionMC value) -> ConditionMCVector
        """
        _mxdevtool.ConditionMCVector_swiginit(self, _mxdevtool.new_ConditionMCVector(*args))

    def push_back(self, x: "ConditionMC") -> "void":
        r"""push_back(ConditionMCVector self, ConditionMC x)"""
        return _mxdevtool.ConditionMCVector_push_back(self, x)

    def front(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::value_type const &":
        r"""front(ConditionMCVector self) -> ConditionMC"""
        return _mxdevtool.ConditionMCVector_front(self)

    def back(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::value_type const &":
        r"""back(ConditionMCVector self) -> ConditionMC"""
        return _mxdevtool.ConditionMCVector_back(self)

    def assign(self, n: "std::vector< boost::shared_ptr< ConditionMC > >::size_type", x: "ConditionMC") -> "void":
        r"""assign(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type n, ConditionMC x)"""
        return _mxdevtool.ConditionMCVector_assign(self, n, x)

    def resize(self, *args) -> "void":
        r"""
        resize(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type new_size)
        resize(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type new_size, ConditionMC x)
        """
        return _mxdevtool.ConditionMCVector_resize(self, *args)

    def insert(self, *args) -> "void":
        r"""
        insert(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::iterator pos, ConditionMC x) -> std::vector< boost::shared_ptr< ConditionMC > >::iterator
        insert(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::iterator pos, std::vector< boost::shared_ptr< ConditionMC > >::size_type n, ConditionMC x)
        """
        return _mxdevtool.ConditionMCVector_insert(self, *args)

    def reserve(self, n: "std::vector< boost::shared_ptr< ConditionMC > >::size_type") -> "void":
        r"""reserve(ConditionMCVector self, std::vector< boost::shared_ptr< ConditionMC > >::size_type n)"""
        return _mxdevtool.ConditionMCVector_reserve(self, n)

    def capacity(self) -> "std::vector< boost::shared_ptr< ConditionMC > >::size_type":
        r"""capacity(ConditionMCVector self) -> std::vector< boost::shared_ptr< ConditionMC > >::size_type"""
...
class core_XORConditionMC(core_ConditionMC):
    ...
    def __init__(self, condition1: "ConditionMC", condition2: "ConditionMC"):
...
class core_NOTConditionMC(core_ConditionMC):
    ...
    def __init__(self, condition: "ConditionMC"):
...
class core_RangeConditionMC(core_ConditionMC):
    ...
    def __init__(self, po: "PayoffMC", a: "double", b: "double"):
        r"""__init__(core_RangeConditionMC self, PayoffMC po, double a, double b) -> core_RangeConditionMC"""
...
class core_DatesConditionMC(core_ConditionMC):
    ...
    def __init__(self, condition: "ConditionMC", dates: "DateVector", operand: "std::string const &"):
...
class core_RelationalConditionMC(core_ConditionMC):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_RelationalConditionMC self, PayoffMC po1, std::string const & operand, Real v) -> core_RelationalConditionMC
        __init__(core_RelationalConditionMC self, Real v, std::string const & operand, PayoffMC po2) -> core_RelationalConditionMC
        __init__(core_RelationalConditionMC self, PayoffMC po1, std::string const & operand, PayoffMC po2) -> core_RelationalConditionMC
        """
...
class core_Swaption(Instrument):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_Swaption self, core_VanillaSwapExt swap, Date exerciseDate) -> core_Swaption
        __init__(core_Swaption self, boost::shared_ptr< VanillaSwap > const & swap, boost::shared_ptr< Exercise > const & exercise, Settlement::Type type=Physical, Settlement::Method settlementMethod=PhysicalOTC) -> core_Swaption
        """
        _mxdevtool.core_Swaption_swiginit(self, _mxdevtool.new_core_Swaption(*args))

    def settlementType(self) -> "Settlement::Type":
        r"""settlementType(core_Swaption self) -> Settlement::Type"""
        return _mxdevtool.core_Swaption_settlementType(self)

    def settlementMethod(self) -> "Settlement::Method":
        r"""settlementMethod(core_Swaption self) -> Settlement::Method"""
        return _mxdevtool.core_Swaption_settlementMethod(self)

    def type(self) -> "VanillaSwap::Type":
        r"""type(core_Swaption self) -> VanillaSwap::Type"""
        return _mxdevtool.core_Swaption_type(self)

    def underlyingSwap(self) -> "boost::shared_ptr< VanillaSwap > const &":
        r"""underlyingSwap(core_Swaption self) -> boost::shared_ptr< VanillaSwap > const &"""
        return _mxdevtool.core_Swaption_underlyingSwap(self)

    def impliedVolatility(self, price: "Real", discountCurve: "YieldTermStructure", guess: "Volatility"=0.3, accuracy: "Real"=1.0e-4, maxEvaluations: "Natural"=100, minVol: "Volatility"=1.0e-7, maxVol: "Volatility"=4.0, type: "VolatilityType"=ShiftedLognormal, displacement: "Real"=0.0) -> "Volatility":
        r"""impliedVolatility(core_Swaption self, Real price, YieldTermStructure discountCurve, Volatility guess=0.3, Real accuracy=1.0e-4, Natural maxEvaluations=100, Volatility minVol=1.0e-7, Volatility maxVol=4.0, VolatilityType type=ShiftedLognormal, Real displacement=0.0) -> Volatility"""
        return _mxdevtool.core_Swaption_impliedVolatility(self, price, discountCurve, guess, accuracy, maxEvaluations, minVol, maxVol, type, displacement)
...
class core_BachelierSwaptionEngine(PricingEngine):
    r"""Proxy of C++ BachelierSwaptionEnginePtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, discountCurve: "YieldTermStructure", vol: "double"):
        r"""__init__(core_BachelierSwaptionEngine self, YieldTermStructure discountCurve, double vol) -> core_BachelierSwaptionEngine"""
        _mxdevtool.core_BachelierSwaptionEngine_swiginit(self, _mxdevtool.new_core_BachelierSwaptionEngine(discountCurve, vol))
    __swig_destroy__ = _mxdevtool.delete_core_BachelierSwaptionEngine

# Register core_BachelierSwaptionEngine in _mxdevtool:
_mxdevtool.core_BachelierSwaptionEngine_swigregister(core_BachelierSwaptionEngine)
...
class core_SpotRateCalc(core_ProcessValue):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_SpotRateCalc self, std::string name, ProcessValue pv, Period maturityTenor, Compounding compounding) -> core_SpotRateCalc
        __init__(core_SpotRateCalc self, std::string name, ProcessValue pv, Real maturity_t, Compounding compounding) -> core_SpotRateCalc
        """
...
class core_ForwardRateCalc(core_ProcessValue):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_ForwardRateCalc self, std::string name, ProcessValue pv, Period startTenor, Period maturityTenor, Compounding compounding) -> core_ForwardRateCalc
        __init__(core_ForwardRateCalc self, std::string name, ProcessValue pv, Real start_t, Real maturity_t, Compounding compounding) -> core_ForwardRateCalc
        """
...
class core_DiscountBondCalc(core_ProcessValue):
    ...
    def __init__(self, *args):
        r"""
        __init__(core_DiscountBondCalc self, std::string name, ProcessValue pv, Period maturityTenor) -> core_DiscountBondCalc
        __init__(core_DiscountBondCalc self, std::string name, ProcessValue pv, Real maturity_t) -> core_DiscountBondCalc
        """
...
class core_DiscountBondReturnCalc(core_ProcessValue):
    r"""Proxy of C++ DiscountBondReturnCalcPtr class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(core_DiscountBondReturnCalc self, std::string name, ProcessValue pv, Period maturityTenor, bool isConstantMaturity) -> core_DiscountBondReturnCalc
        __init__(core_DiscountBondReturnCalc self, std::string name, ProcessValue pv, Real maturity_t, bool isConstantMaturity) -> core_DiscountBondReturnCalc
        """
...
class core_LiborCalc(core_ProcessValue):
    r"""Proxy of C++ LiborCalcPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(core_LiborCalc self, std::string name, ProcessValue pv, core_IborIndex iborIndex, Real fixing=Null< Real >()) -> core_LiborCalc"""
        _mxdevtool.core_LiborCalc_swiginit(self, _mxdevtool.new_core_LiborCalc(*args))
    __swig_destroy__ = _mxdevtool.delete_core_LiborCalc

# Register core_LiborCalc in _mxdevtool:
_mxdevtool.core_LiborCalc_swigregister(core_LiborCalc)

class core_SwapRateCalc(core_ProcessValue):
    r"""Proxy of C++ SwapRateCalcPtr class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(core_SwapRateCalc self, std::string name, ProcessValue pv, core_SwapIndex swapIndex, Real fixing=Null< Real >()) -> core_SwapRateCalc"""
        _mxdevtool.core_SwapRateCalc_swiginit(self, _mxdevtool.new_core_SwapRateCalc(*args))
