...
class RsgFaure(Rsg):
    def __init__(self, sampleNum: int, dimension: int=365, 
                 seed: int=1, skip: int=0, isMomentMatching: bool=False, 
                 subType: str='mersennetwister', randomTransformType: str='invnormal'):
        super().__init__(sampleNum, dimension, seed, skip, isMomentMatching, 'faure', subType, randomTransformType)
...
class Scenario:
    def __init__(self, models, calcs, corr, timegrid, rsg, filename, isMomentMatching = False):
        ...
        self.models: List[mx.core_ProcessModel] = models
        self.calcs: List[mx.core_ProcessValue] = calcs
        self.corr = _corr
