...
class PeriodIntervalVector(object):
    ...
    def __delitem__(self, *args):
        ...
        __delitem__(PeriodIntervalVector self, SWIGPY_SLICEOBJECT * slice)
        """
        return _mxdevtool.PeriodIntervalVector___delitem__(self, *args)

    def __getitem__(self, *args):
        r"""
        __getitem__(PeriodIntervalVector self, SWIGPY_SLICEOBJECT * slice) -> PeriodIntervalVector
    ...
    def __setitem__(self, *args):
        r"""
        __setitem__(PeriodIntervalVector self, SWIGPY_SLICEOBJECT * slice, PeriodIntervalVector v)
        __setitem__(PeriodIntervalVector self, SWIGPY_SLICEOBJECT * slice)
...
class core_ZeroSpreadedTermStructure(YieldTermStructure):
    ...
    def __init__(self, yieldCurve, spread, compounding, frequency):
...
class core_ForwardSpreadedTermStructure(YieldTermStructure):
    ...
    def __init__(self, yieldCurve, spread):
...
class core_FlatForward(YieldTermStructure):
    ...
    def __init__(self, ref_date, forward, calendar, dayCounter, bdc, compounding):
...
class core_BootstrapCurve(YieldCurveExt):
    ...
    def __init__(self, refDate, tenors_str, rateTypes, quotes, interpolatorID, extrapolation, mc):
...
class Instrument(object):
    ...
    def calculateMany2D(self, parameterName1, operand1, values1, parameterName2, operand2, values2, resultName):
...
class Portfolio(Instrument):
    ...
    def __init__(self, multiples, instruments):
...
class core_StructuredSwap(Instrument):
    ...
    def _setPricingParams_Scen(self, pay_discount, rec_discount, regression_index_names, scen_filename):
...
class core_FloatingRateCouponMC(core_CouponMC):
    ...
    def __init__(self, paymentDate, nominal, startDate, endDate, fixingDays, indexPayoffMC, calendar, dayCounter, gearing=1.0, spread=0.0, isInArrears=False):
...
class core_ConstantSwaptionVolatility(SwaptionVolatilityStructure):
    ...
    def __init__(self, referenceDate, cal, bdc, volatility, dc, type=ShiftedLognormal, shift=0.0):
...
class core_ProcessModel(core_ProcessValue):
    ...
    def model_swaptionATM(self, expiry, tenor, familyname):
    ...
    def model_swaption(self, expiry, tenor, strike, familyname):
...
class core_CIR1FModel(core_ProcessModel):
    ...
    def __init__(self, name, r0, meanRevertingSpeed, longTermRate, sigma):
...
class core_EuropeanOption(Instrument):
    ...
    def _setPricingParams_GBMConst(self, x0, rf, div, vol):
...
class core_DatesFunctionPayoffMC(core_PayoffMC):
    ...
    def __init__(self, payoffMC, dates, func_name):
...
class core_BetweenDatesFunctionPayoffMC(core_PayoffMC):
    ...
    def __init__(self, payoffMC, startDate, endDate, func_name):
...
class core_BinaryFunctionPayoffMC(core_PayoffMC):
    ...
    def __init__(self, po1, po2, func_name):
...
class core_VanillaSwapExt(VanillaSwap):
    ...
    def __init__(self, type, nominal, settlementDate, maturityTenor, fixedRate, spread, mc):
    ...
    def _setPricingParams_YieldCurve(self, yieldcurve):
...
class core_VanillaSwapCCPExt(core_VanillaSwapExt):
    ...
    def __init__(self, type, nominal, settlementDate, maturityTenor, fixedRate, iborIndex, spread, familyName):
...
class core_Swaption(Instrument):
    ...
    def impliedVolatility(self, price, discountCurve, guess=0.3, accuracy=1.0e-4, maxEvaluations=100, minVol=1.0e-7, maxVol=4.0, type=ShiftedLognormal, displacement=0.0):
...
class core_BlackSwaptionEngine(PricingEngine):
    ...
    def __init__(self, discountCurve, vol):
