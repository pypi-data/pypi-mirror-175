...
# body param
SchemaForRequestBodyApplicationJson = ClassifyRequest


request_body_classify_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _classify_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_classify_request.serialize(body, content_type)
