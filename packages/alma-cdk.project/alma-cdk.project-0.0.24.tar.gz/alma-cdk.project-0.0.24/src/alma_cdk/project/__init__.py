...
class AccountConfiguration:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountConfiguration.__init__)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument config", value=config, expected_type=type_hints["config"])
        self._values: typing.Dict[str, typing.Any] = {
            "id": id,
...
class AccountContext(
    ...
    @jsii.member(jsii_name="getAccountConfig") # type: ignore[misc]
    ...
    def get_account_config(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.get_account_config)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
        return typing.cast(typing.Any, jsii.sinvoke(cls, "getAccountConfig", [scope, key]))

    @jsii.member(jsii_name="getAccountId") # type: ignore[misc]
    @builtins.classmethod
    def get_account_id(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.get_account_id)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getAccountId", [scope]))

    @jsii.member(jsii_name="getAccountType") # type: ignore[misc]
    @builtins.classmethod
    def get_account_type(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.get_account_type)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getAccountType", [scope]))

    @jsii.member(jsii_name="isDev") # type: ignore[misc]
    @builtins.classmethod
    def is_dev(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.is_dev)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isDev", [scope]))

    @jsii.member(jsii_name="isMock") # type: ignore[misc]
    @builtins.classmethod
    def is_mock(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.is_mock)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isMock", [scope]))

    @jsii.member(jsii_name="isPreProd") # type: ignore[misc]
    @builtins.classmethod
    def is_pre_prod(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.is_pre_prod)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isPreProd", [scope]))

    @jsii.member(jsii_name="isProd") # type: ignore[misc]
    @builtins.classmethod
    def is_prod(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.is_prod)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isProd", [scope]))

    @jsii.member(jsii_name="isShared") # type: ignore[misc]
    @builtins.classmethod
    def is_shared(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountContext.is_shared)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class AccountStrategy(
    ...
    @jsii.member(jsii_name="three") # type: ignore[misc]
    @builtins.classmethod
    def three(
        cls,
        *,
    ...
    @jsii.member(jsii_name="two") # type: ignore[misc]
    @builtins.classmethod
    def two(
        cls,
        *,
...
class AccountStrategyOneProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AccountStrategyOneProps.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(mock, dict):
            mock = AccountConfiguration(**mock)
        if __debug__:
            type_hints = typing.get_type_hints(AccountStrategyThreeProps.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(mock, dict):
            mock = AccountConfiguration(**mock)
        if __debug__:
            type_hints = typing.get_type_hints(AccountStrategyTwoProps.__init__)
            check_type(argname="argument dev", value=dev, expected_type=type_hints["dev"])
            check_type(argname="argument prod", value=prod, expected_type=type_hints["prod"])
            check_type(argname="argument mock", value=mock, expected_type=type_hints["mock"])
        self._values: typing.Dict[str, typing.Any] = {
...
class AccountType(metaclass=jsii.JSIIMeta, jsii_type="@alma-cdk/project.AccountType"):
    ...
    def get(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountType.get)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "get", [scope]))

    @jsii.member(jsii_name="matchFromEnvironment") # type: ignore[misc]
    @builtins.classmethod
    def match_from_environment(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountType.match_from_environment)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def set(cls, scope: constructs.Construct, account_type: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountType.set)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class AccountWrapper(
    ...
    def __init__(self, scope: constructs.Construct) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AccountWrapper.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class Author:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Author.__init__)
...
class EnvRegExp(metaclass=jsii.JSIIMeta, jsii_type="@alma-cdk/project.EnvRegExp"):
    ...
    def __init__(self, base: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvRegExp.__init__)
    ...
    def test(self, value: builtins.str) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvRegExp.test)
...
class EnvironmentContext(
    ...
    @jsii.member(jsii_name="getCategory") # type: ignore[misc]
    @builtins.classmethod
    def get_category(cls, scope: constructs.Construct) -> EnvironmentCategory:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.get_category)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(EnvironmentCategory, jsii.sinvoke(cls, "getCategory", [scope]))

    @jsii.member(jsii_name="getFeatureInfo") # type: ignore[misc]
    @builtins.classmethod
    def get_feature_info(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.get_feature_info)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getFeatureInfo", [scope]))

    @jsii.member(jsii_name="getLabel") # type: ignore[misc]
    @builtins.classmethod
    def get_label(cls, scope: constructs.Construct) -> "EnvironmentLabel":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.get_label)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast("EnvironmentLabel", jsii.sinvoke(cls, "getLabel", [scope]))

    @jsii.member(jsii_name="getName") # type: ignore[misc]
    @builtins.classmethod
    def get_name(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.get_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getName", [scope]))

    @jsii.member(jsii_name="getUrlName") # type: ignore[misc]
    @builtins.classmethod
    def get_url_name(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.get_url_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getUrlName", [scope]))

    @jsii.member(jsii_name="isDevelopment") # type: ignore[misc]
    @builtins.classmethod
    def is_development(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.is_development)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isDevelopment", [scope]))

    @jsii.member(jsii_name="isFeature") # type: ignore[misc]
    @builtins.classmethod
    def is_feature(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.is_feature)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def is_mock(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.is_mock)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isMock", [scope]))

    @jsii.member(jsii_name="isStable") # type: ignore[misc]
    @builtins.classmethod
    def is_stable(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.is_stable)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isStable", [scope]))

    @jsii.member(jsii_name="isVerification") # type: ignore[misc]
    @builtins.classmethod
    def is_verification(cls, scope: constructs.Construct) -> builtins.bool:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentContext.is_verification)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class EnvironmentType(
    ...
    def get(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentType.get)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def set(cls, scope: constructs.Construct, environment_type: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentType.set)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument environment_type", value=environment_type, expected_type=type_hints["environment_type"])
        return typing.cast(None, jsii.sinvoke(cls, "set", [scope, environment_type]))

    @jsii.member(jsii_name="tryGet") # type: ignore[misc]
    @builtins.classmethod
    def try_get(cls, scope: constructs.Construct) -> typing.Optional[builtins.str]:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentType.try_get)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class EnvironmentWrapper(
    ...
    def __init__(self, scope: constructs.Construct) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnvironmentWrapper.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        jsii.create(self.__class__, self, [scope])
...
class Name(metaclass=jsii.JSIIAbstractClass, jsii_type="@alma-cdk/project.Name"):
    ...
    @jsii.member(jsii_name="globally") # type: ignore[misc]
    @builtins.classmethod
    def globally(
        cls,
        scope: constructs.Construct,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Name.globally)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    @jsii.member(jsii_name="it") # type: ignore[misc]
    @builtins.classmethod
    def it(
        cls,
        scope: constructs.Construct,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Name.it)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
    ...
    @jsii.member(jsii_name="withProject") # type: ignore[misc]
    @builtins.classmethod
    def with_project(
        cls,
        scope: constructs.Construct,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Name.with_project)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
...
class NameProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NameProps.__init__)
...
class Project(
    ...
    @jsii.member(jsii_name="getAccount") # type: ignore[misc]
    @builtins.classmethod
    def get_account(
        cls,
        scope: constructs.Construct,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Project.get_account)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument account_type", value=account_type, expected_type=type_hints["account_type"])
        return typing.cast(Account, jsii.sinvoke(cls, "getAccount", [scope, account_type]))

    @jsii.member(jsii_name="getConfiguration") # type: ignore[misc]
    @builtins.classmethod
    def get_configuration(cls, scope: constructs.Construct) -> "ProjectConfiguration":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(Project.get_configuration)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class ProjectConfiguration:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(ProjectConfiguration.__init__)
            check_type(argname="argument accounts", value=accounts, expected_type=type_hints["accounts"])
...
class ProjectContext(
    ...
    def get_account_config(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_account_config)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
    ...
    def get_account_id(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_account_id)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getAccountId", [scope]))
    ...
    def get_account_type(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_account_type)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getAccountType", [scope]))

    @jsii.member(jsii_name="getAllowedEnvironments") # type: ignore[misc]
    @builtins.classmethod
    def get_allowed_environments(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_allowed_environments)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.List[builtins.str], jsii.sinvoke(cls, "getAllowedEnvironments", [scope]))

    @jsii.member(jsii_name="getAuthorEmail") # type: ignore[misc]
    @builtins.classmethod
    def get_author_email(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_author_email)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Optional[builtins.str], jsii.sinvoke(cls, "getAuthorEmail", [scope]))

    @jsii.member(jsii_name="getAuthorName") # type: ignore[misc]
    @builtins.classmethod
    def get_author_name(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_author_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getAuthorName", [scope]))

    @jsii.member(jsii_name="getAuthorOrganization") # type: ignore[misc]
    @builtins.classmethod
    def get_author_organization(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_author_organization)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(typing.Optional[builtins.str], jsii.sinvoke(cls, "getAuthorOrganization", [scope]))

    @jsii.member(jsii_name="getDefaultRegion") # type: ignore[misc]
    @builtins.classmethod
    def get_default_region(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_default_region)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getDefaultRegion", [scope]))

    @jsii.member(jsii_name="getEnvironment") # type: ignore[misc]
    @builtins.classmethod
    def get_environment(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_environment)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def get_name(cls, scope: constructs.Construct) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.get_name)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(builtins.str, jsii.sinvoke(cls, "getName", [scope]))

    @jsii.member(jsii_name="tryGetEnvironment") # type: ignore[misc]
    @builtins.classmethod
    def try_get_environment(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ProjectContext.try_get_environment)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class SmartStack(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SmartStack.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class UrlName(
    ...
    def globally(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UrlName.globally)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
    ...
    def it(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UrlName.it)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
    ...
    def with_project(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UrlName.with_project)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
...
class _UrlNameProxy(
    UrlName, jsii.proxy_for(Name) # type: ignore[misc]
):
    pass
...
class PathName(
    ...
    def globally(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PathName.globally)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
    ...
    def it(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PathName.it)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
    ...
    def with_project(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PathName.with_project)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument base_name", value=base_name, expected_type=type_hints["base_name"])
        props = NameProps(max_length=max_length, trim=trim)
...
class _PathNameProxy(
    PathName, jsii.proxy_for(UrlName) # type: ignore[misc]
):
    pass
