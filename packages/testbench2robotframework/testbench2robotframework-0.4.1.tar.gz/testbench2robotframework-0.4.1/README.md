...
Der standardmäßig eingestellte Regex findet alle Subdivisionen, deren Name auf "[Robot-Library]" endet. Wenn eine Interaktion aus einer der gefundenen Subdivisionen verwendet wird, so wird diese Subdivision in der generierten Robot Framework Testsuite als Bibliothek importiert.
...
Standardmäßig werden nur Subdivisionen als Ressourcen in den Robot Framework Testsuiten importiert, deren Namen auf "[Robot-Resource]" endet.
