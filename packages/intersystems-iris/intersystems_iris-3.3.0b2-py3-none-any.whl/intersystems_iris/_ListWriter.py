...
class _ListWriter(object):
    ...
    def _set_parameter(self, param):
        param_switcher = {
            intersystems_iris.dbapi._DBAPI.SQLType.LONGVARBINARY: self._set_stream,
            intersystems_iris.dbapi._DBAPI.SQLType.LONGVARCHAR: self._set_stream,
            intersystems_iris.dbapi._DBAPI.SQLType.DATE: None,
            intersystems_iris.dbapi._DBAPI.SQLType.TIME: None,
            intersystems_iris.dbapi._DBAPI.SQLType.TIMESTAMP: None,
            intersystems_iris.dbapi._DBAPI.SQLType.TYPE_DATE: None,
            intersystems_iris.dbapi._DBAPI.SQLType.TYPE_TIME: None,
            intersystems_iris.dbapi._DBAPI.SQLType.TYPE_TIMESTAMP: None,
            intersystems_iris.dbapi._DBAPI.SQLType.DATE_HOROLOG: self._set_date_h,
            intersystems_iris.dbapi._DBAPI.SQLType.TIME_HOROLOG: self._set_time_h,
            intersystems_iris.dbapi._DBAPI.SQLType.TIMESTAMP_POSIX: self._set_posix
        }
