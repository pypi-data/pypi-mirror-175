...
class _ResultSetRow:
    ...
    class DataRow:
        ...
        def __getitem__(self, key):
            if isinstance(key, str):
                ...
                intersystems_iris._DBList._DBList._get_list_element(self._list_item)
                item = intersystems_iris._DBList._DBList._get(self._list_item, self._locale)
        ...
        for i in range(self.colCount + 1):
            try:
                ...
                if i == 0:
                    ...
                    continue
                curr_offset = intersystems_iris._DBList._DBList._get_data_offset(buffer, prev_offset)
    ...
    def cloneListItem(self, list_item):
        clone = intersystems_iris._ListItem._ListItem(list_item.buffer)
