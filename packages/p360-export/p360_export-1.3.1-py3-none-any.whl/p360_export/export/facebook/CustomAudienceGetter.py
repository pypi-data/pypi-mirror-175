...
class CustomAudienceGetter:
    ...
    def get(self, config: Dict[str, Any], ad_account: AdAccount) -> CustomAudience:
        audience_name = self.__audience_name_getter.get(config)
        user_friendly_export_id = self.__audience_name_getter.get_user_friendly_export_id(config)
