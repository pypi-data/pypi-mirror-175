...
class NodeResourceInfoGcsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetGcsSchedulingStats = channel.unary_unary(
                '/ray.rpc.NodeResourceInfoGcsService/GetGcsSchedulingStats',
                request_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsReply.FromString,
                )
...
class NodeResourceInfoGcsServiceServicer(object):
    ...
    def GetGcsSchedulingStats(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_NodeResourceInfoGcsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetGcsSchedulingStats': grpc.unary_unary_rpc_method_handler(
                    servicer.GetGcsSchedulingStats,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class NodeResourceInfoGcsService(object):
    ...
    @staticmethod
    def GetGcsSchedulingStats(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.NodeResourceInfoGcsService/GetGcsSchedulingStats',
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_gcs__service__pb2.GetGcsSchedulingStatsReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
