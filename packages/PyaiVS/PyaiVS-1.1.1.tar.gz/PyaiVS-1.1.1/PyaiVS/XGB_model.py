...
# args = {'n_estimators': 1500, 'max_depth': 9, 'min_child_weight': 2, 'learning_rate': 0.0623815315228433, 'gamma': 0.12351759899530147, 'subsample': 0.8181545496832763, 'colsample_bytree': 0.824318091709357}
# a,b =para_xgb(df['Smiles'],df['activity'],args,split_type='scaffold',FP_type='MACCS',task_type = 'cla',model_dir=False)
