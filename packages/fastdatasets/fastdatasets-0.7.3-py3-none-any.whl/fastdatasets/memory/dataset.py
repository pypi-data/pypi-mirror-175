...
def MemoryRandomDatasetLoader(data_list: typing.Union[typing.List,typing.AnyStr,typing.Sized],
    ...
    if isinstance(data_list, list):
        if len(data_list) == 1:
            cls = SingleMemoryRandomDataset(data_list[0], index_path=index_path, use_index_cache=use_index_cache, options=options,
                                            
                                            )
        else:
            cls = MultiMemoryRandomDataset(data_list, index_path=index_path, use_index_cache=use_index_cache, options=options,
                                           )
