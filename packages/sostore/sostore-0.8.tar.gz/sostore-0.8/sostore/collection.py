...
class Collection():
    ...
    def find(self, field, value, compare_function=None):
        ...
        value_is_list = isinstance(value, Iterable) and not isinstance(value, _strtest)
        ...
        for d in fieldsearch:
            ...
            matched = False
            field_is_list = isinstance(d[field], Iterable) and not isinstance(d[field], _strtest)
