...
class PagedResponseImportError(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ImportError']:
                        return ImportError
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ImportError'], typing.List['ImportError']],
                ...
                def __getitem__(self, i: int) -> 'ImportError':
