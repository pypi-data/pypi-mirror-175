...
class PagedResponseSynchronizationInfo(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SynchronizationInfo']:
                        return SynchronizationInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SynchronizationInfo'], typing.List['SynchronizationInfo']],
                ...
                def __getitem__(self, i: int) -> 'SynchronizationInfo':
