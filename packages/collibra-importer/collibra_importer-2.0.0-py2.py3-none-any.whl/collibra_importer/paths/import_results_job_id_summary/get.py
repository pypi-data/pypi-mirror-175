...
SchemaFor200ResponseBodyApplicationJson = ImportSummary
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_import_job_summary_oapg(
        self,
...
class GetImportJobSummary(BaseApi):
    ...
    def get_import_job_summary(
        ...
        return self._get_import_job_summary_oapg(
