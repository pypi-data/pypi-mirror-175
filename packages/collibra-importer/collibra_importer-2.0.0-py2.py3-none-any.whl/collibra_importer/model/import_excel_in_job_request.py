...
class ImportExcelInJobRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["template", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "sheetName", "sheetIndex", "headerRow", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["template", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "sheetName", "sheetIndex", "headerRow", ], str]):
