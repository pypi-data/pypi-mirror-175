...
class SchemaForRequestBodyMultipartFormData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "finalizationStrategy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "finalizationStrategy", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _synchronize_json_in_job_oapg(
        self,
...
class SynchronizeJsonInJob(BaseApi):
    ...
    def synchronize_json_in_job(
        ...
        return self._synchronize_json_in_job_oapg(
            body=body,
