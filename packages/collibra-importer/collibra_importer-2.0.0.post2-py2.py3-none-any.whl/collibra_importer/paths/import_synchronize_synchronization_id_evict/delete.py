...
# Path params
SynchronizationIdSchema = schemas.StrSchema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _evict_synchronization_cache_oapg(
        self,
...
class EvictSynchronizationCache(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def evict_synchronization_cache(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def evict_synchronization_cache(
        ...
        return self._evict_synchronization_cache_oapg(
