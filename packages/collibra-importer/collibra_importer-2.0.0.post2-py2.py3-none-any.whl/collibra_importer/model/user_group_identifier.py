...
class UserGroupIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "indexes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "indexes", ], str]):
