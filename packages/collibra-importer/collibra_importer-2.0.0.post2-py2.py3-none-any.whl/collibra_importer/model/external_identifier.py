...
class ExternalIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["externalSystemId", "externalEntityId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["externalSystemId", "externalEntityId", ], str]):
