...
SchemaFor200ResponseBodyApplicationJson = PagedResponseSynchronizationInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_synchronization_infos_oapg(
        self,
...
class FindSynchronizationInfos(BaseApi):
    ...
    def find_synchronization_infos(
        ...
        return self._find_synchronization_infos_oapg(
