...
class SchemaForRequestBodyMultipartFormData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "sheetName", "sheetIndex", "headerRow", "template", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "sheetName", "sheetIndex", "headerRow", "template", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _synchronize_batch_excel_in_job_oapg(
        self,
...
class SynchronizeBatchExcelInJob(BaseApi):
    ...
    def synchronize_batch_excel_in_job(
        ...
        return self._synchronize_batch_excel_in_job_oapg(
            body=body,
