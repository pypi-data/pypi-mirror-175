...
class SynchronizationBatchJsonInJobRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["synchronizationId", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "relationsAction", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["synchronizationId", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "relationsAction", ], str]):
