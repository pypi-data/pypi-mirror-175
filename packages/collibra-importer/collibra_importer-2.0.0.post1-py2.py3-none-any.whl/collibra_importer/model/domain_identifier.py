...
class DomainIdentifier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "indexes", "externalSystemId", "externalEntityId", "name", "community", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "indexes", "externalSystemId", "externalEntityId", "name", "community", ], str]):
