...
class SynchronizationCsvInJobRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["synchronizationId", "separator", "quote", "escape", "template", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "strictQuotes", "ignoreLeadingWhitespace", "headerRow", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["synchronizationId", "separator", "quote", "escape", "template", "sendNotification", "batchSize", "simulation", "saveResult", "fileId", "file", "fileName", "deleteFile", "continueOnError", "strictQuotes", "ignoreLeadingWhitespace", "headerRow", ], str]):
