...
SchemaFor200ResponseBodyApplicationJson = ImportErrorPagedResponse
...
class FindImportErrors(BaseApi):
    ...
    def find_import_errors(
        ...
        return self._find_import_errors_oapg(
