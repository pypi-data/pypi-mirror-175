...
from torch.nn import Module, SyncBatchNorm, parallel
...
class DistributedDataParallel(
    ...
    r"""
    Classe interface à torch.nn.parallel.DistributedDataParallel. Pour
    connaitre les arguements de cette classe ce référer à la doc PyTorch.
    """
    def __init__(
        self,
        module,
