...
class PolygonDataFetch:
    """
    fetchData() will fetch the data from the RESTClient provided by polygon.
    It also includes `ts_to_datetime()`, `reset_raw_data_tables()`, `initialize_raw_data_tables()`, `initialize_aggregated_tables()`,
    `aggregate_raw_data_tables()` functions as a class functions which were the dependency for max christs main funtion.
    """

    def __init__(self):
        # I initiated the class with the apikey as a class variable so that I can access in other functions
        self.apiKey = "beBybSi8daPgsTp5yx5cHtHpYcrjp5Jq"
    ...
    """
    :param currency_pairs: The currency_pairs.
    :type currency_pairs: dict
    """
    def fetchData(self, currency_pairs):
        # This function logic is the exact copy of main funtion of max christ
        ...
        return "Data Stored in DB Successfully"
