...
DLL_EXPORT void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
              std::int64_t k, sycl::half alpha, cl::sycl::buffer<sycl::half, 1> &a, std::int64_t lda,
              cl::sycl::buffer<sycl::half, 1> &b, std::int64_t ldb, sycl::half beta, cl::sycl::buffer<sycl::half, 1> &c,
              std::int64_t ldc);

DLL_EXPORT void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
              std::int64_t k, float alpha, cl::sycl::buffer<sycl::half, 1> &a, std::int64_t lda,
              cl::sycl::buffer<sycl::half, 1> &b, std::int64_t ldb, float beta, cl::sycl::buffer<float, 1> &c,
              std::int64_t ldc);
...
DLL_EXPORT void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
              std::int64_t k, float alpha, cl::sycl::buffer<bfloat16, 1> &a, std::int64_t lda,
              cl::sycl::buffer<bfloat16, 1> &b, std::int64_t ldb, float beta, cl::sycl::buffer<bfloat16, 1> &c,
              std::int64_t ldc);

DLL_EXPORT void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
              std::int64_t k, float alpha, cl::sycl::buffer<std::int8_t, 1> &a, std::int64_t lda,
              cl::sycl::buffer<std::int8_t, 1> &b, std::int64_t ldb, float beta, cl::sycl::buffer<std::int32_t, 1> &c,
              std::int64_t ldc);

DLL_EXPORT void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
              std::int64_t k, float alpha, cl::sycl::buffer<std::int8_t, 1> &a, std::int64_t lda,
              cl::sycl::buffer<std::int8_t, 1> &b, std::int64_t ldb, float beta, cl::sycl::buffer<float, 1> &c,
              std::int64_t ldc);
...
DLL_EXPORT void axpy(cl::sycl::queue &queue, std::int64_t n, sycl::half alpha, cl::sycl::buffer<sycl::half,1> &x, std::int64_t incx, cl::sycl::buffer<sycl::half,1> &y, std::int64_t incy);


DLL_EXPORT void axpy(cl::sycl::queue &queue, std::int64_t n, bfloat16 alpha, cl::sycl::buffer<bfloat16,1> &x, std::int64_t incx, cl::sycl::buffer<bfloat16,1> &y, std::int64_t incy);
...
DLL_EXPORT void dot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<sycl::half,1> &x, std::int64_t incx, cl::sycl::buffer<sycl::half,1> &y, std::int64_t incy, cl::sycl::buffer<sycl::half,1> &result);


DLL_EXPORT void dot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<bfloat16,1> &x, std::int64_t incx, cl::sycl::buffer<bfloat16,1> &y, std::int64_t incy, cl::sycl::buffer<bfloat16,1> &result);
...
DLL_EXPORT void nrm2(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<sycl::half,1> &x, std::int64_t incx, cl::sycl::buffer<sycl::half,1> &result);


DLL_EXPORT void nrm2(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<bfloat16,1> &x, std::int64_t incx, cl::sycl::buffer<bfloat16,1> &result);
...
DLL_EXPORT void rot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<sycl::half,1> &x, std::int64_t incx, cl::sycl::buffer<sycl::half,1> &y, std::int64_t incy, sycl::half c, sycl::half s);


DLL_EXPORT void rot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<bfloat16,1> &x, std::int64_t incx, cl::sycl::buffer<bfloat16,1> &y, std::int64_t incy, bfloat16 c, bfloat16 s);
...
DLL_EXPORT void rot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<std::complex<float>,1> &x, std::int64_t incx, cl::sycl::buffer<std::complex<float>,1> &y, std::int64_t incy, float c, std::complex<float> s);
...
DLL_EXPORT void rot(cl::sycl::queue &queue, std::int64_t n, cl::sycl::buffer<std::complex<double>,1> &x, std::int64_t incx, cl::sycl::buffer<std::complex<double>,1> &y, std::int64_t incy, double c, std::complex<double> s);
...
DLL_EXPORT void scal(cl::sycl::queue &queue, std::int64_t n, sycl::half alpha, cl::sycl::buffer<sycl::half,1> &x, std::int64_t incx);


DLL_EXPORT void scal(cl::sycl::queue &queue, std::int64_t n, bfloat16 alpha, cl::sycl::buffer<bfloat16,1> &x, std::int64_t incx);
...
DLL_EXPORT void imatcopy_batch(cl::sycl::queue &queue, transpose trans,
                               std::int64_t m, std::int64_t n, float alpha, cl::sycl::buffer<float, 1> &ab, std::int64_t lda,
                               std::int64_t ldb, std::int64_t stride, std::int64_t batch_size);

DLL_EXPORT void imatcopy_batch(cl::sycl::queue &queue, transpose trans,
                               std::int64_t m, std::int64_t n, double alpha, cl::sycl::buffer<double, 1> &ab, std::int64_t lda,
                               std::int64_t ldb, std::int64_t stride, std::int64_t batch_size);

DLL_EXPORT void imatcopy_batch(cl::sycl::queue &queue, transpose trans,
                               std::int64_t m, std::int64_t n, std::complex<float> alpha,
                               cl::sycl::buffer<std::complex<float>, 1> &ab, std::int64_t lda,
                               std::int64_t ldb, std::int64_t stride, std::int64_t batch_size);

DLL_EXPORT void imatcopy_batch(cl::sycl::queue &queue, transpose trans,
                               std::int64_t m, std::int64_t n, std::complex<double> alpha,
                               cl::sycl::buffer<std::complex<double>, 1> &ab, std::int64_t lda,
                               std::int64_t ldb, std::int64_t stride, std::int64_t batch_size);

DLL_EXPORT void omatcopy_batch(cl::sycl::queue &queue, transpose trans,
                               std::int64_t m, std::int64_t n, float alpha,
...
DLL_EXPORT void omatadd_batch(cl::sycl::queue &queue, transpose transa, transpose transb,
                              std::int64_t m, std::int64_t n, float alpha,
                              cl::sycl::buffer<float, 1> &a, std::int64_t lda, std::int64_t stride_a,
                              float beta, cl::sycl::buffer<float, 1> &b, std::int64_t ldb, std::int64_t stride_b,
...
DLL_EXPORT void omatadd_batch(cl::sycl::queue &queue, transpose transa, transpose transb,
                              std::int64_t m, std::int64_t n, double alpha,
                              cl::sycl::buffer<double, 1> &a, std::int64_t lda, std::int64_t stride_a,
                              double beta, cl::sycl::buffer<double, 1> &b, std::int64_t ldb, std::int64_t stride_b,
...
DLL_EXPORT void omatadd_batch(cl::sycl::queue &queue, transpose transa, transpose transb,
                              std::int64_t m, std::int64_t n, std::complex<float> alpha,
                              cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda, std::int64_t stride_a,
                              std::complex<float> beta, cl::sycl::buffer<std::complex<float>, 1> &b,
...
DLL_EXPORT void omatadd_batch(cl::sycl::queue &queue, transpose transa, transpose transb,
                              std::int64_t m, std::int64_t n, std::complex<double> alpha,
                              cl::sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda, std::int64_t stride_a,
                              std::complex<double> beta, cl::sycl::buffer<std::complex<double>, 1> &b,
                              std::int64_t ldb, std::int64_t stride_b,
...
DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, sycl::half alpha, cl::sycl::buffer<sycl::half, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<sycl::half, 1> &b, std::int64_t ldb, std::int64_t stride_b, sycl::half beta, cl::sycl::buffer<sycl::half, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);

DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, float alpha, cl::sycl::buffer<sycl::half, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<sycl::half, 1> &b, std::int64_t ldb, std::int64_t stride_b, float beta, cl::sycl::buffer<float, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);

DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, float alpha, cl::sycl::buffer<bfloat16, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<bfloat16, 1> &b, std::int64_t ldb, std::int64_t stride_b, float beta, cl::sycl::buffer<bfloat16, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);

DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, float alpha, cl::sycl::buffer<bfloat16, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<bfloat16, 1> &b, std::int64_t ldb, std::int64_t stride_b, float beta, cl::sycl::buffer<float, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);

DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, float alpha, cl::sycl::buffer<std::int8_t, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<std::int8_t, 1> &b, std::int64_t ldb, std::int64_t stride_b, float beta, cl::sycl::buffer<std::int32_t, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);

DLL_EXPORT void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
                    std::int64_t k, float alpha, cl::sycl::buffer<std::int8_t, 1> &a, std::int64_t lda,
                    std::int64_t stride_a,
                    cl::sycl::buffer<std::int8_t, 1> &b, std::int64_t ldb, std::int64_t stride_b, float beta, cl::sycl::buffer<float, 1> &c,
                    std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size);
...
DLL_EXPORT void imatcopy(sycl::queue &queue, transpose trans,
                         std::int64_t m, std::int64_t n,
                         double alpha, cl::sycl::buffer<double, 1> &ab,
                         std::int64_t lda, std::int64_t ldb);

DLL_EXPORT void imatcopy(sycl::queue &queue, transpose trans,
                         std::int64_t m, std::int64_t n,
                         std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &ab,
                         std::int64_t lda, std::int64_t ldb);

DLL_EXPORT void imatcopy(sycl::queue &queue, transpose trans,
                         std::int64_t m, std::int64_t n,
                         std::complex<double> alpha, cl::sycl::buffer<std::complex<double>, 1> &ab,
                         std::int64_t lda, std::int64_t ldb);
...
DLL_EXPORT void omatadd(sycl::queue &queue, transpose transa, transpose transb,
                        std::int64_t m, std::int64_t n,
                        double alpha, cl::sycl::buffer<double, 1> &a, std::int64_t lda,
                        double beta, cl::sycl::buffer<double, 1> &b, std::int64_t ldb,
                        cl::sycl::buffer<double, 1> &c, std::int64_t ldc);

DLL_EXPORT void omatadd(sycl::queue &queue, transpose transa, transpose transb,
                        std::int64_t m, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                        std::complex<float> beta, cl::sycl::buffer<std::complex<float>, 1> &b, std::int64_t ldb,
                        cl::sycl::buffer<std::complex<float>, 1> &c, std::int64_t ldc);

DLL_EXPORT void omatadd(sycl::queue &queue, transpose transa, transpose transb,
                        std::int64_t m, std::int64_t n,
                        std::complex<double> alpha, cl::sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda,
                        std::complex<double> beta, cl::sycl::buffer<std::complex<double>, 1> &b, std::int64_t ldb,
                        cl::sycl::buffer<std::complex<double>, 1> &c, std::int64_t ldc);
