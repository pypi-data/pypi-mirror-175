...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue,
                                      ...
                                      const sycl::span<std::int64_t> &k,
                                      const sycl::span<float> &alpha,
                                      const sycl::span<const bfloat16*> &a, const sycl::span<std::int64_t> &lda,
                                      const sycl::span<const bfloat16*> &b, const sycl::span<std::int64_t> &ldb,
                                      const sycl::span<float> &beta,
                                      const sycl::span<bfloat16*> &c, const sycl::span<std::int64_t> &ldc,
                                      size_t group_count, const sycl::span<size_t> &groupsize,
                                      const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue,
                                      ...
                                      const sycl::span<std::int64_t> &k,
                                      const sycl::span<float> &alpha,
                                      const sycl::span<const std::int8_t*> &a, const sycl::span<std::int64_t> &lda,
                                      const sycl::span<const std::int8_t*> &b, const sycl::span<std::int64_t> &ldb,
                                      const sycl::span<float> &beta,
                                      const sycl::span<std::int32_t*> &c, const sycl::span<std::int64_t> &ldc,
                                      size_t group_count, const sycl::span<size_t> &groupsize,
                                      const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue, const transpose *transa, const transpose *transb,
                           const std::int64_t *m, const std::int64_t *n, const std::int64_t *k, const float *alpha,
                           const bfloat16 **a, const std::int64_t *lda,
                           const bfloat16 **b, const std::int64_t *ldb,
                           const float *beta, bfloat16 **c, const std::int64_t *ldc,
                           std::int64_t group_count, const std::int64_t *groupsize,
                           const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event gemm_batch(cl::sycl::queue &queue, const transpose *transa, const transpose *transb,
                           const std::int64_t *m, const std::int64_t *n, const std::int64_t *k, const float *alpha,
                           const std::int8_t **a, const std::int64_t *lda,
                           const std::int8_t **b, const std::int64_t *ldb,
                           const float *beta, std::int32_t **c, const std::int64_t *ldc,
                           std::int64_t group_count, const std::int64_t *groupsize,
                           const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event axpy(cl::sycl::queue &queue, std::int64_t n, sycl::half alpha, const sycl::half *x, std::int64_t incx, sycl::half *y, std::int64_t incy, const std::vector<cl::sycl::event> &dependencies = {});

DLL_EXPORT cl::sycl::event axpy(cl::sycl::queue &queue, std::int64_t n, bfloat16 alpha, const bfloat16 *x, std::int64_t incx, bfloat16 *y, std::int64_t incy, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event dot(cl::sycl::queue &queue, std::int64_t n, const sycl::half *x, std::int64_t incx, const sycl::half *y, std::int64_t incy, sycl::half *result, const std::vector<cl::sycl::event> &dependencies = {});

DLL_EXPORT cl::sycl::event dot(cl::sycl::queue &queue, std::int64_t n, const bfloat16 *x, std::int64_t incx, const bfloat16 *y, std::int64_t incy, bfloat16 *result, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event nrm2(cl::sycl::queue &queue, std::int64_t n, const sycl::half *x, std::int64_t incx, sycl::half *result, const std::vector<cl::sycl::event> &dependencies = {});

DLL_EXPORT cl::sycl::event nrm2(cl::sycl::queue &queue, std::int64_t n, const bfloat16 *x, std::int64_t incx, bfloat16 *result, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event rot(cl::sycl::queue &queue, std::int64_t n, sycl::half *x, std::int64_t incx, sycl::half *y, std::int64_t incy, sycl::half c, sycl::half s, const std::vector<cl::sycl::event> &dependencies = {});

DLL_EXPORT cl::sycl::event rot(cl::sycl::queue &queue, std::int64_t n, bfloat16 *x, std::int64_t incx, bfloat16 *y, std::int64_t incy, bfloat16 c, bfloat16 s, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event rot(cl::sycl::queue &queue, std::int64_t n, std::complex<float> *x, std::int64_t incx, std::complex<float> *y, std::int64_t incy, float c, std::complex<float> s, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event rot(cl::sycl::queue &queue, std::int64_t n, std::complex<double> *x, std::int64_t incx, std::complex<double> *y, std::int64_t incy, double c, std::complex<double> s, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT cl::sycl::event scal(cl::sycl::queue &queue, std::int64_t n, sycl::half alpha, sycl::half *x, std::int64_t incx, const std::vector<cl::sycl::event> &dependencies = {});

DLL_EXPORT cl::sycl::event scal(cl::sycl::queue &queue, std::int64_t n, bfloat16 alpha, bfloat16 *x, std::int64_t incx, const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event omatadd(sycl::queue &queue, transpose transa, transpose transb,
                               std::int64_t m, std::int64_t n,
                               std::complex<float> alpha, const std::complex<float> *a, std::int64_t lda,
                               std::complex<float> beta, const std::complex<float> *b, std::int64_t ldb,
                               std::complex<float> *c, std::int64_t ldc,
                               const std::vector<cl::sycl::event> &dependencies = {});
...
DLL_EXPORT sycl::event omatadd(sycl::queue &queue, transpose transa, transpose transb,
                               std::int64_t m, std::int64_t n,
                               std::complex<double> alpha, const std::complex<double> *a, std::int64_t lda,
                               std::complex<double> beta, const std::complex<double> *b, std::int64_t ldb,
                               std::complex<double> *c, std::int64_t ldc,
                               const std::vector<cl::sycl::event> &dependencies = {});
