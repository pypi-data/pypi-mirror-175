...
urlpatterns = [
    re_path(r'^category_add/?$', ThreadCategoryApis.add, name='category_list'),  # 类别列表
    re_path(r'^category_del/?(?P<pk>[-_\w]+)?', ThreadCategoryApis.delete, name='category_list'),  # 类别列表
    re_path(r'^category_edit/?(?P<pk>[-_\w]+)?', ThreadCategoryApis.edit, name='category_list'),  # 类别列表
