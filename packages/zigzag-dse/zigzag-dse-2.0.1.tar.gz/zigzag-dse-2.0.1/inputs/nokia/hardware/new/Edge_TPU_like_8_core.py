...
def memory_hierarchy_dut(multiplier_array):
    ...
    memory_hierarchy_graph.add_memory(memory_instance=sram_32KB_512_1r_1w, operands=('I1', 'O'),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
...
def multiplier_array_dut():
    ...
    multiplier_area = 1
    dimensions = {'D1': 16, 'D2': 32}  # {'D1': ('K', 8), 'D2': ('C', 8), 'D3': ('OX', 4), 'D4': ('OY', 4),}
...
def cores():
    ...
    core3 = Core(3, multiplier_array1, memory_hierarchy1)
    core4 = Core(4, multiplier_array1, memory_hierarchy1)
    core5 = Core(5, multiplier_array1, memory_hierarchy1)
    core6 = Core(6, multiplier_array1, memory_hierarchy1)
    core7 = Core(7, multiplier_array1, memory_hierarchy1)
    core8 = Core(8, multiplier_array1, memory_hierarchy1)

    return {core1, core2, core3, core4, core5, core6, core7, core8}
