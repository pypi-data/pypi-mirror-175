...
class SchematicAPI:
    ...
    def precompile_fmu(self, fmu_file_path, precompiled_file_path=None):
        """
        ...
        Returns:
            None
        """
        return clstub().precompile_fmu(self, fmu_file_path=fmu_file_path, precompiled_file_path=precompiled_file_path)
