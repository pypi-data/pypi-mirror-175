...
def lowest_common_ancestor():
    curr_path = os.path.dirname(__file__)
    file_path = os.path.join(curr_path, './lowest_common_ancestor.py')
    lowest_common_ancestor_code = ""
    with open(file_path, 'r') as f:
        lowest_common_ancestor_code = f.read()

    f.close()
    pyperclip.copy(lowest_common_ancestor_code)
    return lowest_common_ancestor_code
