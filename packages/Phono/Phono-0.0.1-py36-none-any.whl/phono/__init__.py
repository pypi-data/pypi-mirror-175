...
@author: cnheider
"""
__all__ = ["PROJECT_APP_PATH", "PROJECT_NAME", "PROJECT_VERSION", "get_version", 'PROJECT_ORGANISATION',
           'PROJECT_AUTHOR', 'PROJECT_YEAR', 'INCLUDE_PROJECT_READMES', 'PACKAGE_DATA_PATH']
