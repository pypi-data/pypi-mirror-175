...
from hic_ssdna.src.hic_ssdna.oligos_replacement import oligo_correction

genome_path ='/scratch/lanani/Stage_L3_cbp/Projet/Pycharm/inputs/S288c_DSB_LY_Capture_original.fa'


oligos_path = '/scratch/lanani/Stage_L3_cbp/' \
'Projet/Pycharm/inputs/oligo_positions.csv'

output_path = '/home/lanani/outputs/S288c_DSB_LY_Capture_original_artificial.fa'

bed_paths = '/scratch/lanani/Stage_L3_cbp/' \
