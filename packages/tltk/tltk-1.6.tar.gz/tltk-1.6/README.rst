Thai Language Toolkit Project  version 1.6
==========================================
...
* avgedu ## avg. of edu length (word)
* avgwrd ## avg. of word length (syllable)
* avgpar ## avg. of paragraph length (word)
* avgcorrtone  ## avg. of correct tone form and phone
* avgcorrfinal  ## avg. of correct final consonant กก กด กง กน กม เกย เกอว
* avgkaran ## avg. of karan
* avgcluster  ## avg. of cluster
* avgdoubvowel ## avg. of double vowel
* NEl ## No. of named entity location
* NEo ## No. of named entity organization
* NEp ## No. of named entity person
* negation  ## No.no of negation
...
* wrdlevelX, wrdC/F/CF, wrdfrm..., wrdsem..., wrdbaseM, wrdbaseT are No. of words in each category (see below)
...
* avgwrdbaseM ## ratio of basic vocab from min.of Education per total
* avgwrdbaseT ## ratio of basic vocab from TNC&TTC per total
* avgtfidf  ## average of tfidf of each word (calculated from TNC)
* avgtncdisp ## average of dispersion of each word (calculated from TNC)
* avgttcdisp ## average of dispersion of each word (calculated from TTC)
* avgarf ## average of arf (average reduced frequency) of each word in the text
* pos ##  pos[POS]=freq, (POS = { NOUN, VERB, ADV, ...} )
