...
# -*- coding: utf-8 -*-
#########################################################
## Thai Language Toolkit : version  1.6
...
class TextProp:
    ...
    wrdbaseM = 0 ## no word in basic vocab of ministry of Education
    wrdbaseT = 0 ## no word in basic vocab from TNC & TTC < 2000
...
#        print("word",w)
    ...
    txt.avgwrdbaseM = txt.wrdbaseM/txt.totalword
    txt.avgwrdbaseT = txt.wrdbaseT/txt.totalword
