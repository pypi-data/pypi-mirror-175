...
class GIWAXSMainWindow(QMainWindow):
    ...
    def _init_shortcuts(self):
        ...
        self.fit_shortcut = QShortcut(QKeySequence('Ctrl+S'), self)
        self.fit_shortcut.activated.connect(self._save_state)
    ...
    def _save_state(self, *args):
        self.app.save_state()
        QMessageBox.information(self, 'Data saved', "The fitted peaks are successfully saved")
