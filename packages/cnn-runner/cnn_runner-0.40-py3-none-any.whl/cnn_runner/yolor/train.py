...
from cnn_runner.yolor.utils_yolor.autoanchor import check_anchors
from cnn_runner.yolor.utils_yolor.datasets import create_dataloader
from cnn_runner.yolor.utils_yolor.general import labels_to_class_weights, increment_path, labels_to_image_weights, init_seeds, \
...
from cnn_runner.yolor.utils_yolor.google_utils import attempt_download
from cnn_runner.yolor.utils_yolor.loss import compute_loss
from cnn_runner.yolor.utils_yolor.plots import plot_images, plot_labels, plot_results, plot_evolution
from cnn_runner.yolor.utils_yolor.torch_utils import ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='aes/aes.yaml', help='data.yaml path')
