...
from cnn_runner.yolor.utils_yolor.general import xywh2xyxy, xyxy2xywh
from cnn_runner.yolor.utils_yolor.metrics import fitness
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    tl = line_thickness or round(0.0012 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thickness
    ...
    if label:
        ...
        cv2.putText(img, label, (c1[0], c1[1] - 2), cv2.FONT_HERSHEY_COMPLEX, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA,
                    )
