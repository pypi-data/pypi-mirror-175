...
FALLBACK_STREAMER_OFFLINE_ARCHIVE_UPLOAD_MESSAGE = "Could not send live data to Comet during experiment runtime. An offline experiment will be available for upload:\n    comet upload --force-reupload %s"
