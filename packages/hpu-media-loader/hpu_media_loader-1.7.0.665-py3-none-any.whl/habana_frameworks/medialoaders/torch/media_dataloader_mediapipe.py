...
class HPUMediaPipe(MediaPipe):
    ...
    def __init__(self, a_torch_transforms=None, a_root=None, a_annotation_file=None, a_batch_size=1, a_shuffle=False, a_drop_last=True, a_prefetch_count=1, a_num_instances=1, a_instance_id=0, a_model_ssd=False, a_device=None):
        """
        Constructor method.
        ...
        super().__init__(device=a_device, batch_size=batchSize,
                         prefetch_depth=a_prefetch_count, pipename=pipename)
    ...
    def definegraph(self):
        ...
        if self.model_ssd == True:
            decode_stage = ds.ENABLE_SINGLE_STAGE
            if self.ssd_train == True:
        ...
        if enable_decoder_random_crop == True:
            ...
            self.decode = fn.ImageDecoder(output_format=it.RGB_P, resize=def_output_image_size, filter=res_pp_filter, random_crop_type=rct.PYT_RANDOM_CROP,
            ...
            self.decode = fn.ImageDecoder(
                output_format=it.RGB_P, resize=def_output_image_size, filter=res_pp_filter, decoder_stage=decode_stage)
