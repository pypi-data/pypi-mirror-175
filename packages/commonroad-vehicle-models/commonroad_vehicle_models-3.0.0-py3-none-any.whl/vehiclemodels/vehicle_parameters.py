...
class VehicleParameters:
    ...
    # steering parameters
    steering: SteeringParameters = SteeringParameters()

    # longitudinal parameters
    longitudinal: LongitudinalParameters = LongitudinalParameters()
    ...
    # tire parameters
    tire: TireParameters = TireParameters()

    # trailer parameters
    trailer: TrailerParameters = TrailerParameters()


def setup_vehicle_parameters(vehicle_id: int, dir_params: str = None) -> DictConfig:
    """
    Creates an OmegaConf DictConfig object holding all vehicle parameters for a given vehicle type ID
    ...
    :return OmegaConf.DictConfig object with vehicle parameters
    """
