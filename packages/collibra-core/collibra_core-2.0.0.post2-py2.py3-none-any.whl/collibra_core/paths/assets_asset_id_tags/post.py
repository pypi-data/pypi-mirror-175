...
# body param
SchemaForRequestBodyApplicationJson = AddAssetTagsRequest


request_body_add_asset_tags_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_tags_to_asset_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_asset_tags_request.serialize(body, content_type)
...
class AddTagsToAsset(BaseApi):
    ...
    def add_tags_to_asset(
        ...
        return self._add_tags_to_asset_oapg(
            body=body,
