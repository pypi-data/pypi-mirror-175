...
# body param
SchemaForRequestBodyApplicationJson = AddResponsibilityRequest
...
SchemaFor201ResponseBodyApplicationJson = ResponsibilityImpl
...
class AddResponsibility(BaseApi):
    ...
    def add_responsibility(
        ...
        return self._add_responsibility_oapg(
            body=body,
