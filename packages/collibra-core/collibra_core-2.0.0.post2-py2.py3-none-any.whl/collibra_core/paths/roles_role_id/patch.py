...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'roleId': typing.Union[RoleIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ChangeRoleRequest


request_body_change_role_request = api_client.RequestBody(
    content={
...
SchemaFor0ResponseBodyApplicationJson = RoleImpl
...
class BaseApi(api_client.Api):
    ...
    def _change_role_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_change_role_request.serialize(body, content_type)
