...
# Path params
MappingIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'mappingId': typing.Union[MappingIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ChangeMappingRequest
...
class ChangeMapping(BaseApi):
    ...
    def change_mapping(
        ...
        return self._change_mapping_oapg(
            body=body,
