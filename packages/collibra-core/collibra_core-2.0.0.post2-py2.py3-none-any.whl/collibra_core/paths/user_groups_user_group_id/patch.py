...
# body param
SchemaForRequestBodyApplicationJson = ChangeUserGroupRequest


request_body_change_user_group_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UserGroupImpl
...
class BaseApi(api_client.Api):
    ...
    def _change_user_group_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_change_user_group_request.serialize(body, content_type)
...
class ChangeUserGroup(BaseApi):
    ...
    def change_user_group(
        ...
        return self._change_user_group_oapg(
            body=body,
