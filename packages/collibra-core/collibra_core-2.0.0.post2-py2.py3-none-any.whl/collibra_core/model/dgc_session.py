...
class DGCSession(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["csrfToken", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["csrfToken", "user", ], str]):
