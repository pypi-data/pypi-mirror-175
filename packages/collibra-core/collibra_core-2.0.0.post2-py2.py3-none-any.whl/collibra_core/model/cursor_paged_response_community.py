...
class CursorPagedResponseCommunity(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CommunityImpl']:
                        return CommunityImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CommunityImpl'], typing.List['CommunityImpl']],
                ...
                def __getitem__(self, i: int) -> 'CommunityImpl':
