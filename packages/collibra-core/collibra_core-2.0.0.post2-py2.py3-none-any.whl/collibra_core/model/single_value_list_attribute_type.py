...
class SingleValueListAttributeType(
    ...
    Represents an attribute which holds a list of allowed string values from which a single value can be chosen
    """
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["allowedValues", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["allowedValues", ], str]):
