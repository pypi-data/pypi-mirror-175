...
class ChangeScopeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "domainIds", "communityIds", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "domainIds", "communityIds", ], str]):
