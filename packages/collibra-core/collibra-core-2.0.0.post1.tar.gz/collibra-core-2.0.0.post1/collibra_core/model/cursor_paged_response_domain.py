...
class CursorPagedResponseDomain(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DomainImpl']:
                        return DomainImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DomainImpl'], typing.List['DomainImpl']],
                ...
                def __getitem__(self, i: int) -> 'DomainImpl':
