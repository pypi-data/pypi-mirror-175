        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JdbcDriver']:
                        return JdbcDriver
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JdbcDriver'], typing.List['JdbcDriver']],
                ...
                def __getitem__(self, i: int) -> 'JdbcDriver':
