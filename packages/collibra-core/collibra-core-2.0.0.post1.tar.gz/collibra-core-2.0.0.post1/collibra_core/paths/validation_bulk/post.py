...
# body param
SchemaForRequestBodyApplicationJson = ValidateInJobRequest


request_body_validate_in_job_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _validate_in_job_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_validate_in_job_request.serialize(body, content_type)
...
class ValidateInJob(BaseApi):
    ...
    def validate_in_job(
        ...
        return self._validate_in_job_oapg(
            body=body,
