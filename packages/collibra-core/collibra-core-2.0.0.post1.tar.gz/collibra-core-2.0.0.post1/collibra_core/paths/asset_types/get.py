...
TopLevelSchema = schemas.BoolSchema
DisplayNameEnabledSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'topLevel': typing.Union[TopLevelSchema, bool, ],
        'displayNameEnabled': typing.Union[DisplayNameEnabledSchema, bool, ],
    },
    total=False
)
...
request_query_top_level = api_client.QueryParameter(
    name="topLevel",
    style=api_client.ParameterStyle.FORM,
    schema=TopLevelSchema,
    explode=True,
)
request_query_display_name_enabled = api_client.QueryParameter(
    name="displayNameEnabled",
    style=api_client.ParameterStyle.FORM,
    schema=DisplayNameEnabledSchema,
    explode=True,
)
_auth = [
    'basicAuth',
...
SchemaFor200ResponseBodyApplicationJson = AssetTypePagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _find_asset_types_oapg(
        ...
        for parameter in (
            ...
            request_query_top_level,
            request_query_display_name_enabled,
        ):
...
class FindAssetTypes(BaseApi):
    ...
    def find_asset_types(
        ...
        return self._find_asset_types_oapg(
