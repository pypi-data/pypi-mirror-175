...
# body param
SchemaForRequestBodyApplicationJson = AddIssueRequest


request_body_add_issue_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_issue_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_issue_request.serialize(body, content_type)
