...
# body param
SchemaForRequestBodyApplicationJson = AddCommentRequest


request_body_add_comment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Comment
...
class BaseApi(api_client.Api):
    ...
    def _add_comment_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_comment_request.serialize(body, content_type)
