...
# body param
SchemaForRequestBodyApplicationJson = AddScopeRequest


request_body_add_scope_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ScopeImpl
...
class BaseApi(api_client.Api):
    ...
    def _add_scope_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_scope_request.serialize(body, content_type)
