...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AddAttributeRequest']:
            return AddAttributeRequest

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AddAttributeRequest'], typing.List['AddAttributeRequest']],
    ...
    def __getitem__(self, i: int) -> 'AddAttributeRequest':
        return super().__getitem__(i)


request_body_add_attribute_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_attributes_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_attribute_request.serialize(body, content_type)
...
class AddAttributes(BaseApi):
    ...
    def add_attributes(
        ...
        return self._add_attributes_oapg(
            body=body,
