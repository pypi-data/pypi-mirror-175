...
class ChangeRelationRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sourceId", "targetId", "startingDate", "endingDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sourceId", "targetId", "startingDate", "endingDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        targetId: typing.Union[MetaOapg.properties.targetId, str, uuid.UUID, schemas.Unset] = schemas.unset,
