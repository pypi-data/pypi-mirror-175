...
class PagedResponseViewPermission(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ViewPermissionImpl']:
                        return ViewPermissionImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ViewPermissionImpl'], typing.List['ViewPermissionImpl']],
                ...
                def __getitem__(self, i: int) -> 'ViewPermissionImpl':
