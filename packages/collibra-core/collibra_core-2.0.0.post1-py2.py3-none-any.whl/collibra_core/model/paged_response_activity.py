        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ActivityImpl']:
                        return ActivityImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ActivityImpl'], typing.List['ActivityImpl']],
                ...
                def __getitem__(self, i: int) -> 'ActivityImpl':
