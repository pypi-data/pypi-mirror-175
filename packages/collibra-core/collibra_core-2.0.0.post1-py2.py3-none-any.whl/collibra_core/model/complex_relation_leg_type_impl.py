...
class ComplexRelationLegTypeImpl(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "minimumOccurrences", "maximumOccurrences", "assetType", "role", "coRole", "relationTypeId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "minimumOccurrences", "maximumOccurrences", "assetType", "role", "coRole", "relationTypeId", ], str]):
