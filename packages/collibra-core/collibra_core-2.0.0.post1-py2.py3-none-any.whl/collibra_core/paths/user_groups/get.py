...
IncludeEveryoneSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeEveryone': typing.Union[IncludeEveryoneSchema, bool, ],
    },
    total=False
)
...
request_query_include_everyone = api_client.QueryParameter(
    name="includeEveryone",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeEveryoneSchema,
    explode=True,
)
_auth = [
    'basicAuth',
...
SchemaFor200ResponseBodyApplicationJson = UserGroupPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _find_user_groups_oapg(
        ...
        for parameter in (
            ...
            request_query_include_everyone,
        ):
...
class FindUserGroups(BaseApi):
    ...
    def find_user_groups(
        ...
        return self._find_user_groups_oapg(
