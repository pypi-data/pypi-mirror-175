...
DatabaseVersionSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'databaseVersion': typing.Union[DatabaseVersionSchema, str, ],
    },
    total=False
)
...
request_query_database_version = api_client.QueryParameter(
    name="databaseVersion",
    style=api_client.ParameterStyle.FORM,
    schema=DatabaseVersionSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = JdbcDriverPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _find_jdbc_drivers_oapg(
        ...
        for parameter in (
            ...
            request_query_database_version,
        ):
...
class FindJdbcDrivers(BaseApi):
    ...
    def find_jdbc_drivers(
        ...
        return self._find_jdbc_drivers_oapg(
