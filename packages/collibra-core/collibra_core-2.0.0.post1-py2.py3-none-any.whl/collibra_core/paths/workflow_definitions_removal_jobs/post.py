...
class BaseApi(api_client.Api):
    @typing.overload
    def _remove_workflow_definitions_in_job_oapg(
        self,
...
class RemoveWorkflowDefinitionsInJob(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def remove_workflow_definitions_in_job(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, list, tuple, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def remove_workflow_definitions_in_job(
        ...
        return self._remove_workflow_definitions_in_job_oapg(
            body=body,
