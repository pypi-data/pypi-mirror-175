...
# body param
SchemaForRequestBodyApplicationJson = RemoveUsersFromUserGroupRequest


request_body_remove_users_from_user_group_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_users_from_user_group_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_remove_users_from_user_group_request.serialize(body, content_type)
