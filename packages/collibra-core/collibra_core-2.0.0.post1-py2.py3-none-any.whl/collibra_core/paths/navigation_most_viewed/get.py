...
PeriodSchema = schemas.Int64Schema
IsGuestExcludedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'period': typing.Union[PeriodSchema, decimal.Decimal, int, ],
        'isGuestExcluded': typing.Union[IsGuestExcludedSchema, bool, ],
    },
    total=False
)
...
request_query_is_guest_excluded = api_client.QueryParameter(
    name="isGuestExcluded",
    style=api_client.ParameterStyle.FORM,
    schema=IsGuestExcludedSchema,
    explode=True,
)
_auth = [
    'basicAuth',
...
SchemaFor200ResponseBodyApplicationJson = NavigationStatisticsEntryPagedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_most_viewed_assets_oapg(
        self,
    ...
    def _find_most_viewed_assets_oapg(
        ...
        for parameter in (
            ...
            request_query_is_guest_excluded,
        ):
...
class FindMostViewedAssets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_most_viewed_assets(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_most_viewed_assets(
        ...
        return self._find_most_viewed_assets_oapg(
