...
# body param
SchemaForRequestBodyApplicationJson = AddComplexRelationRequest


request_body_add_complex_relation_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ComplexRelationImpl
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_complex_relation_oapg(
        self,
    ...
    def _add_complex_relation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_complex_relation_request.serialize(body, content_type)
...
class AddComplexRelation(BaseApi):
    ...
    def add_complex_relation(
        ...
        return self._add_complex_relation_oapg(
            body=body,
