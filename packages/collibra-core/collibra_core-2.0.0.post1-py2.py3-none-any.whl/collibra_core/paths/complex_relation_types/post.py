...
# body param
SchemaForRequestBodyApplicationJson = AddComplexRelationTypeRequest


request_body_add_complex_relation_type_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ComplexRelationTypeImpl
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_complex_relation_type_oapg(
        self,
    ...
    def _add_complex_relation_type_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_complex_relation_type_request.serialize(body, content_type)
...
class AddComplexRelationType(BaseApi):
    ...
    def add_complex_relation_type(
        ...
        return self._add_complex_relation_type_oapg(
            body=body,
