...
# body param
SchemaForRequestBodyApplicationJson = AddViewPermissionRequest


request_body_add_view_permission_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ViewPermissionImpl
...
class BaseApi(api_client.Api):
    ...
    def _add_view_permission_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_view_permission_request.serialize(body, content_type)
...
class AddViewPermission(BaseApi):
    ...
    def add_view_permission(
        ...
        return self._add_view_permission_oapg(
            body=body,
