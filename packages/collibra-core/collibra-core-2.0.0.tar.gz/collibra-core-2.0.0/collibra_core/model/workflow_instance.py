...
class WorkflowInstance(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class subInstances(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkflowInstance'], typing.List['WorkflowInstance']],
            ...
            subProcessInstancesCount = schemas.Int64Schema
            parentWorkflowInstanceId = schemas.StrSchema
            ...
            class tasks(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkflowTask']:
                        return WorkflowTask
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkflowTask'], typing.List['WorkflowTask']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'tasks':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'WorkflowTask':
                    return super().__getitem__(i)
            startDate = schemas.Int64Schema
            ended = schemas.BoolSchema
            createdAssetId = schemas.UUIDSchema
            ...
            __annotations__ = {
                ...
                "subProcessInstancesCount": subProcessInstancesCount,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subInstances"]) -> MetaOapg.properties.subInstances: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subProcessInstancesCount"]) -> MetaOapg.properties.subProcessInstancesCount: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parentWorkflowInstanceId"]) -> MetaOapg.properties.parentWorkflowInstanceId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ended"]) -> MetaOapg.properties.ended: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["createdAssetId"]) -> MetaOapg.properties.createdAssetId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "workflowDefinition", "subInstances", "subProcessInstancesCount", "parentWorkflowInstanceId", "businessItem", "tasks", "startDate", "ended", "createdAssetId", "inError", "errorMessage", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subInstances"]) -> typing.Union[MetaOapg.properties.subInstances, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subProcessInstancesCount"]) -> typing.Union[MetaOapg.properties.subProcessInstancesCount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parentWorkflowInstanceId"]) -> typing.Union[MetaOapg.properties.parentWorkflowInstanceId, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ended"]) -> typing.Union[MetaOapg.properties.ended, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["createdAssetId"]) -> typing.Union[MetaOapg.properties.createdAssetId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "workflowDefinition", "subInstances", "subProcessInstancesCount", "parentWorkflowInstanceId", "businessItem", "tasks", "startDate", "ended", "createdAssetId", "inError", "errorMessage", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        subInstances: typing.Union[MetaOapg.properties.subInstances, list, tuple, schemas.Unset] = schemas.unset,
        subProcessInstancesCount: typing.Union[MetaOapg.properties.subProcessInstancesCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        parentWorkflowInstanceId: typing.Union[MetaOapg.properties.parentWorkflowInstanceId, str, schemas.Unset] = schemas.unset,
        ...
        ended: typing.Union[MetaOapg.properties.ended, bool, schemas.Unset] = schemas.unset,
        createdAssetId: typing.Union[MetaOapg.properties.createdAssetId, str, uuid.UUID, schemas.Unset] = schemas.unset,
