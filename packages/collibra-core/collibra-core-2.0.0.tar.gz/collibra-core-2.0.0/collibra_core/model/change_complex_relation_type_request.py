...
class ChangeComplexRelationTypeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "color", "symbolType", "iconCode", "acronymCode", "attributeTypes", "legTypes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "color", "symbolType", "iconCode", "acronymCode", "attributeTypes", "legTypes", ], str]):
