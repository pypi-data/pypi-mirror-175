...
class DataQualityRulePagedResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataQualityRuleImpl']:
                        return DataQualityRuleImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DataQualityRuleImpl'], typing.List['DataQualityRuleImpl']],
                ...
                def __getitem__(self, i: int) -> 'DataQualityRuleImpl':
