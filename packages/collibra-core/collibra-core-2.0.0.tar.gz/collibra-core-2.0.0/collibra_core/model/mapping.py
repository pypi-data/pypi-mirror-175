...
A single mapping refers to at most one resource which can either be a community, a domain, or an asset.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            externalEntityUrl = schemas.StrSchema
            description = schemas.StrSchema
        
            @staticmethod
            def mappedResource() -> typing.Type['NamedResourceReferenceImpl']:
            ...
            class syncAction(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "UPDATE": "UPDATE",
                        "REMOVE": "REMOVE",
                        "ADD, UPDATE, REMOVE": "ADD_UPDATE_REMOVE",
                    }
                ...
                @schemas.classproperty
                def ADD_UPDATE_REMOVE(cls):
                    return cls("ADD, UPDATE, REMOVE")
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mappedResource"]) -> 'NamedResourceReferenceImpl': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "externalSystemId", "externalEntityId", "externalEntityUrl", "description", "mappedResource", "lastSyncDate", "syncAction", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mappedResource"]) -> typing.Union['NamedResourceReferenceImpl', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "externalSystemId", "externalEntityId", "externalEntityUrl", "description", "mappedResource", "lastSyncDate", "syncAction", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        mappedResource: typing.Union['NamedResourceReferenceImpl', schemas.Unset] = schemas.unset,
