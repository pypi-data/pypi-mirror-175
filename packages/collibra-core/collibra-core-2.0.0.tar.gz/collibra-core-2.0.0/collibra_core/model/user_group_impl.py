...
class UserGroupImpl(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            locallyManaged = schemas.BoolSchema
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["locallyManaged"]) -> MetaOapg.properties.locallyManaged: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "locallyManaged", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["locallyManaged"]) -> typing.Union[MetaOapg.properties.locallyManaged, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "locallyManaged", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        locallyManaged: typing.Union[MetaOapg.properties.locallyManaged, bool, schemas.Unset] = schemas.unset,
