...
class NavigationStatisticsEntryPagedResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NavigationStatisticsEntry']:
                        return NavigationStatisticsEntry
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NavigationStatisticsEntry'], typing.List['NavigationStatisticsEntry']],
                ...
                def __getitem__(self, i: int) -> 'NavigationStatisticsEntry':
