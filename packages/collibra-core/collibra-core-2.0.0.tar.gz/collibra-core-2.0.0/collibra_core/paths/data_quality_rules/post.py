...
# body param
SchemaForRequestBodyApplicationJson = AddDataQualityRuleRequest


request_body_add_data_quality_rule_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DataQualityRuleImpl
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_data_quality_rule_oapg(
        self,
    ...
    def _add_data_quality_rule_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_data_quality_rule_request.serialize(body, content_type)
...
class AddDataQualityRule(BaseApi):
    ...
    def add_data_quality_rule(
        ...
        return self._add_data_quality_rule_oapg(
            body=body,
