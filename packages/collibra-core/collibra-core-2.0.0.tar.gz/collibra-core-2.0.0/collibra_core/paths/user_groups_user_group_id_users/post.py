...
# body param
SchemaForRequestBodyApplicationJson = AddUsersToUserGroupRequest


request_body_add_users_to_user_group_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_users_to_user_group_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_users_to_user_group_request.serialize(body, content_type)
