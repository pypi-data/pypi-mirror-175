...
SchemaFor200ResponseBodyApplicationJson = ComplexRelationTypePagedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_complex_relation_types_oapg(
        self,
...
class FindComplexRelationTypes(BaseApi):
    ...
    def find_complex_relation_types(
        ...
        return self._find_complex_relation_types_oapg(
