...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AddAttributeTypeRequest']:
            return AddAttributeTypeRequest

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AddAttributeTypeRequest'], typing.List['AddAttributeTypeRequest']],
    ...
    def __getitem__(self, i: int) -> 'AddAttributeTypeRequest':
        return super().__getitem__(i)


request_body_add_attribute_type_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_attribute_types_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_attribute_type_request.serialize(body, content_type)
...
class AddAttributeTypes(BaseApi):
    ...
    def add_attribute_types(
        ...
        return self._add_attribute_types_oapg(
            body=body,
