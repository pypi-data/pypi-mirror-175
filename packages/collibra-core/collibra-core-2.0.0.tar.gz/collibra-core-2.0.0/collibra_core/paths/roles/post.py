...
# body param
SchemaForRequestBodyApplicationJson = AddRoleRequest


request_body_add_role_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RoleImpl
...
class BaseApi(api_client.Api):
    ...
    def _add_role_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_role_request.serialize(body, content_type)
