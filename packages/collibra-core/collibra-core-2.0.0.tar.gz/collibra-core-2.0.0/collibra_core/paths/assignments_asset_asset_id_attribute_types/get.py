...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_available_attribute_types_for_asset_oapg(
        self,
...
class GetAvailableAttributeTypesForAsset(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_available_attribute_types_for_asset(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_available_attribute_types_for_asset(
        ...
        return self._get_available_attribute_types_for_asset_oapg(
