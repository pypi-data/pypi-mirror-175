...
# body param
SchemaForRequestBodyApplicationJson = ExportComplexRelationsToExcelRequest


request_body_export_complex_relations_to_excel_request = api_client.RequestBody(
    content={
...
SchemaFor0ResponseBodyApplicationJson = FileInfoImpl
...
class BaseApi(api_client.Api):
    @typing.overload
    def _export_to_excel_without_job_oapg(
        self,
    ...
    def _export_to_excel_without_job_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_export_complex_relations_to_excel_request.serialize(body, content_type)
...
class ExportToExcelWithoutJob(BaseApi):
    ...
    def export_to_excel_without_job(
        ...
        return self._export_to_excel_without_job_oapg(
            body=body,
