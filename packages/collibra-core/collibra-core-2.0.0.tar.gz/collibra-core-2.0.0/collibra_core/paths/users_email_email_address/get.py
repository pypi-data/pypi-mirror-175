...
request_path_email_address = api_client.PathParameter(
    name="emailAddress",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_user_by_email_address_oapg(
        self,
...
class GetUserByEmailAddress(BaseApi):
    ...
    def get_user_by_email_address(
        ...
        return self._get_user_by_email_address_oapg(
