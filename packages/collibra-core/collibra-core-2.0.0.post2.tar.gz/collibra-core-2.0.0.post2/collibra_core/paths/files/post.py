...
from collibra_core.model.file_upload import FileUpload

from . import path

# body param
SchemaForRequestBodyMultipartFormData = FileUpload
...
class SchemaFor201ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FileInfoImpl']:
            return FileInfoImpl

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['FileInfoImpl'], typing.List['FileInfoImpl']],
    ...
    def __getitem__(self, i: int) -> 'FileInfoImpl':
