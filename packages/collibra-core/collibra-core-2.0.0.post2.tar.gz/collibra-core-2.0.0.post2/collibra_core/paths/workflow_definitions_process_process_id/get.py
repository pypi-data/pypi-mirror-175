...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workflow_definition_by_process_id_oapg(
        self,
...
class GetWorkflowDefinitionByProcessId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_workflow_definition_by_process_id(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_workflow_definition_by_process_id(
        ...
        return self._get_workflow_definition_by_process_id_oapg(
