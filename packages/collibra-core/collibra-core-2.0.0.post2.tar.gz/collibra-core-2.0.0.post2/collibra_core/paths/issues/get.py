...
OnlyOpenIssuesSchema = schemas.BoolSchema


class UserRelationSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'onlyOpenIssues': typing.Union[OnlyOpenIssuesSchema, bool, ],
        'userRelation': typing.Union[UserRelationSchema, str, ],
    },
    total=False
)
...
request_query_only_open_issues = api_client.QueryParameter(
    name="onlyOpenIssues",
    style=api_client.ParameterStyle.FORM,
    schema=OnlyOpenIssuesSchema,
    explode=True,
)
request_query_user_relation = api_client.QueryParameter(
    name="userRelation",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _find_issues_oapg(
        ...
        for parameter in (
            ...
            request_query_only_open_issues,
            request_query_user_relation,
        ):
