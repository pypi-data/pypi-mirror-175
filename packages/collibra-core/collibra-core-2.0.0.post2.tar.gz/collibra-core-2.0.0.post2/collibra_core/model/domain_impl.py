...
class DomainImpl(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "community", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "description", "type", "excludedFromAutoHyperlinking", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["community"]) -> 'NamedResourceReferenceImpl': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "community", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "description", "type", "excludedFromAutoHyperlinking", ], str]):
