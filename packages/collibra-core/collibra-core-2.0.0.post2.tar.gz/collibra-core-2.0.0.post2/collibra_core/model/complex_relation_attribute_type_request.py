...
class ComplexRelationAttributeTypeRequest(
    ...
    attributeTypeId: MetaOapg.properties.attributeTypeId
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attributeTypeId", "min", "max", "id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attributeTypeId"]) -> MetaOapg.properties.attributeTypeId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attributeTypeId", "min", "max", "id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        attributeTypeId: typing.Union[MetaOapg.properties.attributeTypeId, str, uuid.UUID, ],
