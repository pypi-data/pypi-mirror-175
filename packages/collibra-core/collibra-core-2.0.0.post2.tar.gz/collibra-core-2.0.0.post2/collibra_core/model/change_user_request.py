...
class ChangeUserRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enabled", "username", "firstName", "lastName", "email", "gender", "language", "licenseType", "addresses", "phones", "additionalEmailAddresses", "instantMessagingAccounts", "websites", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enabled", "username", "firstName", "lastName", "email", "gender", "language", "licenseType", "addresses", "phones", "additionalEmailAddresses", "instantMessagingAccounts", "websites", ], str]):
