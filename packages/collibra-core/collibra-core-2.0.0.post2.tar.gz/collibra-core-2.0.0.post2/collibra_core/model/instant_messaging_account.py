...
class InstantMessagingAccount(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                @schemas.classproperty
                def LIVE_MESSENGER(cls):
                    return cls("LIVE_MESSENGER")
                ...
                @schemas.classproperty
                def YAHOO_MESSENGER(cls):
                    return cls("YAHOO_MESSENGER")
            __annotations__ = {
                "id": id,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "account", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "account", "type", ], str]):
