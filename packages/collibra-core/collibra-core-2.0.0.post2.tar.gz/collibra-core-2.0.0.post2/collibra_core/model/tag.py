...
class Tag(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            assetsCount = schemas.Int32Schema
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assetsCount"]) -> MetaOapg.properties.assetsCount: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "description", "assetsCount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assetsCount"]) -> typing.Union[MetaOapg.properties.assetsCount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "name", "description", "assetsCount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        assetsCount: typing.Union[MetaOapg.properties.assetsCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
