...
class BooleanAttributeType(
    ...
    Represents an attribute which holds a boolean value (either true or false)
    """
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["statisticsEnabled", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["statisticsEnabled", ], str]):
