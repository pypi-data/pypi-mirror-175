...
class ChangeMappingByExternalEntityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["externalEntityUrl", "description", "mappedResourceId", "lastSyncDate", "syncAction", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["externalEntityUrl", "description", "mappedResourceId", "lastSyncDate", "syncAction", ], str]):
