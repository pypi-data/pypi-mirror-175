...
class RelationTraceImpl(
        ...
        class properties:
            ...
            class relationTraceEntries(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RelationTraceEntryImpl']:
                        return RelationTraceEntryImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RelationTraceEntryImpl'], typing.List['RelationTraceEntryImpl']],
                ...
                def __getitem__(self, i: int) -> 'RelationTraceEntryImpl':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "relationTraceEntries", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "relationTraceEntries", ], str]):
