...
class ChangeDomainTypeAssignmentRuleRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            domainTypeId = schemas.UUIDSchema
    ...
    domainTypeId: MetaOapg.properties.domainTypeId
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["domainTypeId"]) -> MetaOapg.properties.domainTypeId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domainTypeId", "communityId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["domainTypeId"]) -> MetaOapg.properties.domainTypeId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domainTypeId", "communityId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        domainTypeId: typing.Union[MetaOapg.properties.domainTypeId, str, uuid.UUID, ],
