...
A rating is a numerical value representing the author's opinion about the rated resource. Ratings can be accompanied by written reviews.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "rating", "asset", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "review", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["asset"]) -> 'NamedResourceReferenceImpl': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resourceType", "rating", "asset", "createdBy", "createdOn", "lastModifiedBy", "lastModifiedOn", "system", "review", ], str]):
