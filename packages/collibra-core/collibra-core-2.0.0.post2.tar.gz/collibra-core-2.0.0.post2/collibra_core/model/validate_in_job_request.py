...
class ValidateInJobRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["assetIds", "sendNotification", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assetIds", "sendNotification", ], str]):
