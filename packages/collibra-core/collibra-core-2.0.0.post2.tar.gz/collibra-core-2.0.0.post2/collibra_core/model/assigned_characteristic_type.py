...
class AssignedCharacteristicType(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class assignedResourceType(
                ...
                def CONTEXT(cls):
                    return cls("Context")
            minimumOccurrences = schemas.Int32Schema
            maximumOccurrences = schemas.Int32Schema
            assignedResourceId = schemas.UUIDSchema
    ...
    assignedResourceType: MetaOapg.properties.assignedResourceType
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignedResourceType"]) -> MetaOapg.properties.assignedResourceType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["minimumOccurrences"]) -> MetaOapg.properties.minimumOccurrences: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["maximumOccurrences"]) -> MetaOapg.properties.maximumOccurrences: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignedResourceId"]) -> MetaOapg.properties.assignedResourceId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["assignedResourceType", "minimumOccurrences", "maximumOccurrences", "assignedResourceId", "readOnly", "system", "id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignedResourceType"]) -> MetaOapg.properties.assignedResourceType: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["minimumOccurrences"]) -> typing.Union[MetaOapg.properties.minimumOccurrences, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["maximumOccurrences"]) -> typing.Union[MetaOapg.properties.maximumOccurrences, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignedResourceId"]) -> typing.Union[MetaOapg.properties.assignedResourceId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assignedResourceType", "minimumOccurrences", "maximumOccurrences", "assignedResourceId", "readOnly", "system", "id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        assignedResourceType: typing.Union[MetaOapg.properties.assignedResourceType, str, ],
        minimumOccurrences: typing.Union[MetaOapg.properties.minimumOccurrences, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        maximumOccurrences: typing.Union[MetaOapg.properties.maximumOccurrences, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        assignedResourceId: typing.Union[MetaOapg.properties.assignedResourceId, str, uuid.UUID, schemas.Unset] = schemas.unset,
