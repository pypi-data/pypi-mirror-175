...
class WorkflowDefinitionPagedResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkflowDefinitionImpl']:
                        return WorkflowDefinitionImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkflowDefinitionImpl'], typing.List['WorkflowDefinitionImpl']],
                ...
                def __getitem__(self, i: int) -> 'WorkflowDefinitionImpl':
