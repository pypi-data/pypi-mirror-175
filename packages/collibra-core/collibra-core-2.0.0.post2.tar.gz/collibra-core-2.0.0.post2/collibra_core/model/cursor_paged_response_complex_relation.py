...
class CursorPagedResponseComplexRelation(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ComplexRelationImpl']:
                        return ComplexRelationImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ComplexRelationImpl'], typing.List['ComplexRelationImpl']],
                ...
                def __getitem__(self, i: int) -> 'ComplexRelationImpl':
                    return super().__getitem__(i)
            nextCursor = schemas.StrSchema
            __annotations__ = {
                "total": total,
                "offset": offset,
                "limit": limit,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nextCursor"]) -> MetaOapg.properties.nextCursor: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "offset", "limit", "results", "nextCursor", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nextCursor"]) -> typing.Union[MetaOapg.properties.nextCursor, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "offset", "limit", "results", "nextCursor", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        nextCursor: typing.Union[MetaOapg.properties.nextCursor, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
