...
# body param
SchemaForRequestBodyApplicationJson = AddAttributeTypeRequest
...
class AddAttributeType(BaseApi):
    ...
    def add_attribute_type(
        ...
        return self._add_attribute_type_oapg(
            body=body,
