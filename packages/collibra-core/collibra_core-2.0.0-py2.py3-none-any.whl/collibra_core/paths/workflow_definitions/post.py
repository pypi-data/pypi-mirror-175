...
class SchemaForRequestBodyMultipartFormData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["file", "fileName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["file", "fileName", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _deploy_workflow_definition_oapg(
        self,
...
class DeployWorkflowDefinition(BaseApi):
    ...
    def deploy_workflow_definition(
        ...
        return self._deploy_workflow_definition_oapg(
            body=body,
