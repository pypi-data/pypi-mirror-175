...
# body param
SchemaForRequestBodyApplicationJson = ChangeUserRequest


request_body_change_user_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _change_user_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_change_user_request.serialize(body, content_type)
