...
BusinessItemIdSchema = schemas.UUIDSchema


class BusinessItemTypeSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
class WorkflowTaskUserRelationSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
    ...
    @schemas.classproperty
    def MY_OVERDUE(cls):
        return cls("MY_OVERDUE")
BusinessItemNameSchema = schemas.StrSchema
DescriptionSchema = schemas.StrSchema
UserIdSchema = schemas.UUIDSchema
CreateDateSchema = schemas.Int64Schema
DueDateSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'businessItemId': typing.Union[BusinessItemIdSchema, str, uuid.UUID, ],
        'businessItemType': typing.Union[BusinessItemTypeSchema, str, ],
        'workflowTaskUserRelation': typing.Union[WorkflowTaskUserRelationSchema, str, ],
        'businessItemName': typing.Union[BusinessItemNameSchema, str, ],
        'description': typing.Union[DescriptionSchema, str, ],
        'userId': typing.Union[UserIdSchema, str, uuid.UUID, ],
        'createDate': typing.Union[CreateDateSchema, decimal.Decimal, int, ],
        'dueDate': typing.Union[DueDateSchema, decimal.Decimal, int, ],
...
request_query_business_item_id = api_client.QueryParameter(
    name="businessItemId",
    style=api_client.ParameterStyle.FORM,
    schema=BusinessItemIdSchema,
    explode=True,
)
request_query_business_item_type = api_client.QueryParameter(
    name="businessItemType",
    style=api_client.ParameterStyle.FORM,
    schema=BusinessItemTypeSchema,
    explode=True,
)
request_query_workflow_task_user_relation = api_client.QueryParameter(
    name="workflowTaskUserRelation",
    style=api_client.ParameterStyle.FORM,
    schema=WorkflowTaskUserRelationSchema,
    explode=True,
)
request_query_business_item_name = api_client.QueryParameter(
    name="businessItemName",
    style=api_client.ParameterStyle.FORM,
    schema=BusinessItemNameSchema,
    explode=True,
)
...
request_query_create_date = api_client.QueryParameter(
    name="createDate",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = WorkflowTaskPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _find_workflow_tasks_oapg(
        ...
        for parameter in (
            ...
            request_query_business_item_id,
            request_query_business_item_type,
            request_query_workflow_task_user_relation,
            request_query_business_item_name,
            request_query_description,
            request_query_user_id,
            request_query_create_date,
...
class FindWorkflowTasks(BaseApi):
    ...
    def find_workflow_tasks(
        ...
        return self._find_workflow_tasks_oapg(
