...
SchemaFor200ResponseBodyApplicationJson = DataQualityRulePagedResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_data_quality_rules_oapg(
        self,
...
class FindDataQualityRules(BaseApi):
    ...
    def find_data_quality_rules(
        ...
        return self._find_data_quality_rules_oapg(
