...
# body param
SchemaForRequestBodyApplicationJson = ChangeUserAvatarRequest


request_body_change_user_avatar_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _change_user_avatar_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_change_user_avatar_request.serialize(body, content_type)
...
class ChangeUserAvatar(BaseApi):
    ...
    def change_user_avatar(
        ...
        return self._change_user_avatar_oapg(
            body=body,
