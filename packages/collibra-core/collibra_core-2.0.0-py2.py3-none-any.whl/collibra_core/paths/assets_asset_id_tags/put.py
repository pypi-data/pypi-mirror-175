...
# body param
SchemaForRequestBodyApplicationJson = SetAssetTagsRequest


request_body_set_asset_tags_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_tags_for_asset_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_set_asset_tags_request.serialize(body, content_type)
...
class SetTagsForAsset(BaseApi):
    ...
    def set_tags_for_asset(
        ...
        return self._set_tags_for_asset_oapg(
            body=body,
