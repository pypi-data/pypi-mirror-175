...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AddUserRequest']:
            return AddUserRequest

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['AddUserRequest'], typing.List['AddUserRequest']],
    ...
    def __getitem__(self, i: int) -> 'AddUserRequest':
        return super().__getitem__(i)


request_body_add_user_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_users_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_user_request.serialize(body, content_type)
