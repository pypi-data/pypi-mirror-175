...
class ChangeCommunityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "parentId", "name", "description", "removeScopeOverlapOnMove", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "parentId", "name", "description", "removeScopeOverlapOnMove", ], str]):
