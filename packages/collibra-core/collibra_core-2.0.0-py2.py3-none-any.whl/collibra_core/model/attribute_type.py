...
class AttributeType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "createdOn", "lastModifiedOn", "resourceType", "createdBy", "lastModifiedBy", "system", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "createdOn", "lastModifiedOn", "resourceType", "createdBy", "lastModifiedBy", "system", "id", ], str]):
