...
class PagedResponseValidationResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ValidationResultImpl']:
                        return ValidationResultImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ValidationResultImpl'], typing.List['ValidationResultImpl']],
                ...
                def __getitem__(self, i: int) -> 'ValidationResultImpl':
