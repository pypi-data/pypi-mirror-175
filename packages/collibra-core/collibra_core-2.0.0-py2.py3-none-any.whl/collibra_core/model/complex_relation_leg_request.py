...
class ComplexRelationLegRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["legTypeId"]) -> MetaOapg.properties.legTypeId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["assetId", "legTypeId", "relationTypeId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["legTypeId"]) -> typing.Union[MetaOapg.properties.legTypeId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assetId", "legTypeId", "relationTypeId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        legTypeId: typing.Union[MetaOapg.properties.legTypeId, str, uuid.UUID, schemas.Unset] = schemas.unset,
