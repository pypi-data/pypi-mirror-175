...
class CursorPagedResponseRelation(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RelationImpl']:
                        return RelationImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RelationImpl'], typing.List['RelationImpl']],
                ...
                def __getitem__(self, i: int) -> 'RelationImpl':
