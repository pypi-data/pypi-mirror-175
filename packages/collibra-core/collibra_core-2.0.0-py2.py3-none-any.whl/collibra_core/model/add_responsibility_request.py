...
class AddResponsibilityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["roleId", "ownerId", "resourceId", "resourceType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["roleId", "ownerId", "resourceId", "resourceType", ], str]):
