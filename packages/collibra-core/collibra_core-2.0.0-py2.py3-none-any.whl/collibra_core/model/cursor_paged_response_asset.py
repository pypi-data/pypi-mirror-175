...
class CursorPagedResponseAsset(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AssetImpl']:
                        return AssetImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AssetImpl'], typing.List['AssetImpl']],
                ...
                def __getitem__(self, i: int) -> 'AssetImpl':
