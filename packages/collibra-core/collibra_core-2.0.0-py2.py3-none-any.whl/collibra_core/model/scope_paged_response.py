        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ScopeImpl']:
                        return ScopeImpl
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ScopeImpl'], typing.List['ScopeImpl']],
                ...
                def __getitem__(self, i: int) -> 'ScopeImpl':
