...
${parent.foot()}\
    <!-- API-Doc App -->
    <script src="${request.static_url('pyramid_helpers:static/js/api-doc.js')}"></script>
</%def>\
<%def name="head()">
${parent.head()}\
    <!-- API-Doc Libraries -->
    ...
    <!-- API-Doc Styles -->
    <link href="${request.static_url('pyramid_helpers:static/css/api-doc-bs5.css')}" rel="stylesheet" />
