...
!$omp declare variant (mkl_lapack_cgebrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tauq,taup,work)
...
!$omp declare variant (mkl_lapack_dgebrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tauq,taup,work)
...
!$omp declare variant (mkl_lapack_sgebrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tauq,taup,work)
...
!$omp declare variant (mkl_lapack_zgebrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tauq,taup,work)
...
!$omp declare variant (mkl_lapack_cgeqrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,tau,work,info)
...
!$omp declare variant (mkl_lapack_dgeqrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,tau,work,info)
...
!$omp declare variant (mkl_lapack_sgeqrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,tau,work,info)
...
!$omp declare variant (mkl_lapack_zgeqrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,tau,work,info)
...
!$omp declare variant (mkl_lapack_cgesvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,s,u,vt,work,rwork)
...
!$omp declare variant (mkl_lapack_dgesvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,s,u,vt,work)
...
!$omp declare variant (mkl_lapack_sgesvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,s,u,vt,work)
...
!$omp declare variant (mkl_lapack_zgesvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,s,u,vt,work,rwork)
...
!$omp declare variant (mkl_lapack_cgetrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv)
...
!$omp declare variant (mkl_lapack_dgetrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv)
...
!$omp declare variant (mkl_lapack_sgetrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv)
...
!$omp declare variant (mkl_lapack_zgetrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv)
...
!$omp declare variant (mkl_lapack_cgetrf_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,info)
...
!$omp declare variant (mkl_lapack_dgetrf_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,info)
...
!$omp declare variant (mkl_lapack_sgetrf_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,info)
...
!$omp declare variant (mkl_lapack_zgetrf_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,info)
...
!$omp declare variant (mkl_lapack_cgetri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,work)
...
!$omp declare variant (mkl_lapack_dgetri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,work)
...
!$omp declare variant (mkl_lapack_sgetri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,work)
...
!$omp declare variant (mkl_lapack_zgetri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,work)
...
!$omp declare variant (mkl_lapack_cgetri_oop_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,ainv,info)
...
!$omp declare variant (mkl_lapack_dgetri_oop_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,ainv,info)
...
!$omp declare variant (mkl_lapack_sgetri_oop_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,ainv,info)
...
!$omp declare variant (mkl_lapack_zgetri_oop_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,ainv,info)
...
!$omp declare variant (mkl_lapack_cgetrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,b)
...
!$omp declare variant (mkl_lapack_dgetrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,b)
...
!$omp declare variant (mkl_lapack_sgetrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,b)
...
!$omp declare variant (mkl_lapack_zgetrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,ipiv,b)
...
!$omp declare variant (mkl_lapack_cheev_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,rwork)
...
!$omp declare variant (mkl_lapack_zheev_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,rwork)
...
!$omp declare variant (mkl_lapack_cheevd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,rwork,iwork)
...
!$omp declare variant (mkl_lapack_zheevd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,rwork,iwork)
...
!$omp declare variant (mkl_lapack_cheevx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,w,z,work,rwork,iwork,ifail)
...
!$omp declare variant (mkl_lapack_zheevx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,w,z,work,rwork,iwork,ifail)
...
!$omp declare variant (mkl_lapack_chegvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b,w,work,rwork,iwork)
...
!$omp declare variant (mkl_lapack_zhegvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b,w,work,rwork,iwork)
...
!$omp declare variant (mkl_lapack_chegvx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,b,w,z,work,rwork,iwork,ifail)
...
!$omp declare variant (mkl_lapack_zhegvx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,b,w,z,work,rwork,iwork,ifail)
...
!$omp declare variant (mkl_lapack_chetrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tau,work)
...
!$omp declare variant (mkl_lapack_zhetrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tau,work)
...
!$omp declare variant (mkl_lapack_dorgqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,work)
...
!$omp declare variant (mkl_lapack_sorgqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,work)
...
!$omp declare variant (mkl_lapack_dormqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,c,work)
...
!$omp declare variant (mkl_lapack_sormqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,c,work)
...
!$omp declare variant (mkl_lapack_csteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:compz,info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_dsteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:compz,info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_ssteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:compz,info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_zsteqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:compz,info,d,e,z,work)
...
!$omp declare variant (mkl_lapack_dsyev_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work)
...
!$omp declare variant (mkl_lapack_ssyev_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work)
...
!$omp declare variant (mkl_lapack_dsyevd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,iwork)
...
!$omp declare variant (mkl_lapack_ssyevd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,w,work,iwork)
...
!$omp declare variant (mkl_lapack_dsyevx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,w,z,work,iwork,ifail)
...
!$omp declare variant (mkl_lapack_ssyevx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,w,z,work,iwork,ifail)
...
!$omp declare variant (mkl_lapack_dsygvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b,w,work,iwork)
...
!$omp declare variant (mkl_lapack_ssygvd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b,w,work,iwork)
...
!$omp declare variant (mkl_lapack_dsygvx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,b,w,z,work,iwork,ifail)
...
!$omp declare variant (mkl_lapack_ssygvx_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:m,info,a,b,w,z,work,iwork,ifail)
...
!$omp declare variant (mkl_lapack_dsytrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tau,work)
...
!$omp declare variant (mkl_lapack_ssytrd_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,d,e,tau,work)
...
!$omp declare variant (mkl_lapack_ctrtrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b)
...
!$omp declare variant (mkl_lapack_dtrtrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b)
...
!$omp declare variant (mkl_lapack_strtrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b)
...
!$omp declare variant (mkl_lapack_ztrtrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,b)
...
!$omp declare variant (mkl_lapack_cungqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,work)
...
!$omp declare variant (mkl_lapack_zungqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,work)
...
!$omp declare variant (mkl_lapack_cunmqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,c,work)
...
!$omp declare variant (mkl_lapack_zunmqr_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:info,a,tau,c,work)
...
!$omp declare variant (mkl_lapack_cgetrs_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,b,info)
...
!$omp declare variant (mkl_lapack_dgetrs_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,b,info)
...
!$omp declare variant (mkl_lapack_sgetrs_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,b,info)
...
!$omp declare variant (mkl_lapack_zgetrs_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,ipiv,b,info)
...
!$omp declare variant (mkl_lapack_cgetrfnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (mkl_lapack_dgetrfnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (mkl_lapack_sgetrfnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (mkl_lapack_zgetrfnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (mkl_lapack_cgetrsnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (mkl_lapack_dgetrsnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (mkl_lapack_sgetrsnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (mkl_lapack_zgetrsnp_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (dpotrf:mkl_lapack_dpotrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (spotrf:mkl_lapack_spotrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (cpotrf:mkl_lapack_cpotrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (zpotrf:mkl_lapack_zpotrf_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (dpotri:mkl_lapack_dpotri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (spotri:mkl_lapack_spotri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (cpotri:mkl_lapack_cpotri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (zpotri:mkl_lapack_zpotri_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,info)
...
!$omp declare variant (dpotrs:mkl_lapack_dpotrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (spotrs:mkl_lapack_spotrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (cpotrs:mkl_lapack_cpotrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
...
!$omp declare variant (zpotrs:mkl_lapack_zpotrs_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
      end subroutine zpotrs

      subroutine mkl_lapack_sgels_batch_strided_omp_offload_ilp64() bind(c) 
      ...
      real,    intent(inout) :: b(stride_b,*)
      integer, intent(out) :: info(*)
!$omp declare variant (sgels_batch_strided:mkl_lapack_sgels_batch_strided_omp_offload_ilp64) match(construct={target variant dispatch}, device={arch(gen)})
!$omp declare variant (sgels_batch_strided:mkl_lapack_sgels_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
      end subroutine sgels_batch_strided

      subroutine mkl_lapack_dgels_batch_strided_omp_offload_ilp64() bind(c)
      ...
      double precision, intent(inout) :: b(stride_b,*)
      integer, intent(out) :: info(*)
!$omp declare variant (dgels_batch_strided:mkl_lapack_dgels_batch_strided_omp_offload_ilp64) match(construct={target variant dispatch}, device={arch(gen)})
!$omp declare variant (dgels_batch_strided:mkl_lapack_dgels_batch_strided_omp_offload_ilp64) match(construct={dispatch}, device={arch(gen)}) append_args(interop(targetsync)) adjust_args(need_device_ptr:a,b,info)
