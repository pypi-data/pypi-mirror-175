...
def scvi(model, contrast, contrast_a, contrast_b, iterations = 50, filter = True, lfc = 1, bayes_factor = 3, pval = 0.01, non_zeros_proportion_b = 0.3):
    ...
    a = (1 - scvi_de['non_zeros_proportion1'])*model.adata[adata.obs[contrast] == contrast_b].obs.shape[0]
    b = (1 - scvi_de['non_zeros_proportion2'])*model.adata[adata.obs[contrast] == contrast_a].obs.shape[0]
    c = scvi_de['non_zeros_proportion1']*model.adata[adata.obs[contrast] == contrast_b].obs.shape[0]
    d = scvi_de['non_zeros_proportion2']*model.adata[adata.obs[contrast] == contrast_a].obs.shape[0]
