...
from skrobot.coordinates import normalize_vector, rpy_angle, rpy_matrix
...
class URDF(URDFType):
    ...
    def __init__(
        self, name, links, joints=None, transmissions=None, materials=None, other_xml=None
    ):
        if joints is None:
            joints = []
        ...
        if cfg is None:
            ...
            for joint in cfg:
                if isinstance(joint, six.string_types):
                    ...
                    raise TypeError("Got key of type {} in cfg map".format(type(joint)))
        ...
        if links is None:
            ...
            for link in links:
                if isinstance(link, six.string_types):
                    ...
                    raise TypeError("Got object of type {} in links list".format(type(link)))
