...
def initialize_database():
    if ModelBase.metadata.bind is not None:
        logger.info("endi_payment : Initialize database")
        ModelBase.metadata.create_all(ModelBase.metadata.bind)
    else:
        logger.info("endi_payment : No database models to initialize")
