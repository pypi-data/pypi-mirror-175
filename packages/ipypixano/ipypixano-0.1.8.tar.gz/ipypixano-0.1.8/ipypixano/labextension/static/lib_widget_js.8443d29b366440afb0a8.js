...
class PixanoModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: PixanoModel.model_name, _model_module: PixanoModel.model_module, _model_module_version: PixanoModel.model_module_version, _view_name: PixanoModel.view_name, _view_module: PixanoModel.view_module, _view_module_version: PixanoModel.view_module_version, element: 'pxn-rectangle', image_path: '', image_data: '', mode: 'none', img_count: 0, counter: 0, toggle_labels: 0, 
            ...
            //targetClass:1,
            //clsMap:{},
            maskVisuMode: 'INSTANCE', prediction: [], selectedCategory: '', label_schema: {}, image_screenshot: '', screenshot: '', do_screenshot: 0, client_ready: false });
    }
}
...
class PixanoView extends base_1.DOMWidgetView {
    ...
    render() {
        ...
        main.addEventListener('keydown', (e) => { this.callback_key_event(e); });
        main.addEventListener('keyup', (e) => { this.callback_key_event(e); });
        ...
        this.model.set("client_ready", true);
    }
        ...
        switch (pxn_element_type) {
            ...
            case 'pxn-polygon':
                this.selectedIds.forEach((id) => {
                    ...
                    this.model.set("selectedCategory", shape.category.name);
                    shape.color = this.attributePicker._colorFor(shape.category);
                    // concatenate and set
            ...
            case 'pxn-smart-segmentation-python':
                ...
                const category = this.attributePicker.selectedCategory;
                this.model.set("selectedCategory", category.name);
                this.pxnElement.targetClass = category.idx;
    ...
    callback_mask_prediction(evt) {
        ...
        const apply_prediction = async () => {
            ...
            if (!cancel) {
                ...
                const fillType = (controler._editionMode.value === EditionMode.REMOVE_FROM_INSTANCE) ? 'remove' : 'add';
                controler.gmask.updateByMaskInRoi(prediction, [xmin, ymin, xmax, ymax], newValue, fillType);
