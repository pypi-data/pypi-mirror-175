...
class client():
    ...
    def __init__(self,uri,path:list=[],token:str="",sniffer:str="sniffer",services:list=[],token_key=None,logger:dict=None,try_count=5,try_sleep=3):
        if logger:
        ...
        if not rpc_server_state:
            raise Exception("can not connect rpc server.")
