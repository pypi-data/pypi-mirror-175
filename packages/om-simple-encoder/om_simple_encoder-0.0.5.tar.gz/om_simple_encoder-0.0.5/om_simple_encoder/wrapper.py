...
class CustomCLIPWrapper(CLIPWrapper):
    def __init__(self,
        ...
        root_dir = os.path.dirname(os.path.abspath(__file__)).replace("om_simple_encoder/om_simple_encoder","om_simple_encoder")
        with open(os.path.join(root_dir,'om_simple_encoder/configs/RN.yaml')) as fin:
