...
from cify.core.utilities import *


def test_schwefel():
    schwefel = get_objective_function('schwefel', n_dimensions=2)
...
def test_vector_constraints():
    ...
    schwefel = get_objective_function('schwefel', n_dimensions=2, vector_constraints=[constraint])
...
def test_get_position_vector():
    schwefel = get_objective_function('schwefel')
