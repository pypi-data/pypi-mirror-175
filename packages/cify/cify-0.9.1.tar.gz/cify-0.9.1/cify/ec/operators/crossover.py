        ...
        for i in range(vector_length):
            if get_rng().uniform() < crossover_probability:
                ...
                while curr_index == prev_index:
                    curr_index = get_rng().choice(n_parents, replace=True)
            child_vector.append(parents[curr_index].chromosome[i])
        child = parents[0].copy()
        child.chromosome = child_vector
        child.chromosome.value = None
...
def linear_crossover(parents: list or Collection, **kwargs):
    ...
    o1.chromosome.vector = p1.chromosome.vector + p2.chromosome.vector
    o2.chromosome.vector = 1.5 * p1.chromosome.vector - .5 * p2.chromosome.vector
    o3.chromosome.vector = -.5 * p1.chromosome.vector + 1.5 * p2.chromosome.vector
    return elitism_selection([o1, o2, o3], n_agents=2)


# def random_blend_crossover():
#     offspring = []
#     for _ in range(n_offspring):
#         values = get_rng().rand(len(parents)).tolist()
#         norm_values = [x / sum(values) for x in values]
#         offspring.append()


# def directional_heuristic_crossover():
#     pass


# arithmetic crossover (pp. 56)
...
# geometrical crossover - multi-parent
# def geometrical_crossover():
#     pass
...
# unimodal distributed crossover (UNDX)
# def unimodal_distributed_crossover():
#     pass
...
# def parent_centric_crossover():
#     pass


# def diagonal_crossover():
#     pass


# ==============================================================================
#                         ES Crossover Operators: ???
# ==============================================================================


# # local + global
# def mu_plus_lambda_crossover():
#     pass
#
#
# def discrete_recombination():
#     pass
#
#
