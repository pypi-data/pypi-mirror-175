...
__all__ = ['elitism_selection', 'random_selection', 'tournament_selection']
...
def elitism_selection(population: list or Collection, n_agents: int = 1, **kwargs):
    ...
    :param n_agents: The number of agents to select, defaults to 1.
...
def random_selection(population: list or Collection,
    ...
    :param population: The population to select from.
    :type population: list, :class:`Collection`
    :param n_agents: The number of agents to select, defaults to the length of the population.
    :type n_agents: int, optional
...
# def proportional_selection():  # for EP? (pp. 121)
#     pass
