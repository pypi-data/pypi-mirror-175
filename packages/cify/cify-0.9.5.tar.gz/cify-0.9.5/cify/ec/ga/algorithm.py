...
class IslandGA(GA):
    # any of the standard 3 operators
    def __init__(
            self,
            obj_func: ObjectiveFunction,
            populations: List[Collection] = None,
            n_individuals: int = None,
            communications_topology=None,       # -> migration paths between islands
            migration_rate=None,                # -> freq. of migration (x iterations or when pop. has converged)
            mig_selection_operator=None,        # -> decide which individuals will migrate
            mig_selection_params: dict = None,
            rep_selection_operator=None,        # -> decide which individuals will migrate
            rep_selection_params: dict = None,
            crossover_operator=None,
            crossover_params: dict = None,
            selection_operator=None,
            selection_params: dict = None,
