...
from cify import Collection, Agent
...
from cify.si.pso.velocity_updates import default_vel_update
from cify.si.pso.velocity_updates import inertia_weight_vel_update
from cify.core.topologies import star_topology

__all__ = ['PSO', 'InertiaWeightPSO']
...
class PSO(Algorithm):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :type swarms: list of :class:`Collection` s
    ...
    def do_iteration(self):
        ...
        for swarm in self.swarms:
            for particle in swarm:
                _, _, topology, _, _, topology_params = self.__get_components(particle, swarm)
                if (
                    particle.satisfies_constraints()
                    and self.obj_func.cmp(particle.position.value, particle.p_best_position.value)
                ):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if velocity_params is None:
            self.velocity_params = {'w': 0.72, 'c1': 1.4, 'c2': 1.4}
