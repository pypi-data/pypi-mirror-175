...
- 🎯 Entry points to execute your program using `python -m <qojpca>` or `$ qojpca` with basic CLI argument parsing.
...
Awesome qojpca created by cryckx
...
```py
from qojpca import BaseClass
from qojpca import base_function
