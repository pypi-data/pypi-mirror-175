...
def validate_and_transform_options(series: MultiSeries, kwargs: Dict = {}) -> Options:
    """
    This will check the keyword arguments passed to the `looniplot.plot` function, will transform them and will return them in form of an `Options` object.
    ...
    As a result the somewhat hacky code below should at least be confined to this function, and not spread throughout looniplot.
    """
