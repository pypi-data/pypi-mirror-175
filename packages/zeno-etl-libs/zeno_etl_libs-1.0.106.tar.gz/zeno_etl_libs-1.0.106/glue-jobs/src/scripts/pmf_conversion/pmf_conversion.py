...
def main(debug_mode, run_stores, run_date, s3, mysql, rs_db_read, rs_db_write,
         read_schema, write_schema, logger):
    ...
    try:
        ...
        where
            ...
            and ad.`created-by` in ('generico2@letsreap.com', 
                                    'sonali.meshram@zeno.health')
        """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-et', '--email_to',
                        default="vivek.revi@zeno.health,vijay.pratap@zeno.health",
