...
def main(debug_mode, reset_stores, reset_date, type_list_comb_lvl,
    ...
    try:
        for store_id in reset_stores:
            ...
            comb_sales_latest_12w = ipc_comb_forecast(
            ...
            fcst_df_drug_lvl, seg_df_drug_lvl, \
            drug_sales_latest_12w, drug_sales_latest_4w = ipc_drug_forecast(
            ...
            fcst_df_comb_lvl, fcst_df_drug_lvl = fcst_correction(
                ...
                drug_sales_latest_12w, drug_sales_latest_4w, logger)
