...
if cluster!= 0:
    pso_cluster_fulfillment_board[['patient-request-id', 'zeno-order-id', 'drug-id','required-quantity', 'quantity-to-order', 'bill-id', 'to-be-transferred-qty', 'actual-transferred-qty', 'drug-billed-cnt', 'quantity-billed-sum','recommended-slot-id']] = pso_cluster_fulfillment_board[['patient-request-id', 'zeno-order-id', 'drug-id','required-quantity', 'quantity-to-order', 'bill-id', 'to-be-transferred-qty', 'actual-transferred-qty', 'drug-billed-cnt', 'quantity-billed-sum','recommended-slot-id']].apply(pd.to_numeric, errors='ignore').astype('Int64')
else:
    pso_cluster_fulfillment_board[
        ['patient-request-id', 'zeno-order-id', 'drug-id', 'required-quantity', 'quantity-to-order', 'bill-id',
          'drug-billed-cnt', 'quantity-billed-sum','recommended-slot-id']] = \
    pso_cluster_fulfillment_board[
        ['patient-request-id', 'zeno-order-id', 'drug-id', 'required-quantity', 'quantity-to-order', 'bill-id',
          'drug-billed-cnt', 'quantity-billed-sum','recommended-slot-id']].apply(
