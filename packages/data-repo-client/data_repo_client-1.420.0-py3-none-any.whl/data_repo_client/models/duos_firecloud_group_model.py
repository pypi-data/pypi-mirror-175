...
class DuosFirecloudGroupModel(object):
    ...
    def __init__(self, duos_id=None, firecloud_group_name=None, firecloud_group_email=None, created_by=None, created=None, last_synced=None, local_vars_configuration=None):  # noqa: E501
