#!/usr/bin/env python
#
# wsipipe documentation build configuration file, created by
...
version = wsipipe.__version__
# The full version, including alpha/beta/rc tags.
release = wsipipe.__version__
...
latex_documents = [
    (master_doc, 'wsipipe.tex',
     'wsipipe Documentation',
     'David Morrison, Christina Fell', 'manual'),
]
