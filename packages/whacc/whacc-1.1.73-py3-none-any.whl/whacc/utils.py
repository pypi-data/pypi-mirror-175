...
def download_all_whacc_data():
    download_resnet_model()
    download_training_data()
    download_extra_LGBM_models()
...
def download_data_dict():
    ...
    d['split_by_trial_2105_data'] = ['https://www.dropbox.com/sh/c8afl0cwja2l08n/AADkqlGMPgmEpDJFwscv5FOPa?dl=1']
...
#          pbox/HIRES_LAB/GitHub/whacc/whacc/whacc_data/final_model/extra_LGBM_models.zip'
