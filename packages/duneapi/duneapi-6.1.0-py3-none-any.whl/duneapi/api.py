...
from .util import paginated_table_name, open_query, partition_array

log = set_log(__name__)

BASE_URL = "https://dune.com"
GRAPH_URL = "https://core-hsr.dune.com/v1/graphql"
VIEW_WRAPPER = open_query("./duneapi/query_template/view_wrapper.sql")
...
class DuneAPI:
    ...
    def push_view(
        self, table_name: str, select_template: str, values: list[str]
    ) -> None:
        """
