...
from zetsubou.project.runtime.project_loader import ProjectTemplate, load_project_from_file
...
class Command:
    ...
    def _load_project(self, context : CommandContext):
        if context.project_template is None:
            ...
            context.project_template = execute_stage(lambda: load_project_from_file(context.project_fs, context.fs_root, context.project_file),
                                        'Project loaded',
