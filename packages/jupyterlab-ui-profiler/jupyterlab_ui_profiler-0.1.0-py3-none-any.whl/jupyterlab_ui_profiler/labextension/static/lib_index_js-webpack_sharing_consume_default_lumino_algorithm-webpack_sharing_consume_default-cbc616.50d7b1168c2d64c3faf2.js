"use strict";
(self["webpackChunk_jupyterlab_benchmarks_ui_profiler"] = self["webpackChunk_jupyterlab_benchmarks_ui_profiler"] || []).push([["lib_index_js-webpack_sharing_consume_default_lumino_algorithm-webpack_sharing_consume_default-cbc616"],{
...
const styleRuleUsageBenchmark = {
    ...
    run: async (scenario, options = {}, progress) => {
        ...
        const reference = await (0,_benchmark__WEBPACK_IMPORTED_MODULE_2__.benchmark)(scenario, n, true);
...
const styleSheetsBenchmark = {
    ...
    run: async (scenario, options = {}, progress) => {
        ...
        for (const style of styles) {
            ...
            if (!sheet) {
                console.log('Skipping style tag without stylesheet', j, 'out of', styles.length);
                continue;
            }
...
class TimingTable extends ResultTable {
    constructor(options) {
        ...
        const referenceIQM = options.reference
            ? _statistics__WEBPACK_IMPORTED_MODULE_2__.Statistic.interQuartileMean(options.reference)
            : null;
        ...
        const results = options.measurements.map(result => {
            ...
            if (referenceIQM !== null) {
                result['Δ'] = _statistics__WEBPACK_IMPORTED_MODULE_2__.Statistic.round(_statistics__WEBPACK_IMPORTED_MODULE_2__.Statistic.interQuartileMean(result.times) - referenceIQM, 1);
            }
            if (result.source) {
        ...
        const frames = frameLocations.map((location, i) => {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: 'up-ProfileTrace-frame ' +
                    (typeof frame.resourceId === 'undefined'
                        ...
                        : ''), key: 'frame-' + i, style: style, title: _statistics__WEBPACK_IMPORTED_MODULE_9__.Statistic.round(location.duration, 1) + 'ms' }, frame.name));
        });
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_lumino_algorithm-webpack_sharing_consume_default-cbc616.50d7b1168c2d64c3faf2.js.map