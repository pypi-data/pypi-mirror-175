...
class DatabaseParameters:
    def __init__(
        ...
        *,
        ...
        :param shared_buffers: (experimental) Note, should be represented in units of 8KB. Default: - 25% of instance memory
    ...
    def shared_buffers(self) -> builtins.str:
        '''(experimental) Note, should be represented in units of 8KB.
