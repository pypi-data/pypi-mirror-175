...
from src.dynamo_helper import DynamoHelperBase, DynamoTestHelper
...
class TableHelper:
    ...
    def build_tables_for_test(self):
        ...
        ddb.create_table(
            ...
            GlobalSecondaryIndexes=[TableHelper.index_from_name_and_attribute("propertyId-index", "propertyId")],
            ProvisionedThroughput={"ReadCapacityUnits": 5, "WriteCapacityUnits": 5},
        )
        ...
        ddb.create_table(
            AttributeDefinitions=[
                {"AttributeName": "id", "AttributeType": "S"},
                {"AttributeName": "locationPlaceId", "AttributeType": "S"},
            ],
            TableName=table_name,
            KeySchema=[
                {"AttributeName": "id", "KeyType": "HASH"},
        ...
        ddb.create_table(
            AttributeDefinitions=[
                {"AttributeName": "id", "AttributeType": "S"},
                {"AttributeName": "authIdCognito", "AttributeType": "S"},
                {"AttributeName": "unverifiedEmail", "AttributeType": "S"},
                {"AttributeName": "verifiedEmail", "AttributeType": "S"},
            ],
            TableName=table_name,
            KeySchema=[
                {"AttributeName": "id", "KeyType": "HASH"},
