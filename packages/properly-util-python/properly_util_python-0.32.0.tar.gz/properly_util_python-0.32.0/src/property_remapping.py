...
from src.dynamo_utils import get_dynamo_item
...
class PropertyRemapping:
    ...
    def _normalize_location_data(self, location_dict):
        ...
        normalization_key_map = {"lat": "latitude", "lng": "longitude", "placeId": "googlePlaceId"}
    ...
    def get_home_from_offer_id(self, offer_id, *args, **kwargs):
        ...
        warnings.warn("Call to deprecated function get_home_from_offer_id.", category=DeprecationWarning, stacklevel=2)
