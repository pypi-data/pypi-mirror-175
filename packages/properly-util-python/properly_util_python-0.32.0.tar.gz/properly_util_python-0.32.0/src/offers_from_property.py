...
from src.dynamo_utils import get_dynamo_item, get_dynamo_items
...
class OffersFromProperty:
    ...
    def _get_dynamo_offer_items_with_property_id(self, offer_table, property_id):
        ...
        table_filter = {"IndexName": "propertyId-index", "KeyConditionExpression": Key("propertyId").eq(property_id)}
    ...
    def get_property(self, property_id):
        ...
        if not self.property_item or self.property_id != property_id:
            ...
            self.property_item = self._get_dynamo_property_item_with_property_id(
                TableHelper.PROPERTY_TABLE_NAME, property_id
            )
