...
class MetricsClient:
    def __init__(self, namespace: str, environment: str = None, dimensions: List[Dict] = None):
        ...
        self.environment = environment or get_properly_stage_for_resource(
            use_local_for_tests=True, default_stage="local"
        )
    ...
    def record_metric(
        self, metric_name: str, value: Union[float, int], metric_unit: str = "None", dimensions: List[Dict] = None
    ):
        """
