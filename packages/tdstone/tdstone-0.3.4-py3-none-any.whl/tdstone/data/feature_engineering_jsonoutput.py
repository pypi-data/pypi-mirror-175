...
if sto_code_type == 'python class MyModel':
    ...
    try:
        ...
        STO_OUPTUT_DEFAULT_STATUS = f'{{"error": "failed", "info": "the model {model_type} run failed. {e}"}}'
        print_when_exception()
    try:
        ...
        STO_OUPTUT_DEFAULT_STATUS = f'{{"error": "failed", "info": "problem managing the model outputs of {model_type}. Are you sure you use the script? chekc you feature engineering mapper attached to your process id. {e}"}}'
        print_when_exception()
