...
def create(sender, instance, **kwargs):
        ...
        wf = workflowitems.objects.update_or_create(transitionmanager = manager ,model_type = a.upper() , event_user = get_current_user() , initial_state = states.description ,interim_state = states.description, final_state = states.description)
