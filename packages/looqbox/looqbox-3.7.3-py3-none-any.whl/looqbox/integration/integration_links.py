...
def _response_json(parser_json, function_call, second_call=False):
    ...
    GlobalCalling.looq.decimal_separator = par.get("user", {}).get("decSeparator", ",")
    GlobalCalling.looq.date_format = par.get("user", {}).get("dateFormat", "dd/mm/yyyy")
    GlobalCalling.looq.language = par.get("user", {}).get("language")
