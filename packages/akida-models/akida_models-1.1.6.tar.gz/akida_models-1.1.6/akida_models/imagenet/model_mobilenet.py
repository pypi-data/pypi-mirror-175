...
def mobilenet_imagenet_pretrained(alpha=1.0):
    ...
    if alpha == 1.0:
        ...
        file_hash = '89dd96d9dfb8f8447392de8760ddb1b62e04ac3f5fa8b5b206e52c3f3fea546a'
    elif alpha == 0.5:
        model_name = 'mobilenet_imagenet_224_alpha_50_iq8_wq4_aq4.h5'
        file_hash = 'ced2243fe9ded2b58d0452dea1f6da4b664c07e383ab815992ce55da43a5190b'
    elif alpha == 0.25:
        model_name = 'mobilenet_imagenet_224_alpha_25_iq8_wq4_aq4.h5'
        file_hash = '9bc217dd0ffe6bcb8c22559b0ffc1f5b5771ffcf630662504e566db76aea62b7'
    else:
        raise ValueError(
