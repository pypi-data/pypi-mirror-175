...
def akidanet_imagenet_pretrained(alpha=1.0):
    ...
    if alpha == 1.0:
        ...
        file_hash = 'f3effbeaf4bcd319615bb8860407c6033929229814a0368828845287ff751e2c'
    elif alpha == 0.5:
        model_name = 'akidanet_imagenet_224_alpha_50_iq8_wq4_aq4.h5'
        file_hash = 'cb4295ebfa33b52ada1f29df5ef5b640d77b9d25c49f2ca6579aa702a859164d'
    elif alpha == 0.25:
        model_name = 'akidanet_imagenet_224_alpha_25_iq8_wq4_aq4.h5'
        file_hash = '6e25f425a0c67094b7a1829f9a1a93d91abbd393400903f53a75f72575b091e7'
    else:
        raise ValueError(
...
def akidanet_cats_vs_dogs_pretrained():
    ...
    file_hash = 'e7eef63de1c6b03fdae36236c384c73c7c6b6b2026be6d565b86b02b403454a9'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_imagenette_pretrained(alpha=1.0):
    ...
    if alpha == 1.0:
        ...
        file_hash = '914b56427aa91de8cac367ebf1c914390871b3f0289cdb0183d79b70824c292d'
    elif alpha == 0.5:
        model_name = 'akidanet_imagenette_224_alpha_50_iq8_wq4_aq4.h5'
        file_hash = '1549d4281b9b6e153558e6610f8db71d43d5504d2de442c4bed5ceaa1c97d819'
    elif alpha == 0.25:
        model_name = 'akidanet_imagenette_224_alpha_25_iq8_wq4_aq4.h5'
        file_hash = 'cb8d8be3c9836ff96a8e3bf744c98122676079ce7537764505e3fc1a16318dc5'
    else:
        raise ValueError(
            f"Requested model with alpha={alpha} is not available.")
...
def akidanet_faceidentification_pretrained():
    ...
    file_hash = '543d7dacbac81f81569d6bace016f2a74b930841ce52c104aabe915eaebd22bd'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_faceverification_pretrained():
    ...
    file_hash = '89f0153ef258e3c961231f6c4de721e846a8315c235a1f298c572e8ec04b8101'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_melanoma_pretrained():
    ...
    file_hash = '8ca62a4c3bba1493e6b50b1246b8f94634a3365d5e1c2068e719e36cc980cdb0'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_odir5k_pretrained():
    ...
    file_hash = '2dce65ff8a6eb5ddb84d5b28e25af835e083493e89da96f4682f3a69bddff119'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_retinal_oct_pretrained():
    ...
    file_hash = '3835203636cd2f6b0869842a604da1d590bf4e7245c97f52fa8d716b48a17abd'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_ecg_pretrained():
    ...
    file_hash = '317d480d657c0b002908bff74cb2bb10fccee393457d1b21c201f4c0897a7c7e'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
...
def akidanet_plantvillage_pretrained():
    ...
    file_hash = 'd889e01e6656c5e1773cde3105250574f38df939347c9beb5a795b2e7cbeb984'
    model_path = get_file(fname=model_name,
                          origin=BASE_WEIGHT_PATH + model_name,
                          file_hash=file_hash,
                          cache_subdir='models')
