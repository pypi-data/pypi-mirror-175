from .gtfo_table_app import GtfoTableApp
...
class GtfoAutoBatchTableApp(GtfoTableApp):
    def __init__(self, *args, **kwargs):
        ...
        self._app._config.consumer_config.batch_consume_max_time_secs = int(env_vars()['NU_CONSUMER_DEFAULT_BATCH_CONSUME_MAX_TIME_SECONDS'])
