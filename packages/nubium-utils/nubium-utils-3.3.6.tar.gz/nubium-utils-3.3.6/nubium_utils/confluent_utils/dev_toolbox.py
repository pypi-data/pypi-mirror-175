...
class DudeConsumer:
    ...
    def _get_config(self, topics):
        ...
        config.consumer_config.batch_consume_max_time_secs = None
        config.consumer_config.batch_consume_store_messages = True
        config.consumer_config.timestamp_offset_mins = int(env_vars()['NU_CONSUMER_TIMESTAMP_OFFSET_MINUTES'])
        config.consumer_config.timeout_mins = int(env_vars()['NU_CONSUMER_TIMEOUT_LIMIT_MINUTES']) + config.consumer_config.timestamp_offset_mins
