...
class AccountClient:
    ...
    def get_quota(self) -> dict:
        """Return a string summarising the number of calls left on your usage plan for
        each service
        ...
        for service in services:
            ...
            remaining = limit if current_usage[lambda_name] is None else current_usage[lambda_name][-1][1]
