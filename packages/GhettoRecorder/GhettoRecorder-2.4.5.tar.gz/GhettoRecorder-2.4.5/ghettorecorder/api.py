...
class GhettoApi:
    ...
    instance vars:
       ...
       EisenRadio must implement itself:
          ER lis_btn_dict = None
          ER rec_btn_dict = None
          ER radios_in_view_dict = None
          ER ghetto_show_analyser = True
          ER work_port = None
          ER radio_active = False
          ER get rid of blacklist_enabled_global, use blacklist_enable
    """
