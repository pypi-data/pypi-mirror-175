...
from robotframework_practitest.services import data_service as data
...
class RobotToPractiTest_Adapter:
    ...
    def get_active_test_set_id(self, timeout=None):
        ...
        return data.CacheLibraryService().wait(data.CacheItem(self._client.test_set_tag, self.test_set_hash_tag),
                                               timeout)
    ...
    def create_test_instance(self, test: PTestCase, version):
        ...
        data.CacheLibraryService()[data.CacheItem('run_instances', test_name)] = set(instance_list)
    ...
    def set_test_results(self, test: PTestCase, results: PTestResult):
        try:
            ...
            related_test_list = data.CacheLibraryService().wait(data.CacheItem('run_instances', test_name),
            ...
            for index, instance in enumerate(related_test_list):
                ...
                instance_id = data.CacheLibraryService().wait(data.CacheItem(self._client.instance_tag, instance))
