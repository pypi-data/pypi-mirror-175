...
class ExperimentLogger:
    ...
    def log_model(
        ...
        full_name =str(experiment.pipeline.estimator)
        console.info(f"Model: {full_name}")
        self.init_loggers(experiment.experiment_name, full_name)
...
#        params = get_estimator_from_meta_estimator(params)
        ...
        for logger in self.loggers:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                logger.log_kolibri_pipeline(experiment, pipeline, model, path=tmpdir)
