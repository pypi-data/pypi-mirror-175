...
class AFM:
    ...
    def snap_in_distance(
        ...
        for i in range(0, self.z_approach.shape[1]):
            ...
            snap_distance[i] = d[self.knee_point(f, d)]
    ...
    def force_map(self,
        ...
        if member == False:
            ...
            if auto_cell == True:
                x_cells = _nid.param.SpecMap.maps[0][4]
                y_cells = _nid.param.SpecMap.maps[0][5]
            ...
            if topography_3d == False:
                ...
                fig.update_layout(margin = dict(t=200,r=200,b=200,l=200),
                    ...
                    autosize = False,
                    xaxis_title="X Position ($\mu$m)",
                    yaxis_title="Y Position ($\mu$m)")
