...
bleach_schema = Schema({
    ...
    'input_units': Or('mixed', '-log(M)', '-log(mol/kg)', 'M', 'mM', 'µM', 'uM', 'nM', 'g/L', 'mg/L', 'mol/kg', 'mmol/kg', 'g/kg', 'kg/kg', ''),
    'output_units': Or('-log(M)', '-log(mol/kg)', 'M', 'mM', 'µM', 'uM', 'nM', 'g/L', 'mg/L', 'mol/kg', 'mmol/kg', 'g/kg', 'kg/kg', ''),
    'units_col': str,
    'assay_type': Or('vitro', 'vivo'),
    'drop_na_units': bool,
