...
import time
# Here we import separate "table_functions.py" file where we have all the methods
# which the main function calls in the library.
from nurdalib.table_functions import *
