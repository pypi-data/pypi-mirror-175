...
class Struc2Vec2():
    ...
    # 接口1: train()
    def train(self, embed_size=128, window_size=5, workers=3, iter=5, w2v_version='old'):
        ...
        # 注意，新老版本的参数不同，参考文章：https://blog.csdn.net/lcy6239/article/details/115786432
        # 新版本用vector_size 代替了原来的size，用epochs代替了原来的iter
