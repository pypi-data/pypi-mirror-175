...
class CodeCommitMirrorSourceRepository(
    ...
    def git_hub(
        ...
        '''
        if __debug__:
            def stub(owner: builtins.str, name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def private(
        ...
        '''
        if __debug__:
            def stub(name: builtins.str, url: aws_cdk.aws_ecs.Secret) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class RollTrigger(
    ...
    def from_rule(cls, rule: aws_cdk.aws_events.Rule) -> "RollTrigger":
        ...
        '''
        if __debug__:
            def stub(rule: aws_cdk.aws_events.Rule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_schedule(cls, schedule: aws_cdk.aws_events.Schedule) -> "RollTrigger":
        ...
        '''
        if __debug__:
            def stub(schedule: aws_cdk.aws_events.Schedule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument schedule", value=schedule, expected_type=type_hints["schedule"])
...
class SamlFederatedPrincipal(
    ...
    def __init__(self, identity_provider: "SamlIdentityProvider") -> None:
        ...
        '''
        if __debug__:
            def stub(identity_provider: "SamlIdentityProvider") -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class SlackAppManifestDefinition(
    ...
    def from_string(cls, manifest: builtins.str) -> "SlackAppManifestDefinition":
        ...
        '''
        if __debug__:
            def stub(manifest: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class SlackAppManifestWorkflowStep:
    def __init__(self, *, callback_id: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, callback_id: builtins.str, name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument callback_id", value=callback_id, expected_type=type_hints["callback_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class SslServerTest(
    ...
    def __init__(
        ...
        *,
        host: builtins.str,
        alarm_topic: typing.Optional[aws_cdk.aws_sns.ITopic] = None,
    ...
    def alarm_topic(self) -> aws_cdk.aws_sns.ITopic:
        ...
        return typing.cast(aws_cdk.aws_sns.ITopic, jsii.get(self, "alarmTopic"))
...
class SslServerTestProps:
    ...
    @builtins.property
    def alarm_topic(self) -> typing.Optional[aws_cdk.aws_sns.ITopic]:
