...
setuptools.setup(
    ...
    py_modules=["oldschool_management_tools", "mgmt_tools_cmd"],             # Name of the python package
    package_dir={'':'oldschool_management_tools/src'},     # Directory of the source code of the package
