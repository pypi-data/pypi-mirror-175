...
from encord_active.common.indexer import EmbeddingType
    ...
    def row_col_settings_in_sidebar():
        ...
        with st.expander("Settings"):
            ...
            with st.form(key="settings_from"):
                ...
                if state.DATA_PAGE_INDEX in st.session_state.keys():
                    if st.session_state[state.DATA_PAGE_INDEX].meta.get("embedding_type", EmbeddingType.NONE.value) in [
