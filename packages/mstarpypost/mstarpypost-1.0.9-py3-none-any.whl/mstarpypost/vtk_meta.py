...
def ReduceMinMaxVariables(varAgg: list[DataVariable]) -> list[DataVariable]:
	"""
	...
	vars = {}
	for v in varAgg:
		key = (v.type, v.name, v.number_components, v.component_index)
...
def GetPvdDataSource(fn="", last_only=True) -> DataSource:
	"""
	"""
