...
class UnityToGymWrapper(gym.Env):
    ...
    def __init__(
        ...
        # for k in self._env.behavior_specs.keys():
        #     print(f"Key {k}: {self._env.behavior_specs[k]=}\n")
        # import sys
        #
        # sys.exit(-1)
        # self.group_spec.action_spec = ActionSpec(continuous_size=0, discrete_branches=(3, 3, 3, 3))
        # print(f"{self.group_spec.action_spec=}")
    ...
    def step(self, action: List[Any]) -> GymStepResult:
        ...
        # nrSameActionStep = 4
        # for i in range(nrSameActionStep):
        #    self._env.set_actions(self.name, action_tuple)
        #    self._env.step()
